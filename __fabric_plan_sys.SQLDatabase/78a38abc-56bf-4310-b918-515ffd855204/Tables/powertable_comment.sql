CREATE TABLE [78a38abc-56bf-4310-b918-515ffd855204].[powertable_comment] (
    ...
    CONSTRAINT [FK_e923d030022f35af27a650126af] FOREIGN KEY ([sourceId]) REFERENCES [78a38abc-56bf-4310-b918-515ffd855204].[powertable_source] ([id])
);
