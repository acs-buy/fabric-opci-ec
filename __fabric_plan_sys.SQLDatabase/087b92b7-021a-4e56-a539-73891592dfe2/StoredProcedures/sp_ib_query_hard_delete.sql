      ...
      CREATE   PROCEDURE [087b92b7-021a-4e56-a539-73891592dfe2].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [087b92b7-021a-4e56-a539-73891592dfe2].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [087b92b7-021a-4e56-a539-73891592dfe2].[ib_query_writeback] qw
