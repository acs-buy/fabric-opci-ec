                ...
                CREATE PROCEDURE [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [5a78dba3-6ef1-477b-91bd-a3fdad824d37].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
