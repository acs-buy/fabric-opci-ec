CREATE TABLE [2942a440-8581-4a23-873f-cfa91145c17e].[cube_partition_sync_logs] (
    ...
    CONSTRAINT [FK_c178596a53d6c303773a9095a21] FOREIGN KEY ([partitionMeasureId]) REFERENCES [2942a440-8581-4a23-873f-cfa91145c17e].[cube_partition_measure] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [2942a440-8581-4a23-873f-cfa91145c17e].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
