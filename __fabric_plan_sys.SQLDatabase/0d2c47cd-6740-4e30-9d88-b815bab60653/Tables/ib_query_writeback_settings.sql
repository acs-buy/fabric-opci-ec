CREATE TABLE [0d2c47cd-6740-4e30-9d88-b815bab60653].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [0d2c47cd-6740-4e30-9d88-b815bab60653].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [0d2c47cd-6740-4e30-9d88-b815bab60653].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [0d2c47cd-6740-4e30-9d88-b815bab60653].[ib_query_writeback_settings]([recordGuid] ASC);
