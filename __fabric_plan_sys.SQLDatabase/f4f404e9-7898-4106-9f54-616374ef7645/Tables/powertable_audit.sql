CREATE TABLE [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
