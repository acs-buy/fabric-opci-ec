      ...
      CREATE   PROCEDURE [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[ib_query_writeback] qw
