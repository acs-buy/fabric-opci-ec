CREATE TABLE [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[powertable_row_access_filters]([recordGuid] ASC);
