CREATE TABLE [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_lookup_config]([recordGuid] ASC);
