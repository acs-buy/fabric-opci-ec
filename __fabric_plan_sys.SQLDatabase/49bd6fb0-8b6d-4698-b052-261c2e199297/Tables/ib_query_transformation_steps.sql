CREATE TABLE [49bd6fb0-8b6d-4698-b052-261c2e199297].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [49bd6fb0-8b6d-4698-b052-261c2e199297].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [49bd6fb0-8b6d-4698-b052-261c2e199297].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [49bd6fb0-8b6d-4698-b052-261c2e199297].[ib_query_transformation_steps]([recordGuid] ASC);
