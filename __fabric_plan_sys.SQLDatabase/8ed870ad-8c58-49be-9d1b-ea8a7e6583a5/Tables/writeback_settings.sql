CREATE TABLE [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[writeback_settings]([recordGuid] ASC);
