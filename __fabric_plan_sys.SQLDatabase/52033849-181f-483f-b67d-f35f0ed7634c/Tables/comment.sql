CREATE TABLE [52033849-181f-483f-b67d-f35f0ed7634c].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [52033849-181f-483f-b67d-f35f0ed7634c].[visual] ([id]) ON DELETE CASCADE
);
