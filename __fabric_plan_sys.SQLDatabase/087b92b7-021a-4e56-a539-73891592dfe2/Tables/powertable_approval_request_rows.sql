CREATE TABLE [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_approval_request] ([id])
);
