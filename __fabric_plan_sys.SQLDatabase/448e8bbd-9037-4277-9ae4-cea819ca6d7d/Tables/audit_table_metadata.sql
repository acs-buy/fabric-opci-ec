CREATE TABLE [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
