CREATE TABLE [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[powertable_row_access_filters]([recordGuid] ASC);
