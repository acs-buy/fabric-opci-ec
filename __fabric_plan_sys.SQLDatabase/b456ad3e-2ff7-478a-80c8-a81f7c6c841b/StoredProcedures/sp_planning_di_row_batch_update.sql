            ...
            CREATE PROCEDURE [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].data_input_row
                INNER JOIN [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
