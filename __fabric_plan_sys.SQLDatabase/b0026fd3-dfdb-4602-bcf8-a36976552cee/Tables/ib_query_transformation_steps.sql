CREATE TABLE [b0026fd3-dfdb-4602-bcf8-a36976552cee].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [b0026fd3-dfdb-4602-bcf8-a36976552cee].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [b0026fd3-dfdb-4602-bcf8-a36976552cee].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [b0026fd3-dfdb-4602-bcf8-a36976552cee].[ib_query_transformation_steps]([recordGuid] ASC);
