CREATE TABLE [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[ib_query_writeback_settings]([recordGuid] ASC);
