CREATE TABLE [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[visual] ([id]) ON DELETE CASCADE
);
