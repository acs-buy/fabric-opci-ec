                          ...
                          CREATE PROCEDURE [a0291f6a-c950-4328-805b-aca7d339d93e].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [a0291f6a-c950-4328-805b-aca7d339d93e].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [a0291f6a-c950-4328-805b-aca7d339d93e].powertable_approval_request_rows
