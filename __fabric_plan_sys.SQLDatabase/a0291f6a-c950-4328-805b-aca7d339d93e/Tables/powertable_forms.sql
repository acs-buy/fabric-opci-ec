CREATE TABLE [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_forms]([recordGuid] ASC);
