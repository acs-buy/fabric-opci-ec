CREATE TABLE [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[powertable_approval_request] ([id])
);
