CREATE TABLE [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[powertable_automation_jobs] ([id])
);
