                ...
                CREATE PROCEDURE [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [90f6b4d0-829e-4f62-91eb-204c8bf56be7].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
