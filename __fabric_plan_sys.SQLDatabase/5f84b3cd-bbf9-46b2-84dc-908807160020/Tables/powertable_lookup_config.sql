CREATE TABLE [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_lookup_config]([recordGuid] ASC);
