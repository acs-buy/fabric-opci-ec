CREATE TABLE [4564c828-5513-4f75-8148-7562146882ce].[writeback] (
    ...
    CONSTRAINT [FK_bbc1ed3d35bb48f8c0823c361c0] FOREIGN KEY ([visualId]) REFERENCES [4564c828-5513-4f75-8148-7562146882ce].[visual] ([id])
);
