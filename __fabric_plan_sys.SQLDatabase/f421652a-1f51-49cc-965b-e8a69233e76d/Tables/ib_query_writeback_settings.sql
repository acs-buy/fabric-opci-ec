CREATE TABLE [f421652a-1f51-49cc-965b-e8a69233e76d].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [f421652a-1f51-49cc-965b-e8a69233e76d].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [f421652a-1f51-49cc-965b-e8a69233e76d].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [f421652a-1f51-49cc-965b-e8a69233e76d].[ib_query_writeback_settings]([recordGuid] ASC);
