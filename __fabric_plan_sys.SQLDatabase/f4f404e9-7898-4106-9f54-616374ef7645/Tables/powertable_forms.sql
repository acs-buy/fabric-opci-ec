CREATE TABLE [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_forms]([recordGuid] ASC);
