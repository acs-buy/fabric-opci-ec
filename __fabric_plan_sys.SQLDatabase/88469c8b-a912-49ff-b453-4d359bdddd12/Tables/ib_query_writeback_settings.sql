CREATE TABLE [88469c8b-a912-49ff-b453-4d359bdddd12].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [88469c8b-a912-49ff-b453-4d359bdddd12].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [88469c8b-a912-49ff-b453-4d359bdddd12].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [88469c8b-a912-49ff-b453-4d359bdddd12].[ib_query_writeback_settings]([recordGuid] ASC);
