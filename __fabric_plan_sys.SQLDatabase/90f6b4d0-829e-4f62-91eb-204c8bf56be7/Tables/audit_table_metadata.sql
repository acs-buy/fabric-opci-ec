CREATE TABLE [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
