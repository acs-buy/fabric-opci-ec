CREATE TABLE [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[powertable_approval_filter]([recordGuid] ASC);
