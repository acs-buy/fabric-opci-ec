CREATE TABLE [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_approval]([recordGuid] ASC);
