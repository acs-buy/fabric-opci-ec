              ...
              CREATE PROCEDURE [087b92b7-021a-4e56-a539-73891592dfe2].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [087b92b7-021a-4e56-a539-73891592dfe2].powertable_approval_request_rows SET status = 500 FROM [087b92b7-021a-4e56-a539-73891592dfe2].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
