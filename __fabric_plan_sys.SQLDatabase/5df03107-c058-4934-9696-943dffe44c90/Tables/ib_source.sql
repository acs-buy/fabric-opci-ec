CREATE TABLE [5df03107-c058-4934-9696-943dffe44c90].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [5df03107-c058-4934-9696-943dffe44c90].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [5df03107-c058-4934-9696-943dffe44c90].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [5df03107-c058-4934-9696-943dffe44c90].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [5df03107-c058-4934-9696-943dffe44c90].[ib_source]([recordGuid] ASC);
