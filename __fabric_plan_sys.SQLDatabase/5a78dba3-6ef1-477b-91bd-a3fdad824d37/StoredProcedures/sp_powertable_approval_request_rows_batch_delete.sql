              ...
              CREATE PROCEDURE [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [5a78dba3-6ef1-477b-91bd-a3fdad824d37].powertable_approval_request_rows SET status = 500 FROM [5a78dba3-6ef1-477b-91bd-a3fdad824d37].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
