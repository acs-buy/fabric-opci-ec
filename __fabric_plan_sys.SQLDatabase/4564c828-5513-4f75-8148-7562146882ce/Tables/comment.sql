CREATE TABLE [4564c828-5513-4f75-8148-7562146882ce].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [4564c828-5513-4f75-8148-7562146882ce].[visual] ([id]) ON DELETE CASCADE
);
