CREATE TABLE [4564c828-5513-4f75-8148-7562146882ce].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [4564c828-5513-4f75-8148-7562146882ce].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [4564c828-5513-4f75-8148-7562146882ce].[powertable_approval_filter]([recordGuid] ASC);
