CREATE TABLE [78a38abc-56bf-4310-b918-515ffd855204].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [78a38abc-56bf-4310-b918-515ffd855204].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [78a38abc-56bf-4310-b918-515ffd855204].[powertable_approval_filter]([recordGuid] ASC);
