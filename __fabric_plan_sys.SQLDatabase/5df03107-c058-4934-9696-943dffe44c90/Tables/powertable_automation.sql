CREATE TABLE [5df03107-c058-4934-9696-943dffe44c90].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [5df03107-c058-4934-9696-943dffe44c90].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [5df03107-c058-4934-9696-943dffe44c90].[powertable_automation]([recordGuid] ASC);
