CREATE TABLE [5df03107-c058-4934-9696-943dffe44c90].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [5df03107-c058-4934-9696-943dffe44c90].[visual] ([id]) ON DELETE CASCADE
);
