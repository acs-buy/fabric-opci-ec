CREATE TABLE [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[powertable_approval_request] ([id])
);
