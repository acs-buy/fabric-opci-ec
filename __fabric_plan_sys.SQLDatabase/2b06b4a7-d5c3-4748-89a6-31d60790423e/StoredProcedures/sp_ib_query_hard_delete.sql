      ...
      CREATE   PROCEDURE [2b06b4a7-d5c3-4748-89a6-31d60790423e].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [2b06b4a7-d5c3-4748-89a6-31d60790423e].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [2b06b4a7-d5c3-4748-89a6-31d60790423e].[ib_query_writeback] qw
