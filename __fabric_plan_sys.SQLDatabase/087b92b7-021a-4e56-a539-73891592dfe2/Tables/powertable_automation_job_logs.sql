CREATE TABLE [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_automation_jobs] ([id])
);
