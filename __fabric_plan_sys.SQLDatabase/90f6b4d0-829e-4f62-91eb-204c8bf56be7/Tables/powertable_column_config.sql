CREATE TABLE [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[powertable_column_config]([recordGuid] ASC);
