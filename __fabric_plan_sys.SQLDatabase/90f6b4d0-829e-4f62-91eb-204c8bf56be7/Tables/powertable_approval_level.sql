CREATE TABLE [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[powertable_approval_level]([recordGuid] ASC);
