CREATE TABLE [49bd6fb0-8b6d-4698-b052-261c2e199297].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [49bd6fb0-8b6d-4698-b052-261c2e199297].[powertable_approval_request] ([id])
);
