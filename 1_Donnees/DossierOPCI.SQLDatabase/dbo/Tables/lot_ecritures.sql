CREATE TABLE [dbo].[lot_ecritures] (
    ...
    CONSTRAINT [ck_lot_source_par_famille] CHECK ([famille]='IMPORTEE' AND [import_id] IS NOT NULL OR [famille]='DECIDEE' AND [feuille_cote] IS NOT NULL AND [question_id] IS NOT NULL OR [famille]='DERIVABLE' AND [feuille_cote] IS NOT NULL),
