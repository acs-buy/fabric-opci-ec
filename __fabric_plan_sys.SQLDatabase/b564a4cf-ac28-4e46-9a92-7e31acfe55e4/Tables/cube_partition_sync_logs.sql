CREATE TABLE [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[cube_partition_sync_logs] (
    ...
    CONSTRAINT [FK_c178596a53d6c303773a9095a21] FOREIGN KEY ([partitionMeasureId]) REFERENCES [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[cube_partition_measure] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
