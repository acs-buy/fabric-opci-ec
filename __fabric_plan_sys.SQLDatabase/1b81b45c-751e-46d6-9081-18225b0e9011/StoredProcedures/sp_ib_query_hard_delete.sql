      ...
      CREATE   PROCEDURE [1b81b45c-751e-46d6-9081-18225b0e9011].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [1b81b45c-751e-46d6-9081-18225b0e9011].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [1b81b45c-751e-46d6-9081-18225b0e9011].[ib_query_writeback] qw
