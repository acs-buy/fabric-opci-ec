CREATE TABLE [31e46168-a84d-491d-9615-f018f7009712].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [31e46168-a84d-491d-9615-f018f7009712].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [31e46168-a84d-491d-9615-f018f7009712].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [31e46168-a84d-491d-9615-f018f7009712].[ib_query_writeback_destination]([recordGuid] ASC);
