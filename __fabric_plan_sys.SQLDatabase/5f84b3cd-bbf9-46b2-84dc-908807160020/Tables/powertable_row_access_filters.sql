CREATE TABLE [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_row_access_filters]([recordGuid] ASC);
