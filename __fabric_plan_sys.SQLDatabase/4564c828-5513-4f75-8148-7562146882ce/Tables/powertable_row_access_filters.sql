CREATE TABLE [4564c828-5513-4f75-8148-7562146882ce].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [4564c828-5513-4f75-8148-7562146882ce].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [4564c828-5513-4f75-8148-7562146882ce].[powertable_row_access_filters]([recordGuid] ASC);
