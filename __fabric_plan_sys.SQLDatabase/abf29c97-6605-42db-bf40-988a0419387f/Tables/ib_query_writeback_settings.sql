CREATE TABLE [abf29c97-6605-42db-bf40-988a0419387f].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [abf29c97-6605-42db-bf40-988a0419387f].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [abf29c97-6605-42db-bf40-988a0419387f].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [abf29c97-6605-42db-bf40-988a0419387f].[ib_query_writeback_settings]([recordGuid] ASC);
