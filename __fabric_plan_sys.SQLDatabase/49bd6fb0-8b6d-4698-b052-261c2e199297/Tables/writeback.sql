CREATE TABLE [49bd6fb0-8b6d-4698-b052-261c2e199297].[writeback] (
    ...
    CONSTRAINT [FK_bbc1ed3d35bb48f8c0823c361c0] FOREIGN KEY ([visualId]) REFERENCES [49bd6fb0-8b6d-4698-b052-261c2e199297].[visual] ([id])
);
