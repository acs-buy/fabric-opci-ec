CREATE TABLE [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_approval_request] ([id])
);
