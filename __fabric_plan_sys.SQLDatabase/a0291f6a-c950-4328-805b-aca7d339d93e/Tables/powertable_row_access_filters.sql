CREATE TABLE [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_row_access_filters]([recordGuid] ASC);
