CREATE TABLE [78a38abc-56bf-4310-b918-515ffd855204].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [78a38abc-56bf-4310-b918-515ffd855204].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [78a38abc-56bf-4310-b918-515ffd855204].[writeback_settings]([recordGuid] ASC);
