CREATE TABLE [f421652a-1f51-49cc-965b-e8a69233e76d].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [f421652a-1f51-49cc-965b-e8a69233e76d].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [f421652a-1f51-49cc-965b-e8a69233e76d].[powertable_approval]([recordGuid] ASC);
