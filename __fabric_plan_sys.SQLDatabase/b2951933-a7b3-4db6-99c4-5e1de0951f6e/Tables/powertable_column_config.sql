CREATE TABLE [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[powertable_column_config]([recordGuid] ASC);
