      ...
      CREATE   PROCEDURE [f4f404e9-7898-4106-9f54-616374ef7645].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [f4f404e9-7898-4106-9f54-616374ef7645].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [f4f404e9-7898-4106-9f54-616374ef7645].[ib_query_writeback] qw
