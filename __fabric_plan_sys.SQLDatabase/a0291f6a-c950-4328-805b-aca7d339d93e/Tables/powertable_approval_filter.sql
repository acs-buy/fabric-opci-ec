CREATE TABLE [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_approval_filter]([recordGuid] ASC);
