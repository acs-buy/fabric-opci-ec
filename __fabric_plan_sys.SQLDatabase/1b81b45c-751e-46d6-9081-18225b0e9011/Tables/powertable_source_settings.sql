CREATE TABLE [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_source_settings]([recordGuid] ASC);
