CREATE TABLE [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_approval_request] ([id])
);
