                ...
                CREATE PROCEDURE [14cd3243-21c1-488b-a192-0760eaf16a68].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [14cd3243-21c1-488b-a192-0760eaf16a68].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
