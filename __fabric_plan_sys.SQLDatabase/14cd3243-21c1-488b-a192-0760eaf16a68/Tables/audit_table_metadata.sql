CREATE TABLE [14cd3243-21c1-488b-a192-0760eaf16a68].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [14cd3243-21c1-488b-a192-0760eaf16a68].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [14cd3243-21c1-488b-a192-0760eaf16a68].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
