CREATE TABLE [49bd6fb0-8b6d-4698-b052-261c2e199297].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [49bd6fb0-8b6d-4698-b052-261c2e199297].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [49bd6fb0-8b6d-4698-b052-261c2e199297].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [49bd6fb0-8b6d-4698-b052-261c2e199297].[ib_query_writeback_destination]([recordGuid] ASC);
