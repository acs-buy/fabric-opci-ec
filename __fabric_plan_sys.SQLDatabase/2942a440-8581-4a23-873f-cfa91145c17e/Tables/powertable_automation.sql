CREATE TABLE [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_automation]([recordGuid] ASC);
