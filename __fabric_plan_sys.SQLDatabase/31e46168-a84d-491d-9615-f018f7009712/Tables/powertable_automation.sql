CREATE TABLE [31e46168-a84d-491d-9615-f018f7009712].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [31e46168-a84d-491d-9615-f018f7009712].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [31e46168-a84d-491d-9615-f018f7009712].[powertable_automation]([recordGuid] ASC);
