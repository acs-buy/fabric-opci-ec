CREATE TABLE [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_automation]([recordGuid] ASC);
