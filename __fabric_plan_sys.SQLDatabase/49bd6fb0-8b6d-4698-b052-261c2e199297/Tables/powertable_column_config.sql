CREATE TABLE [49bd6fb0-8b6d-4698-b052-261c2e199297].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [49bd6fb0-8b6d-4698-b052-261c2e199297].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [49bd6fb0-8b6d-4698-b052-261c2e199297].[powertable_column_config]([recordGuid] ASC);
