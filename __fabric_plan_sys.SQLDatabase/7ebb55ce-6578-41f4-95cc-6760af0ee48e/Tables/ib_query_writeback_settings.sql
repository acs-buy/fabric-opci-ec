CREATE TABLE [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[ib_query_writeback_settings]([recordGuid] ASC);
