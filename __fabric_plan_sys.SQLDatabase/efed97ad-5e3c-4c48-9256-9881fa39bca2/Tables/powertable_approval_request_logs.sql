CREATE TABLE [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_approval_request] ([id])
);
