CREATE TABLE [0d2c47cd-6740-4e30-9d88-b815bab60653].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [0d2c47cd-6740-4e30-9d88-b815bab60653].[powertable_automation_jobs] ([id])
);
