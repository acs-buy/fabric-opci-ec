CREATE TABLE [49bd6fb0-8b6d-4698-b052-261c2e199297].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [49bd6fb0-8b6d-4698-b052-261c2e199297].[visual] ([id]) ON DELETE CASCADE
);
