CREATE TABLE [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[powertable_automation]([recordGuid] ASC);
