CREATE TABLE [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_approval_filter]([recordGuid] ASC);
