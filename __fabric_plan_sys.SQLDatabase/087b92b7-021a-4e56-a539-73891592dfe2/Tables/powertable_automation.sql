CREATE TABLE [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_automation]([recordGuid] ASC);
