CREATE TABLE [2b06b4a7-d5c3-4748-89a6-31d60790423e].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [2b06b4a7-d5c3-4748-89a6-31d60790423e].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [2b06b4a7-d5c3-4748-89a6-31d60790423e].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [2b06b4a7-d5c3-4748-89a6-31d60790423e].[ib_query_writeback_destination]([recordGuid] ASC);
