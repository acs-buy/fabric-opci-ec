CREATE TABLE [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_approval_level]([recordGuid] ASC);
