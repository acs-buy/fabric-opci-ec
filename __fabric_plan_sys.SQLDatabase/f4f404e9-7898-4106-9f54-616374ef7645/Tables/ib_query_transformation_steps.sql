CREATE TABLE [f4f404e9-7898-4106-9f54-616374ef7645].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [f4f404e9-7898-4106-9f54-616374ef7645].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [f4f404e9-7898-4106-9f54-616374ef7645].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [f4f404e9-7898-4106-9f54-616374ef7645].[ib_query_transformation_steps]([recordGuid] ASC);
