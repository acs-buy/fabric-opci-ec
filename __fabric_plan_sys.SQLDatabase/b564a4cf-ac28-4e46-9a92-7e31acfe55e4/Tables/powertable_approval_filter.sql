CREATE TABLE [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[powertable_approval_filter]([recordGuid] ASC);
