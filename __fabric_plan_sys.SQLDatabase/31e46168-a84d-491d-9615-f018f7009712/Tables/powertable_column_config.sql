CREATE TABLE [31e46168-a84d-491d-9615-f018f7009712].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [31e46168-a84d-491d-9615-f018f7009712].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [31e46168-a84d-491d-9615-f018f7009712].[powertable_column_config]([recordGuid] ASC);
