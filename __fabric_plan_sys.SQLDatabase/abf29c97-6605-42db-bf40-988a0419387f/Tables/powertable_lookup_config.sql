CREATE TABLE [abf29c97-6605-42db-bf40-988a0419387f].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [abf29c97-6605-42db-bf40-988a0419387f].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [abf29c97-6605-42db-bf40-988a0419387f].[powertable_lookup_config]([recordGuid] ASC);
