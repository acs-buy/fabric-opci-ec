CREATE TABLE [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[powertable_approval_request] ([id])
);
