CREATE TABLE [88469c8b-a912-49ff-b453-4d359bdddd12].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [88469c8b-a912-49ff-b453-4d359bdddd12].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [88469c8b-a912-49ff-b453-4d359bdddd12].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
