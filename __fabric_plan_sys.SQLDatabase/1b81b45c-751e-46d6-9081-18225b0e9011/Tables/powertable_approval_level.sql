CREATE TABLE [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_approval_level]([recordGuid] ASC);
