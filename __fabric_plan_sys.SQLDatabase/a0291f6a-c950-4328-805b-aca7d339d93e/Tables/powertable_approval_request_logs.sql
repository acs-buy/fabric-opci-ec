CREATE TABLE [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_approval_request] ([id])
);
