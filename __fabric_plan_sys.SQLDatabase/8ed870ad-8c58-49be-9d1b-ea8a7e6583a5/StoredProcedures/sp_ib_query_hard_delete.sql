      ...
      CREATE   PROCEDURE [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[ib_query_writeback] qw
