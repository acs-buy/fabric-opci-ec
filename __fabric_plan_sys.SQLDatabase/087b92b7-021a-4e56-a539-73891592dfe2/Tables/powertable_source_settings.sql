CREATE TABLE [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_source_settings]([recordGuid] ASC);
