CREATE TABLE [b0026fd3-dfdb-4602-bcf8-a36976552cee].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [b0026fd3-dfdb-4602-bcf8-a36976552cee].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [b0026fd3-dfdb-4602-bcf8-a36976552cee].[writeback_settings]([recordGuid] ASC);
