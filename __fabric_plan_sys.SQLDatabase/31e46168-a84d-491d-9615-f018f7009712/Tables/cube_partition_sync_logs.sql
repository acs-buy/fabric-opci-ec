CREATE TABLE [31e46168-a84d-491d-9615-f018f7009712].[cube_partition_sync_logs] (
    ...
    CONSTRAINT [FK_c178596a53d6c303773a9095a21] FOREIGN KEY ([partitionMeasureId]) REFERENCES [31e46168-a84d-491d-9615-f018f7009712].[cube_partition_measure] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [31e46168-a84d-491d-9615-f018f7009712].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
