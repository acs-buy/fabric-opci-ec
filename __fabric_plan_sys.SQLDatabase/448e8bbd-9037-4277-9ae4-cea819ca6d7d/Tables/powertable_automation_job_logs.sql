CREATE TABLE [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[powertable_automation_jobs] ([id])
);
