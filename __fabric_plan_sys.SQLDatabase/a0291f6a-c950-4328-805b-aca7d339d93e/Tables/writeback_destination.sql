CREATE TABLE [a0291f6a-c950-4328-805b-aca7d339d93e].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [a0291f6a-c950-4328-805b-aca7d339d93e].[visual] ([id])
);
