CREATE TABLE [562059f4-3c4c-407c-8a2c-864f2acbe25c].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [562059f4-3c4c-407c-8a2c-864f2acbe25c].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [562059f4-3c4c-407c-8a2c-864f2acbe25c].[powertable_column_config]([recordGuid] ASC);
