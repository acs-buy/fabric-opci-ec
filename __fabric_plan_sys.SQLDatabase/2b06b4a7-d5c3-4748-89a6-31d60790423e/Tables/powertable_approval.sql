CREATE TABLE [2b06b4a7-d5c3-4748-89a6-31d60790423e].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [2b06b4a7-d5c3-4748-89a6-31d60790423e].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [2b06b4a7-d5c3-4748-89a6-31d60790423e].[powertable_approval]([recordGuid] ASC);
