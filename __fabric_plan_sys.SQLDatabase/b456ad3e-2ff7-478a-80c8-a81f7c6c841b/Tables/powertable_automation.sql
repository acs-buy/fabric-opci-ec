CREATE TABLE [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[powertable_automation]([recordGuid] ASC);
