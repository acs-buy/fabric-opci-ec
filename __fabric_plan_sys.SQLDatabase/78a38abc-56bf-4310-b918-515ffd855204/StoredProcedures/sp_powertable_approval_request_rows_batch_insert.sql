                ...
                CREATE PROCEDURE [78a38abc-56bf-4310-b918-515ffd855204].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [78a38abc-56bf-4310-b918-515ffd855204].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
