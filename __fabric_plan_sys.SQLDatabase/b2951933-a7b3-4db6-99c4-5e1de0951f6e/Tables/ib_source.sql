CREATE TABLE [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[ib_source]([recordGuid] ASC);
