CREATE TABLE [0d2c47cd-6740-4e30-9d88-b815bab60653].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [0d2c47cd-6740-4e30-9d88-b815bab60653].[powertable_approval_request] ([id])
);
