              ...
              CREATE PROCEDURE [2b06b4a7-d5c3-4748-89a6-31d60790423e].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [2b06b4a7-d5c3-4748-89a6-31d60790423e].powertable_approval_request_rows SET status = 500 FROM [2b06b4a7-d5c3-4748-89a6-31d60790423e].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
