                          ...
                          CREATE PROCEDURE [087b92b7-021a-4e56-a539-73891592dfe2].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [087b92b7-021a-4e56-a539-73891592dfe2].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [087b92b7-021a-4e56-a539-73891592dfe2].powertable_approval_request_rows
