CREATE TABLE [eb015c3f-91d7-4289-8920-d40b3feafd42].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [eb015c3f-91d7-4289-8920-d40b3feafd42].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [eb015c3f-91d7-4289-8920-d40b3feafd42].[powertable_lookup_config]([recordGuid] ASC);
