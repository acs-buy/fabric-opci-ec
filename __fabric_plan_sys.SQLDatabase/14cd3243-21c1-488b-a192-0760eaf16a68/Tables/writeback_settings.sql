CREATE TABLE [14cd3243-21c1-488b-a192-0760eaf16a68].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [14cd3243-21c1-488b-a192-0760eaf16a68].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [14cd3243-21c1-488b-a192-0760eaf16a68].[writeback_settings]([recordGuid] ASC);
