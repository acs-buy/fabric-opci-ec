CREATE TABLE [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[ib_source]([recordGuid] ASC);
