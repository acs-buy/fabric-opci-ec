CREATE TABLE [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[visual] ([id]) ON DELETE CASCADE
);
