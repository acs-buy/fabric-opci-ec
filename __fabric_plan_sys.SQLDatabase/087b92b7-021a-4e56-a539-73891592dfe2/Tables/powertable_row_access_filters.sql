CREATE TABLE [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_row_access_filters]([recordGuid] ASC);
