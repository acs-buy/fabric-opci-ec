CREATE TABLE [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_column_config]([recordGuid] ASC);
