CREATE TABLE [52033849-181f-483f-b67d-f35f0ed7634c].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [52033849-181f-483f-b67d-f35f0ed7634c].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [52033849-181f-483f-b67d-f35f0ed7634c].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [52033849-181f-483f-b67d-f35f0ed7634c].[ib_query_writeback_destination]([recordGuid] ASC);
