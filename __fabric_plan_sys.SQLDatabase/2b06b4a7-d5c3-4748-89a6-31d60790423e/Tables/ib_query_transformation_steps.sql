CREATE TABLE [2b06b4a7-d5c3-4748-89a6-31d60790423e].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [2b06b4a7-d5c3-4748-89a6-31d60790423e].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [2b06b4a7-d5c3-4748-89a6-31d60790423e].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [2b06b4a7-d5c3-4748-89a6-31d60790423e].[ib_query_transformation_steps]([recordGuid] ASC);
