CREATE TABLE [2b06b4a7-d5c3-4748-89a6-31d60790423e].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [2b06b4a7-d5c3-4748-89a6-31d60790423e].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [2b06b4a7-d5c3-4748-89a6-31d60790423e].[powertable_lookup_config]([recordGuid] ASC);
