CREATE TABLE [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[ib_query_writeback_settings]([recordGuid] ASC);
