                ...
                CREATE PROCEDURE [f4f404e9-7898-4106-9f54-616374ef7645].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [f4f404e9-7898-4106-9f54-616374ef7645].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
