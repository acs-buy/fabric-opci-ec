      ...
      CREATE   PROCEDURE [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[ib_query_writeback] qw
