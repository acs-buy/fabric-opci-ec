CREATE TABLE [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_lookup_config]([recordGuid] ASC);
