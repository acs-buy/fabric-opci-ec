CREATE TABLE [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_approval]([recordGuid] ASC);
