CREATE TABLE [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[powertable_approval_request] ([id])
);
