CREATE TABLE [4564c828-5513-4f75-8148-7562146882ce].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [4564c828-5513-4f75-8148-7562146882ce].[powertable_approval_request] ([id])
);
