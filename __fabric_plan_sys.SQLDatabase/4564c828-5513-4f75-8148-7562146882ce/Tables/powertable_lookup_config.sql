CREATE TABLE [4564c828-5513-4f75-8148-7562146882ce].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [4564c828-5513-4f75-8148-7562146882ce].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [4564c828-5513-4f75-8148-7562146882ce].[powertable_lookup_config]([recordGuid] ASC);
