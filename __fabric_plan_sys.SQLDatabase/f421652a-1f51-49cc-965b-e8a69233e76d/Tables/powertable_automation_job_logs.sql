CREATE TABLE [f421652a-1f51-49cc-965b-e8a69233e76d].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [f421652a-1f51-49cc-965b-e8a69233e76d].[powertable_automation_jobs] ([id])
);
