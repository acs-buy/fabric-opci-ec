CREATE TABLE [5df03107-c058-4934-9696-943dffe44c90].[powertable_comment] (
    ...
    CONSTRAINT [FK_e923d030022f35af27a650126af] FOREIGN KEY ([sourceId]) REFERENCES [5df03107-c058-4934-9696-943dffe44c90].[powertable_source] ([id])
);
