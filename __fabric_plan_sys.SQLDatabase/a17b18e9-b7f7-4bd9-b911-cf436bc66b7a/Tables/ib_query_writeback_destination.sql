CREATE TABLE [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[ib_query_writeback_destination]([recordGuid] ASC);
