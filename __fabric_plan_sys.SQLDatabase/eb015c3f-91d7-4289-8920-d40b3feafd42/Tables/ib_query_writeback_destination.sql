CREATE TABLE [eb015c3f-91d7-4289-8920-d40b3feafd42].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [eb015c3f-91d7-4289-8920-d40b3feafd42].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [eb015c3f-91d7-4289-8920-d40b3feafd42].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [eb015c3f-91d7-4289-8920-d40b3feafd42].[ib_query_writeback_destination]([recordGuid] ASC);
