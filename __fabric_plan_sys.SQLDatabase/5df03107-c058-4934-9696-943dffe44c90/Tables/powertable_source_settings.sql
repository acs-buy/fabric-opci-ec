CREATE TABLE [5df03107-c058-4934-9696-943dffe44c90].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [5df03107-c058-4934-9696-943dffe44c90].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [5df03107-c058-4934-9696-943dffe44c90].[powertable_source_settings]([recordGuid] ASC);
