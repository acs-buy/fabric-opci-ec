CREATE TABLE [78a38abc-56bf-4310-b918-515ffd855204].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [78a38abc-56bf-4310-b918-515ffd855204].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [78a38abc-56bf-4310-b918-515ffd855204].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [78a38abc-56bf-4310-b918-515ffd855204].[ib_query_writeback_destination]([recordGuid] ASC);
