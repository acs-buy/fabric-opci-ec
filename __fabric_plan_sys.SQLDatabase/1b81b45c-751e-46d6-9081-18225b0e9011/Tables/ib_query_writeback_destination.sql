CREATE TABLE [1b81b45c-751e-46d6-9081-18225b0e9011].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [1b81b45c-751e-46d6-9081-18225b0e9011].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [1b81b45c-751e-46d6-9081-18225b0e9011].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [1b81b45c-751e-46d6-9081-18225b0e9011].[ib_query_writeback_destination]([recordGuid] ASC);
