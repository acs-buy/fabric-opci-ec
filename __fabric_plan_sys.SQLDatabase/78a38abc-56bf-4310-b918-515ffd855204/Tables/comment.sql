CREATE TABLE [78a38abc-56bf-4310-b918-515ffd855204].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [78a38abc-56bf-4310-b918-515ffd855204].[visual] ([id]) ON DELETE CASCADE
);
