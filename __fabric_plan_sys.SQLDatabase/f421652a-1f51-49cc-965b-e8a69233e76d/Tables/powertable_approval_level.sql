CREATE TABLE [f421652a-1f51-49cc-965b-e8a69233e76d].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [f421652a-1f51-49cc-965b-e8a69233e76d].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [f421652a-1f51-49cc-965b-e8a69233e76d].[powertable_approval_level]([recordGuid] ASC);
