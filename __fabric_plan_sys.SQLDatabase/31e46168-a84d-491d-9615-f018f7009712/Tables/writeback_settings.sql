CREATE TABLE [31e46168-a84d-491d-9615-f018f7009712].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [31e46168-a84d-491d-9615-f018f7009712].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [31e46168-a84d-491d-9615-f018f7009712].[writeback_settings]([recordGuid] ASC);
