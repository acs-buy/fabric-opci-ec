      ...
      CREATE   PROCEDURE [52033849-181f-483f-b67d-f35f0ed7634c].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [52033849-181f-483f-b67d-f35f0ed7634c].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [52033849-181f-483f-b67d-f35f0ed7634c].[ib_query_writeback] qw
