CREATE TABLE [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[powertable_approval_filter]([recordGuid] ASC);
