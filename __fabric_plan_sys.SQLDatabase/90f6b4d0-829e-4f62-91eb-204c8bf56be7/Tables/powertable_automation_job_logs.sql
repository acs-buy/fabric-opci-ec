CREATE TABLE [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[powertable_automation_jobs] ([id])
);
