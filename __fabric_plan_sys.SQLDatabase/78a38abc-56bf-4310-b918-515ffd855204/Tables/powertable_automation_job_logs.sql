CREATE TABLE [78a38abc-56bf-4310-b918-515ffd855204].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [78a38abc-56bf-4310-b918-515ffd855204].[powertable_automation_jobs] ([id])
);
