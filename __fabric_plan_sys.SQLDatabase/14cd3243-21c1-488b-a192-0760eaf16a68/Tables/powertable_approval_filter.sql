CREATE TABLE [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_approval_filter]([recordGuid] ASC);
