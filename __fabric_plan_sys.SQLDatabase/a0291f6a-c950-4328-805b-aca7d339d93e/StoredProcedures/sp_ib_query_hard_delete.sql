      ...
      CREATE   PROCEDURE [a0291f6a-c950-4328-805b-aca7d339d93e].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [a0291f6a-c950-4328-805b-aca7d339d93e].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [a0291f6a-c950-4328-805b-aca7d339d93e].[ib_query_writeback] qw
