      ...
      CREATE   PROCEDURE [5df03107-c058-4934-9696-943dffe44c90].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [5df03107-c058-4934-9696-943dffe44c90].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [5df03107-c058-4934-9696-943dffe44c90].[ib_query_writeback] qw
