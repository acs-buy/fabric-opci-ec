CREATE TABLE [eb015c3f-91d7-4289-8920-d40b3feafd42].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [eb015c3f-91d7-4289-8920-d40b3feafd42].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [eb015c3f-91d7-4289-8920-d40b3feafd42].[powertable_approval_filter]([recordGuid] ASC);
