CREATE TABLE [b0026fd3-dfdb-4602-bcf8-a36976552cee].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [b0026fd3-dfdb-4602-bcf8-a36976552cee].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [b0026fd3-dfdb-4602-bcf8-a36976552cee].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [b0026fd3-dfdb-4602-bcf8-a36976552cee].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [b0026fd3-dfdb-4602-bcf8-a36976552cee].[ib_source]([recordGuid] ASC);
