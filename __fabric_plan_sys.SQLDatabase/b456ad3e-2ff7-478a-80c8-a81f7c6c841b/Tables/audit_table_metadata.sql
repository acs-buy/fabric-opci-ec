CREATE TABLE [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
