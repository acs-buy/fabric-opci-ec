CREATE TABLE [2b06b4a7-d5c3-4748-89a6-31d60790423e].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [2b06b4a7-d5c3-4748-89a6-31d60790423e].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
