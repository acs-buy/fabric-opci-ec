CREATE TABLE [0d2c47cd-6740-4e30-9d88-b815bab60653].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [0d2c47cd-6740-4e30-9d88-b815bab60653].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [0d2c47cd-6740-4e30-9d88-b815bab60653].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [0d2c47cd-6740-4e30-9d88-b815bab60653].[ib_query_transformation_steps]([recordGuid] ASC);
