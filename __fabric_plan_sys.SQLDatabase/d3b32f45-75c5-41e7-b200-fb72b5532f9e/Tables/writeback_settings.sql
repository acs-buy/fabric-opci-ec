CREATE TABLE [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[writeback_settings]([recordGuid] ASC);
