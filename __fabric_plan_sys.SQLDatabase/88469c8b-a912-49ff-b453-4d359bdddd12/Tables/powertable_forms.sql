CREATE TABLE [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_forms]([recordGuid] ASC);
