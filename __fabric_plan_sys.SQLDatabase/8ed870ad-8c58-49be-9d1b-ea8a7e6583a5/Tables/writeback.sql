CREATE TABLE [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[writeback] (
    ...
    CONSTRAINT [FK_bbc1ed3d35bb48f8c0823c361c0] FOREIGN KEY ([visualId]) REFERENCES [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[visual] ([id])
);
