CREATE TABLE [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_row_access_filters]([recordGuid] ASC);
