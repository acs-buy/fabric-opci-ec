CREATE TABLE [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_attachment] (
    ...
    CONSTRAINT [FK_2bd05b1cc85a67483bedbced9c3] FOREIGN KEY ([sourceId]) REFERENCES [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_source] ([id])
);
