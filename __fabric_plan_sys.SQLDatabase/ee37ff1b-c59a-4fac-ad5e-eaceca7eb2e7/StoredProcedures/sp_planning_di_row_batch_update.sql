            ...
            CREATE PROCEDURE [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].data_input_row
                INNER JOIN [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
