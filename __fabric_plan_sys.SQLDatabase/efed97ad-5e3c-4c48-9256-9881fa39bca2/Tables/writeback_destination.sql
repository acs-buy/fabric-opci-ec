CREATE TABLE [efed97ad-5e3c-4c48-9256-9881fa39bca2].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [efed97ad-5e3c-4c48-9256-9881fa39bca2].[visual] ([id])
);
