                          ...
                          CREATE PROCEDURE [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].powertable_approval_request_rows
