CREATE TABLE [f421652a-1f51-49cc-965b-e8a69233e76d].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [f421652a-1f51-49cc-965b-e8a69233e76d].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [f421652a-1f51-49cc-965b-e8a69233e76d].[powertable_lookup_config]([recordGuid] ASC);
