CREATE TABLE [4564c828-5513-4f75-8148-7562146882ce].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [4564c828-5513-4f75-8148-7562146882ce].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [4564c828-5513-4f75-8148-7562146882ce].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
