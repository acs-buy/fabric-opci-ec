CREATE TABLE [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[ib_query_writeback_destination]([recordGuid] ASC);
