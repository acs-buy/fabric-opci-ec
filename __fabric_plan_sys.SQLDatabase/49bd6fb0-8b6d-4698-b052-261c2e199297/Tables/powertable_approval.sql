CREATE TABLE [49bd6fb0-8b6d-4698-b052-261c2e199297].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [49bd6fb0-8b6d-4698-b052-261c2e199297].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [49bd6fb0-8b6d-4698-b052-261c2e199297].[powertable_approval]([recordGuid] ASC);
