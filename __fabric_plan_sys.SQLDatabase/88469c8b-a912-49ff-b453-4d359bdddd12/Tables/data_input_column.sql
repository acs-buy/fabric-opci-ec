CREATE TABLE [88469c8b-a912-49ff-b453-4d359bdddd12].[data_input_column] (
    ...
    CONSTRAINT [FK_2f2ba9690ea788805bf78ae17a1] FOREIGN KEY ([visualId]) REFERENCES [88469c8b-a912-49ff-b453-4d359bdddd12].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [ix_data_input_column_hydration_cold]
    ON [88469c8b-a912-49ff-b453-4d359bdddd12].[data_input_column]([sidecarHydrationStatus] ASC) WHERE ([sidecarHydrationStatus] IN ((10), (30), (50)));
