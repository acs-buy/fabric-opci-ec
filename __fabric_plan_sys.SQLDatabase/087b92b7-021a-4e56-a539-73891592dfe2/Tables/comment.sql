CREATE TABLE [087b92b7-021a-4e56-a539-73891592dfe2].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [087b92b7-021a-4e56-a539-73891592dfe2].[visual] ([id]) ON DELETE CASCADE
);
