CREATE TABLE [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_automation_jobs] ([id])
);
