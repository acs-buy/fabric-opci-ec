CREATE TABLE [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[powertable_approval_level]([recordGuid] ASC);
