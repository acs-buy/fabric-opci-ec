CREATE TABLE [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_column_config]([recordGuid] ASC);
