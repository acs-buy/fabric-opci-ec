CREATE TABLE [0d2c47cd-6740-4e30-9d88-b815bab60653].[cube_partition_sync_logs] (
    ...
    CONSTRAINT [FK_c178596a53d6c303773a9095a21] FOREIGN KEY ([partitionMeasureId]) REFERENCES [0d2c47cd-6740-4e30-9d88-b815bab60653].[cube_partition_measure] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [0d2c47cd-6740-4e30-9d88-b815bab60653].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
