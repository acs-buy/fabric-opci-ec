CREATE TABLE [2942a440-8581-4a23-873f-cfa91145c17e].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [2942a440-8581-4a23-873f-cfa91145c17e].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [2942a440-8581-4a23-873f-cfa91145c17e].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [2942a440-8581-4a23-873f-cfa91145c17e].[ib_query_writeback_settings]([recordGuid] ASC);
