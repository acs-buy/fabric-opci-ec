CREATE TABLE [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[powertable_approval_level]([recordGuid] ASC);
