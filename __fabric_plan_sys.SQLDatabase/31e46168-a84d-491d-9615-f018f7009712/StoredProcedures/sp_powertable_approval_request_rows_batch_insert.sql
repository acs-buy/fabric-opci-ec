                ...
                CREATE PROCEDURE [31e46168-a84d-491d-9615-f018f7009712].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [31e46168-a84d-491d-9615-f018f7009712].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
