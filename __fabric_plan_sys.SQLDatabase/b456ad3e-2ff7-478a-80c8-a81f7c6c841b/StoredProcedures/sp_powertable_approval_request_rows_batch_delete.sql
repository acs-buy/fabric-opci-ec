              ...
              CREATE PROCEDURE [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].powertable_approval_request_rows SET status = 500 FROM [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
