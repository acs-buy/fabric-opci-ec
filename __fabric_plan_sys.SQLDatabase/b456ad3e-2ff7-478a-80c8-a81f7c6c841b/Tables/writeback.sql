CREATE TABLE [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[writeback] (
    ...
    CONSTRAINT [FK_bbc1ed3d35bb48f8c0823c361c0] FOREIGN KEY ([visualId]) REFERENCES [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[visual] ([id])
);
