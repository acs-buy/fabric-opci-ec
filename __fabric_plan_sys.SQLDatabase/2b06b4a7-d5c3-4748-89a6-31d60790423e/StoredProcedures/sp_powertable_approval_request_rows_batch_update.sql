                          ...
                          CREATE PROCEDURE [2b06b4a7-d5c3-4748-89a6-31d60790423e].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [2b06b4a7-d5c3-4748-89a6-31d60790423e].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [2b06b4a7-d5c3-4748-89a6-31d60790423e].powertable_approval_request_rows
