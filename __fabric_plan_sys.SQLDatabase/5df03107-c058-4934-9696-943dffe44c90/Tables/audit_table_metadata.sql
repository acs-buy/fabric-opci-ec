CREATE TABLE [5df03107-c058-4934-9696-943dffe44c90].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [5df03107-c058-4934-9696-943dffe44c90].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [5df03107-c058-4934-9696-943dffe44c90].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
