      ...
      CREATE   PROCEDURE [efed97ad-5e3c-4c48-9256-9881fa39bca2].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [efed97ad-5e3c-4c48-9256-9881fa39bca2].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [efed97ad-5e3c-4c48-9256-9881fa39bca2].[ib_query_writeback] qw
