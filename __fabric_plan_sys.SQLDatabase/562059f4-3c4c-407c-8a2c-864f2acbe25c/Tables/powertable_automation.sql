CREATE TABLE [562059f4-3c4c-407c-8a2c-864f2acbe25c].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [562059f4-3c4c-407c-8a2c-864f2acbe25c].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [562059f4-3c4c-407c-8a2c-864f2acbe25c].[powertable_automation]([recordGuid] ASC);
