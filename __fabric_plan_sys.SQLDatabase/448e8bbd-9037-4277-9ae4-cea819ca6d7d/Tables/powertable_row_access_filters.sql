CREATE TABLE [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[powertable_row_access_filters]([recordGuid] ASC);
