CREATE TABLE [52033849-181f-483f-b67d-f35f0ed7634c].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [52033849-181f-483f-b67d-f35f0ed7634c].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [52033849-181f-483f-b67d-f35f0ed7634c].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [52033849-181f-483f-b67d-f35f0ed7634c].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [52033849-181f-483f-b67d-f35f0ed7634c].[ib_source]([recordGuid] ASC);
