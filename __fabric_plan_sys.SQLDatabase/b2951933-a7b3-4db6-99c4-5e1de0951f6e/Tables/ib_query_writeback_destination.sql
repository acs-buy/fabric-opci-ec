CREATE TABLE [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[ib_query_writeback_destination]([recordGuid] ASC);
