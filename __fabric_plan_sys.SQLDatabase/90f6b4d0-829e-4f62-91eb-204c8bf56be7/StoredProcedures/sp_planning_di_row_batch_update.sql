            ...
            CREATE PROCEDURE [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [90f6b4d0-829e-4f62-91eb-204c8bf56be7].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [90f6b4d0-829e-4f62-91eb-204c8bf56be7].data_input_row
                INNER JOIN [90f6b4d0-829e-4f62-91eb-204c8bf56be7].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
