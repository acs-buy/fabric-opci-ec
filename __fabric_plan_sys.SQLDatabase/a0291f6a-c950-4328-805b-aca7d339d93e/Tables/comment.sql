CREATE TABLE [a0291f6a-c950-4328-805b-aca7d339d93e].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [a0291f6a-c950-4328-805b-aca7d339d93e].[visual] ([id]) ON DELETE CASCADE
);
