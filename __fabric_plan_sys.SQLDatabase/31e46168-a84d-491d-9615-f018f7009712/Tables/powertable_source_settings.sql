CREATE TABLE [31e46168-a84d-491d-9615-f018f7009712].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [31e46168-a84d-491d-9615-f018f7009712].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [31e46168-a84d-491d-9615-f018f7009712].[powertable_source_settings]([recordGuid] ASC);
