      ...
      CREATE   PROCEDURE [0d2c47cd-6740-4e30-9d88-b815bab60653].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [0d2c47cd-6740-4e30-9d88-b815bab60653].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [0d2c47cd-6740-4e30-9d88-b815bab60653].[ib_query_writeback] qw
