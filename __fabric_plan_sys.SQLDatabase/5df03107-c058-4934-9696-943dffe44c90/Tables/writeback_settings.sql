CREATE TABLE [5df03107-c058-4934-9696-943dffe44c90].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [5df03107-c058-4934-9696-943dffe44c90].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [5df03107-c058-4934-9696-943dffe44c90].[writeback_settings]([recordGuid] ASC);
