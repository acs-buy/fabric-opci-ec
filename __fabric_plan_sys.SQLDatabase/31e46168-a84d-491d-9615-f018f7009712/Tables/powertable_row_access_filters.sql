CREATE TABLE [31e46168-a84d-491d-9615-f018f7009712].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [31e46168-a84d-491d-9615-f018f7009712].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [31e46168-a84d-491d-9615-f018f7009712].[powertable_row_access_filters]([recordGuid] ASC);
