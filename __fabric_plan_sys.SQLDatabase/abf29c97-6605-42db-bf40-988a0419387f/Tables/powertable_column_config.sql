CREATE TABLE [abf29c97-6605-42db-bf40-988a0419387f].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [abf29c97-6605-42db-bf40-988a0419387f].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [abf29c97-6605-42db-bf40-988a0419387f].[powertable_column_config]([recordGuid] ASC);
