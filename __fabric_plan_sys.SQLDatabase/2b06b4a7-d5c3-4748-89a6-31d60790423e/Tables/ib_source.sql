CREATE TABLE [2b06b4a7-d5c3-4748-89a6-31d60790423e].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [2b06b4a7-d5c3-4748-89a6-31d60790423e].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [2b06b4a7-d5c3-4748-89a6-31d60790423e].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [2b06b4a7-d5c3-4748-89a6-31d60790423e].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [2b06b4a7-d5c3-4748-89a6-31d60790423e].[ib_source]([recordGuid] ASC);
