CREATE TABLE [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_approval_filter]([recordGuid] ASC);
