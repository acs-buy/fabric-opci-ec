CREATE TABLE [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_source_settings]([recordGuid] ASC);
