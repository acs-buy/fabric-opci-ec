CREATE TABLE [f4f404e9-7898-4106-9f54-616374ef7645].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [f4f404e9-7898-4106-9f54-616374ef7645].[visual] ([id]) ON DELETE CASCADE
);
