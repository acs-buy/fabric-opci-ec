CREATE TABLE [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_automation]([recordGuid] ASC);
