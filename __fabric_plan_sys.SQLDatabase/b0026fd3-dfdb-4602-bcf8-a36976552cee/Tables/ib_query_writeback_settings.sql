CREATE TABLE [b0026fd3-dfdb-4602-bcf8-a36976552cee].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [b0026fd3-dfdb-4602-bcf8-a36976552cee].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [b0026fd3-dfdb-4602-bcf8-a36976552cee].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [b0026fd3-dfdb-4602-bcf8-a36976552cee].[ib_query_writeback_settings]([recordGuid] ASC);
