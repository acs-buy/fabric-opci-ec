CREATE TABLE [49bd6fb0-8b6d-4698-b052-261c2e199297].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [49bd6fb0-8b6d-4698-b052-261c2e199297].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [49bd6fb0-8b6d-4698-b052-261c2e199297].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [49bd6fb0-8b6d-4698-b052-261c2e199297].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [49bd6fb0-8b6d-4698-b052-261c2e199297].[ib_source]([recordGuid] ASC);
