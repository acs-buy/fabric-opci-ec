CREATE TABLE [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
