CREATE TABLE [78a38abc-56bf-4310-b918-515ffd855204].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [78a38abc-56bf-4310-b918-515ffd855204].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [78a38abc-56bf-4310-b918-515ffd855204].[powertable_automation]([recordGuid] ASC);
