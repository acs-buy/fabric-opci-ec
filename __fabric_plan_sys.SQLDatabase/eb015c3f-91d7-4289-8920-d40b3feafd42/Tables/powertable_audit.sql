CREATE TABLE [eb015c3f-91d7-4289-8920-d40b3feafd42].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [eb015c3f-91d7-4289-8920-d40b3feafd42].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
