CREATE TABLE [a0291f6a-c950-4328-805b-aca7d339d93e].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [a0291f6a-c950-4328-805b-aca7d339d93e].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [a0291f6a-c950-4328-805b-aca7d339d93e].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
