CREATE TABLE [0d2c47cd-6740-4e30-9d88-b815bab60653].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [0d2c47cd-6740-4e30-9d88-b815bab60653].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [0d2c47cd-6740-4e30-9d88-b815bab60653].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [0d2c47cd-6740-4e30-9d88-b815bab60653].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [0d2c47cd-6740-4e30-9d88-b815bab60653].[ib_source]([recordGuid] ASC);
