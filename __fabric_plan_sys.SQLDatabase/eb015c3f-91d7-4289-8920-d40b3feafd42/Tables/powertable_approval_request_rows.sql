CREATE TABLE [eb015c3f-91d7-4289-8920-d40b3feafd42].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [eb015c3f-91d7-4289-8920-d40b3feafd42].[powertable_approval_request] ([id])
);
