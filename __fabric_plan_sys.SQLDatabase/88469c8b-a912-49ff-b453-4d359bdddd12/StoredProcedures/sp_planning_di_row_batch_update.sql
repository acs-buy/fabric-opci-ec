            ...
            CREATE PROCEDURE [88469c8b-a912-49ff-b453-4d359bdddd12].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [88469c8b-a912-49ff-b453-4d359bdddd12].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [88469c8b-a912-49ff-b453-4d359bdddd12].data_input_row
                INNER JOIN [88469c8b-a912-49ff-b453-4d359bdddd12].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
