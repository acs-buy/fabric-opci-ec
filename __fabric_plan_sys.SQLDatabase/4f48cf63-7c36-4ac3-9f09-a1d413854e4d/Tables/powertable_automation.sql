CREATE TABLE [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[powertable_automation]([recordGuid] ASC);
