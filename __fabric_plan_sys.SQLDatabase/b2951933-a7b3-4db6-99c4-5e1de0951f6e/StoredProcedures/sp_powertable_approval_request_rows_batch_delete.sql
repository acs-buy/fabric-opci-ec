              ...
              CREATE PROCEDURE [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [b2951933-a7b3-4db6-99c4-5e1de0951f6e].powertable_approval_request_rows SET status = 500 FROM [b2951933-a7b3-4db6-99c4-5e1de0951f6e].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
