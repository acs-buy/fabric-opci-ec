CREATE TABLE [b0026fd3-dfdb-4602-bcf8-a36976552cee].[cube_partition_sync_logs] (
    ...
    CONSTRAINT [FK_c178596a53d6c303773a9095a21] FOREIGN KEY ([partitionMeasureId]) REFERENCES [b0026fd3-dfdb-4602-bcf8-a36976552cee].[cube_partition_measure] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [b0026fd3-dfdb-4602-bcf8-a36976552cee].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
