                ...
                CREATE PROCEDURE [087b92b7-021a-4e56-a539-73891592dfe2].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [087b92b7-021a-4e56-a539-73891592dfe2].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
