CREATE TABLE [562059f4-3c4c-407c-8a2c-864f2acbe25c].[cube_partition_sync_logs] (
    ...
    CONSTRAINT [FK_c178596a53d6c303773a9095a21] FOREIGN KEY ([partitionMeasureId]) REFERENCES [562059f4-3c4c-407c-8a2c-864f2acbe25c].[cube_partition_measure] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [562059f4-3c4c-407c-8a2c-864f2acbe25c].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
