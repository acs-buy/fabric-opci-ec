CREATE TABLE [78a38abc-56bf-4310-b918-515ffd855204].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [78a38abc-56bf-4310-b918-515ffd855204].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [78a38abc-56bf-4310-b918-515ffd855204].[powertable_approval_level]([recordGuid] ASC);
