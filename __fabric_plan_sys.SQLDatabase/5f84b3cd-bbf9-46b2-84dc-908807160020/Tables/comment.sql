CREATE TABLE [5f84b3cd-bbf9-46b2-84dc-908807160020].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [5f84b3cd-bbf9-46b2-84dc-908807160020].[visual] ([id]) ON DELETE CASCADE
);
