CREATE TABLE [087b92b7-021a-4e56-a539-73891592dfe2].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [087b92b7-021a-4e56-a539-73891592dfe2].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [087b92b7-021a-4e56-a539-73891592dfe2].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [087b92b7-021a-4e56-a539-73891592dfe2].[ib_query_transformation_steps]([recordGuid] ASC);
