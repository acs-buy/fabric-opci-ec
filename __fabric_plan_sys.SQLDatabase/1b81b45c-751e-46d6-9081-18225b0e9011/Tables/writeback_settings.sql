CREATE TABLE [1b81b45c-751e-46d6-9081-18225b0e9011].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [1b81b45c-751e-46d6-9081-18225b0e9011].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [1b81b45c-751e-46d6-9081-18225b0e9011].[writeback_settings]([recordGuid] ASC);
