CREATE TABLE [0d2c47cd-6740-4e30-9d88-b815bab60653].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [0d2c47cd-6740-4e30-9d88-b815bab60653].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [0d2c47cd-6740-4e30-9d88-b815bab60653].[powertable_row_access_filters]([recordGuid] ASC);
