CREATE TABLE [5df03107-c058-4934-9696-943dffe44c90].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [5df03107-c058-4934-9696-943dffe44c90].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [5df03107-c058-4934-9696-943dffe44c90].[powertable_approval_level]([recordGuid] ASC);
