              ...
              CREATE PROCEDURE [0d2c47cd-6740-4e30-9d88-b815bab60653].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [0d2c47cd-6740-4e30-9d88-b815bab60653].powertable_approval_request_rows SET status = 500 FROM [0d2c47cd-6740-4e30-9d88-b815bab60653].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
