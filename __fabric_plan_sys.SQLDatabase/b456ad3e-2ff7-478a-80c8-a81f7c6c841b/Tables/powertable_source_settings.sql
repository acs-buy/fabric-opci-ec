CREATE TABLE [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[powertable_source_settings]([recordGuid] ASC);
