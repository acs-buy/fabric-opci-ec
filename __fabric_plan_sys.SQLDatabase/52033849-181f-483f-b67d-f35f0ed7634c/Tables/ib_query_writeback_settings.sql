CREATE TABLE [52033849-181f-483f-b67d-f35f0ed7634c].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [52033849-181f-483f-b67d-f35f0ed7634c].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [52033849-181f-483f-b67d-f35f0ed7634c].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [52033849-181f-483f-b67d-f35f0ed7634c].[ib_query_writeback_settings]([recordGuid] ASC);
