CREATE TABLE [78a38abc-56bf-4310-b918-515ffd855204].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [78a38abc-56bf-4310-b918-515ffd855204].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [78a38abc-56bf-4310-b918-515ffd855204].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [78a38abc-56bf-4310-b918-515ffd855204].[ib_query_transformation_steps]([recordGuid] ASC);
