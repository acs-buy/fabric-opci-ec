CREATE TABLE [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[writeback_settings]([recordGuid] ASC);
