CREATE TABLE [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[visual] ([id]) ON DELETE CASCADE
);
