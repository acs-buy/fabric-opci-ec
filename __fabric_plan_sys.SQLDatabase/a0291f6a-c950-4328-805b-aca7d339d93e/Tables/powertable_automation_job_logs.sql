CREATE TABLE [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_automation_jobs] ([id])
);
