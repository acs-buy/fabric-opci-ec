CREATE TABLE [a0291f6a-c950-4328-805b-aca7d339d93e].[cube_partition_sync_logs] (
    ...
    CONSTRAINT [FK_c178596a53d6c303773a9095a21] FOREIGN KEY ([partitionMeasureId]) REFERENCES [a0291f6a-c950-4328-805b-aca7d339d93e].[cube_partition_measure] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [a0291f6a-c950-4328-805b-aca7d339d93e].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
