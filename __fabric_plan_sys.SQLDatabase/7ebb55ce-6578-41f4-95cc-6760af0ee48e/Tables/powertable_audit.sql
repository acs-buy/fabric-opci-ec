CREATE TABLE [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
