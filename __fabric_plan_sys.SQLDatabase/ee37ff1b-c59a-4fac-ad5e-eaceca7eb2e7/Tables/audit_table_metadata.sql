CREATE TABLE [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
