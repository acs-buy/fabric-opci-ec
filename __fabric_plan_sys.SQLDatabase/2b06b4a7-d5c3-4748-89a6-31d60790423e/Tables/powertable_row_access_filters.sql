CREATE TABLE [2b06b4a7-d5c3-4748-89a6-31d60790423e].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [2b06b4a7-d5c3-4748-89a6-31d60790423e].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [2b06b4a7-d5c3-4748-89a6-31d60790423e].[powertable_row_access_filters]([recordGuid] ASC);
