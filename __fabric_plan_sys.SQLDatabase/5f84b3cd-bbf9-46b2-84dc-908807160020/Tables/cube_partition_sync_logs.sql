CREATE TABLE [5f84b3cd-bbf9-46b2-84dc-908807160020].[cube_partition_sync_logs] (
    ...
    CONSTRAINT [FK_c178596a53d6c303773a9095a21] FOREIGN KEY ([partitionMeasureId]) REFERENCES [5f84b3cd-bbf9-46b2-84dc-908807160020].[cube_partition_measure] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [5f84b3cd-bbf9-46b2-84dc-908807160020].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
