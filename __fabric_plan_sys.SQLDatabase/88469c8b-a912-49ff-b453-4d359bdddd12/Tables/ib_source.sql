CREATE TABLE [88469c8b-a912-49ff-b453-4d359bdddd12].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [88469c8b-a912-49ff-b453-4d359bdddd12].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [88469c8b-a912-49ff-b453-4d359bdddd12].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [88469c8b-a912-49ff-b453-4d359bdddd12].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [88469c8b-a912-49ff-b453-4d359bdddd12].[ib_source]([recordGuid] ASC);
