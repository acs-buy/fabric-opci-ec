CREATE TABLE [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[visual] ([id]) ON DELETE CASCADE
);
