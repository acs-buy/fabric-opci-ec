CREATE TABLE [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[visual] ([id]) ON DELETE CASCADE
);
