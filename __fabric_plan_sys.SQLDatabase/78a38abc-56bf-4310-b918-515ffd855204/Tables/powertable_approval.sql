CREATE TABLE [78a38abc-56bf-4310-b918-515ffd855204].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [78a38abc-56bf-4310-b918-515ffd855204].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [78a38abc-56bf-4310-b918-515ffd855204].[powertable_approval]([recordGuid] ASC);
