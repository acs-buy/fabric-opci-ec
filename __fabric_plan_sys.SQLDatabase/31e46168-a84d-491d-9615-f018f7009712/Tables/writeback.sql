CREATE TABLE [31e46168-a84d-491d-9615-f018f7009712].[writeback] (
    ...
    CONSTRAINT [FK_bbc1ed3d35bb48f8c0823c361c0] FOREIGN KEY ([visualId]) REFERENCES [31e46168-a84d-491d-9615-f018f7009712].[visual] ([id])
);
