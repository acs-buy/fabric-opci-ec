CREATE TABLE [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_automation_jobs] ([id])
);
