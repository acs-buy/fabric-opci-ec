CREATE TABLE [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[powertable_column_config]([recordGuid] ASC);
