CREATE TABLE [78a38abc-56bf-4310-b918-515ffd855204].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [78a38abc-56bf-4310-b918-515ffd855204].[powertable_approval_request] ([id])
);
