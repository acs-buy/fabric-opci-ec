CREATE TABLE [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[ib_source]([recordGuid] ASC);
