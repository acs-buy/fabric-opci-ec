CREATE TABLE [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_approval_request] ([id])
);
