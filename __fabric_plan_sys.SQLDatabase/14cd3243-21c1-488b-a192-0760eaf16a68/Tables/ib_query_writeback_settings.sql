CREATE TABLE [14cd3243-21c1-488b-a192-0760eaf16a68].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [14cd3243-21c1-488b-a192-0760eaf16a68].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [14cd3243-21c1-488b-a192-0760eaf16a68].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [14cd3243-21c1-488b-a192-0760eaf16a68].[ib_query_writeback_settings]([recordGuid] ASC);
