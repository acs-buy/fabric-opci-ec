CREATE TABLE [562059f4-3c4c-407c-8a2c-864f2acbe25c].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [562059f4-3c4c-407c-8a2c-864f2acbe25c].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [562059f4-3c4c-407c-8a2c-864f2acbe25c].[powertable_approval_level]([recordGuid] ASC);
