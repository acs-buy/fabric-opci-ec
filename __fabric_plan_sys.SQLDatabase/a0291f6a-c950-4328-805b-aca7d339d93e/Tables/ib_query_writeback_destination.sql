CREATE TABLE [a0291f6a-c950-4328-805b-aca7d339d93e].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [a0291f6a-c950-4328-805b-aca7d339d93e].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [a0291f6a-c950-4328-805b-aca7d339d93e].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [a0291f6a-c950-4328-805b-aca7d339d93e].[ib_query_writeback_destination]([recordGuid] ASC);
