CREATE TABLE [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[powertable_approval_request] ([id])
);
