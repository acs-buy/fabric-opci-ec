CREATE TABLE [31e46168-a84d-491d-9615-f018f7009712].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [31e46168-a84d-491d-9615-f018f7009712].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [31e46168-a84d-491d-9615-f018f7009712].[powertable_lookup_config]([recordGuid] ASC);
