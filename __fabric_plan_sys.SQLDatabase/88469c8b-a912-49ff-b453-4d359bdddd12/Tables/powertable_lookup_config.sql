CREATE TABLE [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_lookup_config]([recordGuid] ASC);
