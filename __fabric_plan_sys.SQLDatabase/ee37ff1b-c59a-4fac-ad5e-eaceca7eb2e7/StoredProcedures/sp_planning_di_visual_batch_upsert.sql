        ...
        CREATE   PROCEDURE [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].' + QUOTENAME(@DIVTableName) + ' AS div
