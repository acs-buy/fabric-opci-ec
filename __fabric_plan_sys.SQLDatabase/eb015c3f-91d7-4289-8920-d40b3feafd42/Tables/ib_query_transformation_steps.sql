CREATE TABLE [eb015c3f-91d7-4289-8920-d40b3feafd42].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [eb015c3f-91d7-4289-8920-d40b3feafd42].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [eb015c3f-91d7-4289-8920-d40b3feafd42].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [eb015c3f-91d7-4289-8920-d40b3feafd42].[ib_query_transformation_steps]([recordGuid] ASC);
