        ...
        CREATE   PROCEDURE [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [7ebb55ce-6578-41f4-95cc-6760af0ee48e].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [7ebb55ce-6578-41f4-95cc-6760af0ee48e].' + QUOTENAME(@DIVTableName) + ' AS div
