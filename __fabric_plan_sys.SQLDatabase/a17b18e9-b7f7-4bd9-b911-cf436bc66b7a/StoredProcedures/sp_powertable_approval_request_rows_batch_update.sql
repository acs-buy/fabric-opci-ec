                          ...
                          CREATE PROCEDURE [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].powertable_approval_request_rows
