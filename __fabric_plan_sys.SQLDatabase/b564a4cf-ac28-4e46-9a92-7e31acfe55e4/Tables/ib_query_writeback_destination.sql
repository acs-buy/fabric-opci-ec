CREATE TABLE [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[ib_query_writeback_destination]([recordGuid] ASC);
