CREATE TABLE [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[ib_query_writeback_settings]([recordGuid] ASC);
