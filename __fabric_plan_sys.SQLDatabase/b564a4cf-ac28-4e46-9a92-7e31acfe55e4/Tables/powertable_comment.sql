CREATE TABLE [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[powertable_comment] (
    ...
    CONSTRAINT [FK_e923d030022f35af27a650126af] FOREIGN KEY ([sourceId]) REFERENCES [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[powertable_source] ([id])
);
