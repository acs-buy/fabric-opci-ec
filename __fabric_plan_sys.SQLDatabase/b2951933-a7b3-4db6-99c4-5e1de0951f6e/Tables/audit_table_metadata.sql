CREATE TABLE [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
