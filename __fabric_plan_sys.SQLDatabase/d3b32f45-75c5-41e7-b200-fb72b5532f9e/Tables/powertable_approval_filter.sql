CREATE TABLE [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[powertable_approval_filter]([recordGuid] ASC);
