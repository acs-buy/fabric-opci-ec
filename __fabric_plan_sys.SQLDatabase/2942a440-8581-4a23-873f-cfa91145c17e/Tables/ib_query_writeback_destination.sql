CREATE TABLE [2942a440-8581-4a23-873f-cfa91145c17e].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [2942a440-8581-4a23-873f-cfa91145c17e].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [2942a440-8581-4a23-873f-cfa91145c17e].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [2942a440-8581-4a23-873f-cfa91145c17e].[ib_query_writeback_destination]([recordGuid] ASC);
