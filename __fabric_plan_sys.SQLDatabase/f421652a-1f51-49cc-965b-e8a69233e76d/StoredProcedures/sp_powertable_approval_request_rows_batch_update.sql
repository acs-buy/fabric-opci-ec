                          ...
                          CREATE PROCEDURE [f421652a-1f51-49cc-965b-e8a69233e76d].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [f421652a-1f51-49cc-965b-e8a69233e76d].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [f421652a-1f51-49cc-965b-e8a69233e76d].powertable_approval_request_rows
