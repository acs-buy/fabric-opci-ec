CREATE TABLE [abf29c97-6605-42db-bf40-988a0419387f].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [abf29c97-6605-42db-bf40-988a0419387f].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [abf29c97-6605-42db-bf40-988a0419387f].[powertable_approval_filter]([recordGuid] ASC);
