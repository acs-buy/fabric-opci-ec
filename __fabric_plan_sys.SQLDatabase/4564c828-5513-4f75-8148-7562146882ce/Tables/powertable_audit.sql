CREATE TABLE [4564c828-5513-4f75-8148-7562146882ce].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [4564c828-5513-4f75-8148-7562146882ce].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
