CREATE TABLE [4564c828-5513-4f75-8148-7562146882ce].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [4564c828-5513-4f75-8148-7562146882ce].[powertable_automation_jobs] ([id])
);
