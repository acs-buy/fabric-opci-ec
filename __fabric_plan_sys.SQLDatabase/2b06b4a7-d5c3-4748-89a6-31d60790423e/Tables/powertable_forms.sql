CREATE TABLE [2b06b4a7-d5c3-4748-89a6-31d60790423e].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [2b06b4a7-d5c3-4748-89a6-31d60790423e].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [2b06b4a7-d5c3-4748-89a6-31d60790423e].[powertable_forms]([recordGuid] ASC);
