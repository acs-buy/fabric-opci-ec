CREATE TABLE [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[ib_query_writeback_destination]([recordGuid] ASC);
