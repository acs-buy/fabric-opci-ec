CREATE TABLE [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
