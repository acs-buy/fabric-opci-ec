CREATE TABLE [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_column_config]([recordGuid] ASC);
