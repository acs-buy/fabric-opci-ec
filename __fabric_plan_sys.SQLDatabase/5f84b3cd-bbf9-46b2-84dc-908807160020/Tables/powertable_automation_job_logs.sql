CREATE TABLE [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_automation_jobs] ([id])
);
