CREATE TABLE [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[powertable_approval_level]([recordGuid] ASC);
