              ...
              CREATE PROCEDURE [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [7ebb55ce-6578-41f4-95cc-6760af0ee48e].powertable_approval_request_rows SET status = 500 FROM [7ebb55ce-6578-41f4-95cc-6760af0ee48e].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
