CREATE TABLE [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_automation_jobs] ([id])
);
