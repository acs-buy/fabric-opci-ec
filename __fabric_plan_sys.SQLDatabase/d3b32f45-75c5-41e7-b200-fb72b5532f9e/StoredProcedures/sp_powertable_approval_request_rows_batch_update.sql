                          ...
                          CREATE PROCEDURE [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [d3b32f45-75c5-41e7-b200-fb72b5532f9e].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [d3b32f45-75c5-41e7-b200-fb72b5532f9e].powertable_approval_request_rows
