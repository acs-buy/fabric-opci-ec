CREATE TABLE [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[ib_query_writeback_settings]([recordGuid] ASC);
