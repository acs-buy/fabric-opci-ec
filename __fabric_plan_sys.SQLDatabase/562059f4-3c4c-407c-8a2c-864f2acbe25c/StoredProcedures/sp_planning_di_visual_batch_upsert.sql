        ...
        CREATE   PROCEDURE [562059f4-3c4c-407c-8a2c-864f2acbe25c].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [562059f4-3c4c-407c-8a2c-864f2acbe25c].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [562059f4-3c4c-407c-8a2c-864f2acbe25c].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [562059f4-3c4c-407c-8a2c-864f2acbe25c].' + QUOTENAME(@DIVTableName) + ' AS div
