CREATE TABLE [14cd3243-21c1-488b-a192-0760eaf16a68].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [14cd3243-21c1-488b-a192-0760eaf16a68].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [14cd3243-21c1-488b-a192-0760eaf16a68].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [14cd3243-21c1-488b-a192-0760eaf16a68].[ib_query_transformation_steps]([recordGuid] ASC);
