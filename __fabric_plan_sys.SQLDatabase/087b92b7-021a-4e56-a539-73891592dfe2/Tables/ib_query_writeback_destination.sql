CREATE TABLE [087b92b7-021a-4e56-a539-73891592dfe2].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [087b92b7-021a-4e56-a539-73891592dfe2].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [087b92b7-021a-4e56-a539-73891592dfe2].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [087b92b7-021a-4e56-a539-73891592dfe2].[ib_query_writeback_destination]([recordGuid] ASC);
