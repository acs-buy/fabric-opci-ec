      ...
      CREATE   PROCEDURE [49bd6fb0-8b6d-4698-b052-261c2e199297].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [49bd6fb0-8b6d-4698-b052-261c2e199297].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [49bd6fb0-8b6d-4698-b052-261c2e199297].[ib_query_writeback] qw
