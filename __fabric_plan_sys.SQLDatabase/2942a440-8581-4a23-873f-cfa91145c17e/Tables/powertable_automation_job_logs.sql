CREATE TABLE [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_automation_jobs] ([id])
);
