CREATE TABLE [eb015c3f-91d7-4289-8920-d40b3feafd42].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [eb015c3f-91d7-4289-8920-d40b3feafd42].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [eb015c3f-91d7-4289-8920-d40b3feafd42].[powertable_row_access_filters]([recordGuid] ASC);
