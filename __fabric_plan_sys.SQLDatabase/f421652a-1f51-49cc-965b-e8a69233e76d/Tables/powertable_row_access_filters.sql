CREATE TABLE [f421652a-1f51-49cc-965b-e8a69233e76d].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [f421652a-1f51-49cc-965b-e8a69233e76d].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [f421652a-1f51-49cc-965b-e8a69233e76d].[powertable_row_access_filters]([recordGuid] ASC);
