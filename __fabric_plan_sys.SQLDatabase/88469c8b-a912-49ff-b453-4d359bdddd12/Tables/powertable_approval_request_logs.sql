CREATE TABLE [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_approval_request] ([id])
);
