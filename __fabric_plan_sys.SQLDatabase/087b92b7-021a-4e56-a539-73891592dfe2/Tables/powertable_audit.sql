CREATE TABLE [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
