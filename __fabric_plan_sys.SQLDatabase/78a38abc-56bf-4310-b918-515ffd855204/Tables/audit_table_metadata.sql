CREATE TABLE [78a38abc-56bf-4310-b918-515ffd855204].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [78a38abc-56bf-4310-b918-515ffd855204].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [78a38abc-56bf-4310-b918-515ffd855204].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
