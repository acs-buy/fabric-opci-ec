CREATE TABLE [14cd3243-21c1-488b-a192-0760eaf16a68].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [14cd3243-21c1-488b-a192-0760eaf16a68].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [14cd3243-21c1-488b-a192-0760eaf16a68].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [14cd3243-21c1-488b-a192-0760eaf16a68].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [14cd3243-21c1-488b-a192-0760eaf16a68].[ib_source]([recordGuid] ASC);
