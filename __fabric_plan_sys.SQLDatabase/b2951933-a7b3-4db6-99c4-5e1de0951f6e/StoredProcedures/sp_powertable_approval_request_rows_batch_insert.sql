                ...
                CREATE PROCEDURE [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [b2951933-a7b3-4db6-99c4-5e1de0951f6e].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
