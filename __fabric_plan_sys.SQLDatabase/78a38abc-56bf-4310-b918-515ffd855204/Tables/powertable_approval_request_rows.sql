CREATE TABLE [78a38abc-56bf-4310-b918-515ffd855204].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [78a38abc-56bf-4310-b918-515ffd855204].[powertable_approval_request] ([id])
);
