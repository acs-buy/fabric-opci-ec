CREATE TABLE [31e46168-a84d-491d-9615-f018f7009712].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [31e46168-a84d-491d-9615-f018f7009712].[powertable_automation_jobs] ([id])
);
