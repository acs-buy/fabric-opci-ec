CREATE TABLE [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
