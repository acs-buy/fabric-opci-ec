CREATE TABLE [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_approval_request] ([id])
);
