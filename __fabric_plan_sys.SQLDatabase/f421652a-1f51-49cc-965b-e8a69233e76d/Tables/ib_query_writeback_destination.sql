CREATE TABLE [f421652a-1f51-49cc-965b-e8a69233e76d].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [f421652a-1f51-49cc-965b-e8a69233e76d].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [f421652a-1f51-49cc-965b-e8a69233e76d].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [f421652a-1f51-49cc-965b-e8a69233e76d].[ib_query_writeback_destination]([recordGuid] ASC);
