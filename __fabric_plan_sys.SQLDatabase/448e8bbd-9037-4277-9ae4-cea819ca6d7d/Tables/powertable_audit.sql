CREATE TABLE [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
