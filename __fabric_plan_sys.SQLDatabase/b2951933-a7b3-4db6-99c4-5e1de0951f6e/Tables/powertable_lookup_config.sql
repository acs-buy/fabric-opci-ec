CREATE TABLE [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[powertable_lookup_config]([recordGuid] ASC);
