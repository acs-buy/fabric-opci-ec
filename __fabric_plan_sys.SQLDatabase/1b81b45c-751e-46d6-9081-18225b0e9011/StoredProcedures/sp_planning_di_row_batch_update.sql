            ...
            CREATE PROCEDURE [1b81b45c-751e-46d6-9081-18225b0e9011].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [1b81b45c-751e-46d6-9081-18225b0e9011].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [1b81b45c-751e-46d6-9081-18225b0e9011].data_input_row
                INNER JOIN [1b81b45c-751e-46d6-9081-18225b0e9011].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
