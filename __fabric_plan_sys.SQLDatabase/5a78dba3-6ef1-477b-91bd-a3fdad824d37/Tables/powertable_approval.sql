CREATE TABLE [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_approval]([recordGuid] ASC);
