CREATE TABLE [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_attachment] (
    ...
    CONSTRAINT [FK_2bd05b1cc85a67483bedbced9c3] FOREIGN KEY ([sourceId]) REFERENCES [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_source] ([id])
);
