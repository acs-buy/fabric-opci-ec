CREATE TABLE [562059f4-3c4c-407c-8a2c-864f2acbe25c].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [562059f4-3c4c-407c-8a2c-864f2acbe25c].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
