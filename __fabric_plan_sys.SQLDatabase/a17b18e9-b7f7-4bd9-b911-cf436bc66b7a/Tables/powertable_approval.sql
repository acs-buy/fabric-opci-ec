CREATE TABLE [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[powertable_approval]([recordGuid] ASC);
