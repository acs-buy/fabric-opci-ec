CREATE TABLE [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[powertable_comment] (
    ...
    CONSTRAINT [FK_e923d030022f35af27a650126af] FOREIGN KEY ([sourceId]) REFERENCES [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[powertable_source] ([id])
);
