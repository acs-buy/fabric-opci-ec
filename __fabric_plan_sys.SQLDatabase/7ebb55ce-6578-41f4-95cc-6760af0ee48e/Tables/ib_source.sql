CREATE TABLE [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[ib_source]([recordGuid] ASC);
