CREATE TABLE [087b92b7-021a-4e56-a539-73891592dfe2].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [087b92b7-021a-4e56-a539-73891592dfe2].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [087b92b7-021a-4e56-a539-73891592dfe2].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [087b92b7-021a-4e56-a539-73891592dfe2].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [087b92b7-021a-4e56-a539-73891592dfe2].[ib_source]([recordGuid] ASC);
