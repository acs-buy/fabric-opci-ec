CREATE TABLE [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_column_config]([recordGuid] ASC);
