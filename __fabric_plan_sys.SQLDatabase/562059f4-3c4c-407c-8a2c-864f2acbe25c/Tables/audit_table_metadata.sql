CREATE TABLE [562059f4-3c4c-407c-8a2c-864f2acbe25c].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [562059f4-3c4c-407c-8a2c-864f2acbe25c].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [562059f4-3c4c-407c-8a2c-864f2acbe25c].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
