                          ...
                          CREATE PROCEDURE [abf29c97-6605-42db-bf40-988a0419387f].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [abf29c97-6605-42db-bf40-988a0419387f].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [abf29c97-6605-42db-bf40-988a0419387f].powertable_approval_request_rows
