      ...
      CREATE   PROCEDURE [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[ib_query_writeback] qw
