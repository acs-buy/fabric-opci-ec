      ...
      CREATE   PROCEDURE [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[ib_query_writeback] qw
