      ...
      CREATE   PROCEDURE [31e46168-a84d-491d-9615-f018f7009712].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [31e46168-a84d-491d-9615-f018f7009712].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [31e46168-a84d-491d-9615-f018f7009712].[ib_query_writeback] qw
