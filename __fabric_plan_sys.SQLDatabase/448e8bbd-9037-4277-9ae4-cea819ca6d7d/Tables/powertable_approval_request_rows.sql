CREATE TABLE [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[powertable_approval_request] ([id])
);
