CREATE TABLE [52033849-181f-483f-b67d-f35f0ed7634c].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [52033849-181f-483f-b67d-f35f0ed7634c].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [52033849-181f-483f-b67d-f35f0ed7634c].[powertable_column_config]([recordGuid] ASC);
