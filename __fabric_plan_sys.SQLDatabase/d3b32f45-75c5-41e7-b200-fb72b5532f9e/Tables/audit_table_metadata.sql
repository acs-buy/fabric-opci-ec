CREATE TABLE [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
