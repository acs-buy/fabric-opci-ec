CREATE TABLE [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[ib_query_transformation_steps]([recordGuid] ASC);
