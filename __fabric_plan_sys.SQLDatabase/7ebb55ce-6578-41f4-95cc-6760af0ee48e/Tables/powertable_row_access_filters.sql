CREATE TABLE [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[powertable_row_access_filters]([recordGuid] ASC);
