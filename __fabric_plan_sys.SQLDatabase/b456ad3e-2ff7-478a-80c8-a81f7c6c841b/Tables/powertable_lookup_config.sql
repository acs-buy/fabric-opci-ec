CREATE TABLE [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[powertable_lookup_config]([recordGuid] ASC);
