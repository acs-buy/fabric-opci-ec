CREATE TABLE [abf29c97-6605-42db-bf40-988a0419387f].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [abf29c97-6605-42db-bf40-988a0419387f].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [abf29c97-6605-42db-bf40-988a0419387f].[powertable_approval]([recordGuid] ASC);
