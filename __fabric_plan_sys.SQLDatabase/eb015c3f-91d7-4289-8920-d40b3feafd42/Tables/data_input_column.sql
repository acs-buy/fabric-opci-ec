CREATE TABLE [eb015c3f-91d7-4289-8920-d40b3feafd42].[data_input_column] (
    ...
    CONSTRAINT [FK_2f2ba9690ea788805bf78ae17a1] FOREIGN KEY ([visualId]) REFERENCES [eb015c3f-91d7-4289-8920-d40b3feafd42].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [ix_data_input_column_hydration_cold]
    ON [eb015c3f-91d7-4289-8920-d40b3feafd42].[data_input_column]([sidecarHydrationStatus] ASC) WHERE ([sidecarHydrationStatus] IN ((10), (30), (50)));
