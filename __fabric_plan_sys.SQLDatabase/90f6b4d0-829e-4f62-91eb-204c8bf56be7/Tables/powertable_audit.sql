CREATE TABLE [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
