CREATE TABLE [49bd6fb0-8b6d-4698-b052-261c2e199297].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [49bd6fb0-8b6d-4698-b052-261c2e199297].[powertable_approval_request] ([id])
);
