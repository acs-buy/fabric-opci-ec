CREATE TABLE [efed97ad-5e3c-4c48-9256-9881fa39bca2].[data_input_column] (
    ...
    CONSTRAINT [FK_2f2ba9690ea788805bf78ae17a1] FOREIGN KEY ([visualId]) REFERENCES [efed97ad-5e3c-4c48-9256-9881fa39bca2].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [ix_data_input_column_hydration_cold]
    ON [efed97ad-5e3c-4c48-9256-9881fa39bca2].[data_input_column]([sidecarHydrationStatus] ASC) WHERE ([sidecarHydrationStatus] IN ((10), (30), (50)));
