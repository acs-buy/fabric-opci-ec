              ...
              CREATE PROCEDURE [78a38abc-56bf-4310-b918-515ffd855204].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [78a38abc-56bf-4310-b918-515ffd855204].powertable_approval_request_rows SET status = 500 FROM [78a38abc-56bf-4310-b918-515ffd855204].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
