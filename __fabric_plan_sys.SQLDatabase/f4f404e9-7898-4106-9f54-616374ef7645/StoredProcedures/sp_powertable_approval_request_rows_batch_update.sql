                          ...
                          CREATE PROCEDURE [f4f404e9-7898-4106-9f54-616374ef7645].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [f4f404e9-7898-4106-9f54-616374ef7645].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [f4f404e9-7898-4106-9f54-616374ef7645].powertable_approval_request_rows
