CREATE TABLE [2b06b4a7-d5c3-4748-89a6-31d60790423e].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [2b06b4a7-d5c3-4748-89a6-31d60790423e].[visual] ([id]) ON DELETE CASCADE
);
