CREATE TABLE [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[powertable_lookup_config]([recordGuid] ASC);
