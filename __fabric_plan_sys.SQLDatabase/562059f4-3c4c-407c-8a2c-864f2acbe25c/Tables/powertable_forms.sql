CREATE TABLE [562059f4-3c4c-407c-8a2c-864f2acbe25c].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [562059f4-3c4c-407c-8a2c-864f2acbe25c].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [562059f4-3c4c-407c-8a2c-864f2acbe25c].[powertable_forms]([recordGuid] ASC);
