CREATE TABLE [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[powertable_approval_level]([recordGuid] ASC);
