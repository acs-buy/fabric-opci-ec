CREATE TABLE [562059f4-3c4c-407c-8a2c-864f2acbe25c].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [562059f4-3c4c-407c-8a2c-864f2acbe25c].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [562059f4-3c4c-407c-8a2c-864f2acbe25c].[powertable_row_access_filters]([recordGuid] ASC);
