CREATE TABLE [88469c8b-a912-49ff-b453-4d359bdddd12].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [88469c8b-a912-49ff-b453-4d359bdddd12].[visual] ([id]) ON DELETE CASCADE
);
