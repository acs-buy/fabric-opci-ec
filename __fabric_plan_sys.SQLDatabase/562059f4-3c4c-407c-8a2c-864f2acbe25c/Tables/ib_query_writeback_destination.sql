CREATE TABLE [562059f4-3c4c-407c-8a2c-864f2acbe25c].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [562059f4-3c4c-407c-8a2c-864f2acbe25c].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [562059f4-3c4c-407c-8a2c-864f2acbe25c].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [562059f4-3c4c-407c-8a2c-864f2acbe25c].[ib_query_writeback_destination]([recordGuid] ASC);
