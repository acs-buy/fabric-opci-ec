CREATE TABLE [78a38abc-56bf-4310-b918-515ffd855204].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [78a38abc-56bf-4310-b918-515ffd855204].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [78a38abc-56bf-4310-b918-515ffd855204].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [78a38abc-56bf-4310-b918-515ffd855204].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [78a38abc-56bf-4310-b918-515ffd855204].[ib_source]([recordGuid] ASC);
