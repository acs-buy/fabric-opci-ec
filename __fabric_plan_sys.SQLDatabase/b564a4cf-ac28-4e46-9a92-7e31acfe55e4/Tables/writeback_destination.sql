CREATE TABLE [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[visual] ([id])
);
