CREATE TABLE [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[powertable_automation_jobs] ([id])
);
