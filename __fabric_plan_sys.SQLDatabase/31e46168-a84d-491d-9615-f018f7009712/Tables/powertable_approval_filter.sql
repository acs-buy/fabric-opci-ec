CREATE TABLE [31e46168-a84d-491d-9615-f018f7009712].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [31e46168-a84d-491d-9615-f018f7009712].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [31e46168-a84d-491d-9615-f018f7009712].[powertable_approval_filter]([recordGuid] ASC);
