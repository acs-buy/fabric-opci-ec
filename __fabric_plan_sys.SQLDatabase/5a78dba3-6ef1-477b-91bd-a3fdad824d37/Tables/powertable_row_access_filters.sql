CREATE TABLE [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_row_access_filters]([recordGuid] ASC);
