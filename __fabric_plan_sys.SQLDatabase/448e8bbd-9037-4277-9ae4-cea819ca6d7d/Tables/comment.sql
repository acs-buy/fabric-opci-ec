CREATE TABLE [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[visual] ([id]) ON DELETE CASCADE
);
