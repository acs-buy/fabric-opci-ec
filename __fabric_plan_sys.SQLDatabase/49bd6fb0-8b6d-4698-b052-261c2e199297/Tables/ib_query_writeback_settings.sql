CREATE TABLE [49bd6fb0-8b6d-4698-b052-261c2e199297].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [49bd6fb0-8b6d-4698-b052-261c2e199297].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [49bd6fb0-8b6d-4698-b052-261c2e199297].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [49bd6fb0-8b6d-4698-b052-261c2e199297].[ib_query_writeback_settings]([recordGuid] ASC);
