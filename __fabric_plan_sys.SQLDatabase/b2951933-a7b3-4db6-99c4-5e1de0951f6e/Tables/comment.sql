CREATE TABLE [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[visual] ([id]) ON DELETE CASCADE
);
