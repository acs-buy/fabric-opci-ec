CREATE TABLE [52033849-181f-483f-b67d-f35f0ed7634c].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [52033849-181f-483f-b67d-f35f0ed7634c].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [52033849-181f-483f-b67d-f35f0ed7634c].[powertable_approval_level]([recordGuid] ASC);
