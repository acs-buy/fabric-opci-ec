CREATE TABLE [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[powertable_approval_request] ([id])
);
