                          ...
                          CREATE PROCEDURE [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [90f6b4d0-829e-4f62-91eb-204c8bf56be7].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [90f6b4d0-829e-4f62-91eb-204c8bf56be7].powertable_approval_request_rows
