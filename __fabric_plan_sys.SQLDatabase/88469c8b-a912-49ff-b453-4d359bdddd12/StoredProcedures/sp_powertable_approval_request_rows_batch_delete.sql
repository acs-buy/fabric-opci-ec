              ...
              CREATE PROCEDURE [88469c8b-a912-49ff-b453-4d359bdddd12].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [88469c8b-a912-49ff-b453-4d359bdddd12].powertable_approval_request_rows SET status = 500 FROM [88469c8b-a912-49ff-b453-4d359bdddd12].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
