                          ...
                          CREATE PROCEDURE [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [b2951933-a7b3-4db6-99c4-5e1de0951f6e].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [b2951933-a7b3-4db6-99c4-5e1de0951f6e].powertable_approval_request_rows
