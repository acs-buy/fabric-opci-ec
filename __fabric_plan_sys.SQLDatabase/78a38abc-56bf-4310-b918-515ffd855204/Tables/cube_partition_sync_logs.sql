CREATE TABLE [78a38abc-56bf-4310-b918-515ffd855204].[cube_partition_sync_logs] (
    ...
    CONSTRAINT [FK_c178596a53d6c303773a9095a21] FOREIGN KEY ([partitionMeasureId]) REFERENCES [78a38abc-56bf-4310-b918-515ffd855204].[cube_partition_measure] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [78a38abc-56bf-4310-b918-515ffd855204].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
