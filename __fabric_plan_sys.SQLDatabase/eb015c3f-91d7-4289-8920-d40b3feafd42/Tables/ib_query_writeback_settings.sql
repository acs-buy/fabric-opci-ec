CREATE TABLE [eb015c3f-91d7-4289-8920-d40b3feafd42].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [eb015c3f-91d7-4289-8920-d40b3feafd42].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [eb015c3f-91d7-4289-8920-d40b3feafd42].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [eb015c3f-91d7-4289-8920-d40b3feafd42].[ib_query_writeback_settings]([recordGuid] ASC);
