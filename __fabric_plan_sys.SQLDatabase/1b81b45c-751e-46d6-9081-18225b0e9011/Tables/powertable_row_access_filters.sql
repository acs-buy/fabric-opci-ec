CREATE TABLE [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_row_access_filters]([recordGuid] ASC);
