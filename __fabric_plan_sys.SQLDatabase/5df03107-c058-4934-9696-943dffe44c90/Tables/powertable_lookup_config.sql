CREATE TABLE [5df03107-c058-4934-9696-943dffe44c90].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [5df03107-c058-4934-9696-943dffe44c90].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [5df03107-c058-4934-9696-943dffe44c90].[powertable_lookup_config]([recordGuid] ASC);
