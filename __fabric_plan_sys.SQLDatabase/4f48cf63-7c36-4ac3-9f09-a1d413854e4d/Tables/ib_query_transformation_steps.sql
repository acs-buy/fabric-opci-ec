CREATE TABLE [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[ib_query_transformation_steps]([recordGuid] ASC);
