CREATE TABLE [52033849-181f-483f-b67d-f35f0ed7634c].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [52033849-181f-483f-b67d-f35f0ed7634c].[powertable_approval_request] ([id])
);
