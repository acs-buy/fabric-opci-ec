CREATE TABLE [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_approval_filter]([recordGuid] ASC);
