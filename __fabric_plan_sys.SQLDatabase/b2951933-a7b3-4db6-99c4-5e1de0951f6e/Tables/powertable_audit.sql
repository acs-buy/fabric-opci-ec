CREATE TABLE [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
