CREATE TABLE [1b81b45c-751e-46d6-9081-18225b0e9011].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [1b81b45c-751e-46d6-9081-18225b0e9011].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [1b81b45c-751e-46d6-9081-18225b0e9011].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [1b81b45c-751e-46d6-9081-18225b0e9011].[ib_query_writeback_settings]([recordGuid] ASC);
