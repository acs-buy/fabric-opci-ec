CREATE TABLE [087b92b7-021a-4e56-a539-73891592dfe2].[cube_partition_sync_logs] (
    ...
    CONSTRAINT [FK_c178596a53d6c303773a9095a21] FOREIGN KEY ([partitionMeasureId]) REFERENCES [087b92b7-021a-4e56-a539-73891592dfe2].[cube_partition_measure] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [087b92b7-021a-4e56-a539-73891592dfe2].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
