                          ...
                          CREATE PROCEDURE [14cd3243-21c1-488b-a192-0760eaf16a68].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [14cd3243-21c1-488b-a192-0760eaf16a68].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [14cd3243-21c1-488b-a192-0760eaf16a68].powertable_approval_request_rows
