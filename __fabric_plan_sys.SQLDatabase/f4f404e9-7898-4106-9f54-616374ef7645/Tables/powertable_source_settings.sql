CREATE TABLE [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_source_settings]([recordGuid] ASC);
