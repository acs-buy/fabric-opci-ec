CREATE TABLE [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_approval_filter]([recordGuid] ASC);
