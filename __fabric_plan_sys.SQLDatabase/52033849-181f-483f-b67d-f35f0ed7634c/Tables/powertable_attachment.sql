CREATE TABLE [52033849-181f-483f-b67d-f35f0ed7634c].[powertable_attachment] (
    ...
    CONSTRAINT [FK_2bd05b1cc85a67483bedbced9c3] FOREIGN KEY ([sourceId]) REFERENCES [52033849-181f-483f-b67d-f35f0ed7634c].[powertable_source] ([id])
);
