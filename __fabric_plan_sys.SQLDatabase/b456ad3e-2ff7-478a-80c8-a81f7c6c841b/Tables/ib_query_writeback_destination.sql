CREATE TABLE [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[ib_query_writeback_destination]([recordGuid] ASC);
