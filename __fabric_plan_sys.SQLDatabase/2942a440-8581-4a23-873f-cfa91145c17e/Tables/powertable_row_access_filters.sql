CREATE TABLE [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_row_access_filters]([recordGuid] ASC);
