CREATE TABLE [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_column_config]([recordGuid] ASC);
