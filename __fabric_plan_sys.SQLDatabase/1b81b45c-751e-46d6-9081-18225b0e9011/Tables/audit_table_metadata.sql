CREATE TABLE [1b81b45c-751e-46d6-9081-18225b0e9011].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [1b81b45c-751e-46d6-9081-18225b0e9011].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [1b81b45c-751e-46d6-9081-18225b0e9011].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
