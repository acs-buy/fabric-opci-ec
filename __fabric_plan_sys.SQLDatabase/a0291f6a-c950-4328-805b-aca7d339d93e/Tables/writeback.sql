CREATE TABLE [a0291f6a-c950-4328-805b-aca7d339d93e].[writeback] (
    ...
    CONSTRAINT [FK_bbc1ed3d35bb48f8c0823c361c0] FOREIGN KEY ([visualId]) REFERENCES [a0291f6a-c950-4328-805b-aca7d339d93e].[visual] ([id])
);
