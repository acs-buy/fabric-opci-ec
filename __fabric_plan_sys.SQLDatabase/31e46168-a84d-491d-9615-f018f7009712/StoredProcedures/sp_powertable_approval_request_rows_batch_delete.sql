              ...
              CREATE PROCEDURE [31e46168-a84d-491d-9615-f018f7009712].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [31e46168-a84d-491d-9615-f018f7009712].powertable_approval_request_rows SET status = 500 FROM [31e46168-a84d-491d-9615-f018f7009712].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
