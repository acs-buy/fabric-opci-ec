CREATE TABLE [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
