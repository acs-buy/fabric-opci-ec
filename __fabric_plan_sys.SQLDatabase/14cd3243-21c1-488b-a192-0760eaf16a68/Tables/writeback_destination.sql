CREATE TABLE [14cd3243-21c1-488b-a192-0760eaf16a68].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [14cd3243-21c1-488b-a192-0760eaf16a68].[visual] ([id])
);
