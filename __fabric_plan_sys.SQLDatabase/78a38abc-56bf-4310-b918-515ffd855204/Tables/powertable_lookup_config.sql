CREATE TABLE [78a38abc-56bf-4310-b918-515ffd855204].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [78a38abc-56bf-4310-b918-515ffd855204].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [78a38abc-56bf-4310-b918-515ffd855204].[powertable_lookup_config]([recordGuid] ASC);
