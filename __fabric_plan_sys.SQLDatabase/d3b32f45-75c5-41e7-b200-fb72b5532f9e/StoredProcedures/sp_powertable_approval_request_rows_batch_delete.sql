              ...
              CREATE PROCEDURE [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [d3b32f45-75c5-41e7-b200-fb72b5532f9e].powertable_approval_request_rows SET status = 500 FROM [d3b32f45-75c5-41e7-b200-fb72b5532f9e].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
