CREATE TABLE [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_source_settings]([recordGuid] ASC);
