CREATE TABLE [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[powertable_approval_request] ([id])
);
