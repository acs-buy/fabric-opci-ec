              ...
              CREATE PROCEDURE [2942a440-8581-4a23-873f-cfa91145c17e].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [2942a440-8581-4a23-873f-cfa91145c17e].powertable_approval_request_rows SET status = 500 FROM [2942a440-8581-4a23-873f-cfa91145c17e].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
