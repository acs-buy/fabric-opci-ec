CREATE TABLE [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_approval_request] ([id])
);
