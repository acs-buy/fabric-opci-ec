CREATE TABLE [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_forms]([recordGuid] ASC);
