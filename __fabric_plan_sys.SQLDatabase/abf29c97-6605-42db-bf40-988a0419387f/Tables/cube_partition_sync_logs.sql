CREATE TABLE [abf29c97-6605-42db-bf40-988a0419387f].[cube_partition_sync_logs] (
    ...
    CONSTRAINT [FK_c178596a53d6c303773a9095a21] FOREIGN KEY ([partitionMeasureId]) REFERENCES [abf29c97-6605-42db-bf40-988a0419387f].[cube_partition_measure] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [abf29c97-6605-42db-bf40-988a0419387f].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
