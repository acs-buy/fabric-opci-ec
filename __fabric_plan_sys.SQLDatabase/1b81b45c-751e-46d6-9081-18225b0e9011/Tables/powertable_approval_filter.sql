CREATE TABLE [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_approval_filter]([recordGuid] ASC);
