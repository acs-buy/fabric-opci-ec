      ...
      CREATE   PROCEDURE [f421652a-1f51-49cc-965b-e8a69233e76d].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [f421652a-1f51-49cc-965b-e8a69233e76d].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [f421652a-1f51-49cc-965b-e8a69233e76d].[ib_query_writeback] qw
