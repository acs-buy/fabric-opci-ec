CREATE TABLE [efed97ad-5e3c-4c48-9256-9881fa39bca2].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [efed97ad-5e3c-4c48-9256-9881fa39bca2].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [efed97ad-5e3c-4c48-9256-9881fa39bca2].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [efed97ad-5e3c-4c48-9256-9881fa39bca2].[ib_query_writeback_destination]([recordGuid] ASC);
