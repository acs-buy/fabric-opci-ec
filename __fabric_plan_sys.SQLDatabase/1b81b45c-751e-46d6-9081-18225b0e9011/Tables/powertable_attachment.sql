CREATE TABLE [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_attachment] (
    ...
    CONSTRAINT [FK_2bd05b1cc85a67483bedbced9c3] FOREIGN KEY ([sourceId]) REFERENCES [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_source] ([id])
);
