                          ...
                          CREATE PROCEDURE [31e46168-a84d-491d-9615-f018f7009712].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [31e46168-a84d-491d-9615-f018f7009712].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [31e46168-a84d-491d-9615-f018f7009712].powertable_approval_request_rows
