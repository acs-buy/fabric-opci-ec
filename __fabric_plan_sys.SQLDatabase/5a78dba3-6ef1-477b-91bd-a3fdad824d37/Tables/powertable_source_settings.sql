CREATE TABLE [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_source_settings]([recordGuid] ASC);
