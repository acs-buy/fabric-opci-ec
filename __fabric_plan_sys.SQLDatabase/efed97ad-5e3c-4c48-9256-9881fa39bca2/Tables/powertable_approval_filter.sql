CREATE TABLE [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_approval_filter]([recordGuid] ASC);
