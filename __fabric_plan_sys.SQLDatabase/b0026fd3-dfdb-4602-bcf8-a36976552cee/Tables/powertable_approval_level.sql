CREATE TABLE [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_approval_level]([recordGuid] ASC);
