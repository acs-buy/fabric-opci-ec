CREATE TABLE [abf29c97-6605-42db-bf40-988a0419387f].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [abf29c97-6605-42db-bf40-988a0419387f].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [abf29c97-6605-42db-bf40-988a0419387f].[powertable_approval_level]([recordGuid] ASC);
