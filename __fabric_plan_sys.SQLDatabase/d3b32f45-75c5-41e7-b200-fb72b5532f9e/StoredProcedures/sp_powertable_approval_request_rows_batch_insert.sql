                ...
                CREATE PROCEDURE [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [d3b32f45-75c5-41e7-b200-fb72b5532f9e].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
