CREATE TABLE [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_row_access_filters]([recordGuid] ASC);
