CREATE TABLE [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[powertable_source_settings]([recordGuid] ASC);
