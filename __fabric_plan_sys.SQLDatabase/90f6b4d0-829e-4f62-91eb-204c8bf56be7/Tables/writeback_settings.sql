CREATE TABLE [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[writeback_settings]([recordGuid] ASC);
