CREATE TABLE [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[ib_query_transformation_steps]([recordGuid] ASC);
