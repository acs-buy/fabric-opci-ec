CREATE TABLE [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
