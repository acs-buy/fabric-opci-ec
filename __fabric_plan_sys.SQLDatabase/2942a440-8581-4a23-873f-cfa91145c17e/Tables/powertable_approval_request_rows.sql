CREATE TABLE [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_approval_request] ([id])
);
