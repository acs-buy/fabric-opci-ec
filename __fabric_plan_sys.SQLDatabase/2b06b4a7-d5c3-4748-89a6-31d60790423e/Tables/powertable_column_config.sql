CREATE TABLE [2b06b4a7-d5c3-4748-89a6-31d60790423e].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [2b06b4a7-d5c3-4748-89a6-31d60790423e].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [2b06b4a7-d5c3-4748-89a6-31d60790423e].[powertable_column_config]([recordGuid] ASC);
