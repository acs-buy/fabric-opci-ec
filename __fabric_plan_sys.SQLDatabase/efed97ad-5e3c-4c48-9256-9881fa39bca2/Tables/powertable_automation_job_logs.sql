CREATE TABLE [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_automation_jobs] ([id])
);
