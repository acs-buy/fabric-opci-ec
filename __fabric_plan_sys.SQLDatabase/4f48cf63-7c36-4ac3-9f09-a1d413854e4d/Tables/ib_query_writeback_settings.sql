CREATE TABLE [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[ib_query_writeback_settings]([recordGuid] ASC);
