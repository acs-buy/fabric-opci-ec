CREATE TABLE [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_approval_filter]([recordGuid] ASC);
