        ...
        CREATE   PROCEDURE [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].' + QUOTENAME(@DIVTableName) + ' AS div
