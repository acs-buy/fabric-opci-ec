                          ...
                          CREATE PROCEDURE [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [7ebb55ce-6578-41f4-95cc-6760af0ee48e].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [7ebb55ce-6578-41f4-95cc-6760af0ee48e].powertable_approval_request_rows
