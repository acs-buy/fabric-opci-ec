CREATE TABLE [b0026fd3-dfdb-4602-bcf8-a36976552cee].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [b0026fd3-dfdb-4602-bcf8-a36976552cee].[visual] ([id]) ON DELETE CASCADE
);
