CREATE TABLE [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_row_access_filters]([recordGuid] ASC);
