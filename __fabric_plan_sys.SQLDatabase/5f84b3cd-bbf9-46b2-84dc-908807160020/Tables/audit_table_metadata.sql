CREATE TABLE [5f84b3cd-bbf9-46b2-84dc-908807160020].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [5f84b3cd-bbf9-46b2-84dc-908807160020].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [5f84b3cd-bbf9-46b2-84dc-908807160020].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
