CREATE TABLE [efed97ad-5e3c-4c48-9256-9881fa39bca2].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [efed97ad-5e3c-4c48-9256-9881fa39bca2].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [efed97ad-5e3c-4c48-9256-9881fa39bca2].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [efed97ad-5e3c-4c48-9256-9881fa39bca2].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [efed97ad-5e3c-4c48-9256-9881fa39bca2].[ib_source]([recordGuid] ASC);
