CREATE TABLE [2b06b4a7-d5c3-4748-89a6-31d60790423e].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [2b06b4a7-d5c3-4748-89a6-31d60790423e].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [2b06b4a7-d5c3-4748-89a6-31d60790423e].[powertable_approval_filter]([recordGuid] ASC);
