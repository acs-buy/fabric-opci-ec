CREATE TABLE [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[cube_partition_sync_logs] (
    ...
    CONSTRAINT [FK_c178596a53d6c303773a9095a21] FOREIGN KEY ([partitionMeasureId]) REFERENCES [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[cube_partition_measure] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
