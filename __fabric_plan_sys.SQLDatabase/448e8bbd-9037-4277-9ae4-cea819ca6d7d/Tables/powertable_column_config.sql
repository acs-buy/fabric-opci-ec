CREATE TABLE [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[powertable_column_config]([recordGuid] ASC);
