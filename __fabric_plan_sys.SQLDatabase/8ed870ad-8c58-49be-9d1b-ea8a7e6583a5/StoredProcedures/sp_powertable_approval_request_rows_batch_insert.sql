                ...
                CREATE PROCEDURE [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
