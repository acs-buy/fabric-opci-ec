      ...
      CREATE   PROCEDURE [abf29c97-6605-42db-bf40-988a0419387f].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [abf29c97-6605-42db-bf40-988a0419387f].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [abf29c97-6605-42db-bf40-988a0419387f].[ib_query_writeback] qw
