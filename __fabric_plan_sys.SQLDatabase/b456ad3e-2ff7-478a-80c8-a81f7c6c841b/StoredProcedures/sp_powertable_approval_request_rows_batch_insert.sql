                ...
                CREATE PROCEDURE [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
