CREATE TABLE [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[writeback_settings]([recordGuid] ASC);
