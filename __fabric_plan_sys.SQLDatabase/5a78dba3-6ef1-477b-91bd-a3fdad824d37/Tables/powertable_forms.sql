CREATE TABLE [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_forms]([recordGuid] ASC);
