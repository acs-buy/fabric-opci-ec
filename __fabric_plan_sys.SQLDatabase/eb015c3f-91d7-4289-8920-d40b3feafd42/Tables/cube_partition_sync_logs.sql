CREATE TABLE [eb015c3f-91d7-4289-8920-d40b3feafd42].[cube_partition_sync_logs] (
    ...
    CONSTRAINT [FK_c178596a53d6c303773a9095a21] FOREIGN KEY ([partitionMeasureId]) REFERENCES [eb015c3f-91d7-4289-8920-d40b3feafd42].[cube_partition_measure] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [eb015c3f-91d7-4289-8920-d40b3feafd42].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
