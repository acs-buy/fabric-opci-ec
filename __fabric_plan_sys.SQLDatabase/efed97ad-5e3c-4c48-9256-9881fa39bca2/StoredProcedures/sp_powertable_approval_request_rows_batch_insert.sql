                ...
                CREATE PROCEDURE [efed97ad-5e3c-4c48-9256-9881fa39bca2].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [efed97ad-5e3c-4c48-9256-9881fa39bca2].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
