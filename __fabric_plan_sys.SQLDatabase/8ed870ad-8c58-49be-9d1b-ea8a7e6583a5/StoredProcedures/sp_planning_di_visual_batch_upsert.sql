        ...
        CREATE   PROCEDURE [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].' + QUOTENAME(@DIVTableName) + ' AS div
