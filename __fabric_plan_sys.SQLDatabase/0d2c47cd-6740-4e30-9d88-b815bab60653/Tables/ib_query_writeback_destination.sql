CREATE TABLE [0d2c47cd-6740-4e30-9d88-b815bab60653].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [0d2c47cd-6740-4e30-9d88-b815bab60653].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [0d2c47cd-6740-4e30-9d88-b815bab60653].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [0d2c47cd-6740-4e30-9d88-b815bab60653].[ib_query_writeback_destination]([recordGuid] ASC);
