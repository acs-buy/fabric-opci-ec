CREATE TABLE [2942a440-8581-4a23-873f-cfa91145c17e].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [2942a440-8581-4a23-873f-cfa91145c17e].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [2942a440-8581-4a23-873f-cfa91145c17e].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
