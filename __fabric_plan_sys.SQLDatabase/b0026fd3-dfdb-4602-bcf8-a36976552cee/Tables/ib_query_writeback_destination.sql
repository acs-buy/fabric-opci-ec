CREATE TABLE [b0026fd3-dfdb-4602-bcf8-a36976552cee].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [b0026fd3-dfdb-4602-bcf8-a36976552cee].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [b0026fd3-dfdb-4602-bcf8-a36976552cee].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [b0026fd3-dfdb-4602-bcf8-a36976552cee].[ib_query_writeback_destination]([recordGuid] ASC);
