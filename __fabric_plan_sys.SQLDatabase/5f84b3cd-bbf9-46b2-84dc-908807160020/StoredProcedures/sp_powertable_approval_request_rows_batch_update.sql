                          ...
                          CREATE PROCEDURE [5f84b3cd-bbf9-46b2-84dc-908807160020].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [5f84b3cd-bbf9-46b2-84dc-908807160020].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [5f84b3cd-bbf9-46b2-84dc-908807160020].powertable_approval_request_rows
