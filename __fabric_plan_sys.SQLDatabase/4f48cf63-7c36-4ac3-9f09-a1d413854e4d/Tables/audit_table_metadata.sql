CREATE TABLE [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
