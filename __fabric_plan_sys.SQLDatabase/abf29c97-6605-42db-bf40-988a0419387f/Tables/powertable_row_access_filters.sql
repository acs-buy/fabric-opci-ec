CREATE TABLE [abf29c97-6605-42db-bf40-988a0419387f].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [abf29c97-6605-42db-bf40-988a0419387f].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [abf29c97-6605-42db-bf40-988a0419387f].[powertable_row_access_filters]([recordGuid] ASC);
