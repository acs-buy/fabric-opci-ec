CREATE TABLE [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_approval_request] ([id])
);
