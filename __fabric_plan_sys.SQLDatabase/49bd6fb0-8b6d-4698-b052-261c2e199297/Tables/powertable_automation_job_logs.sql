CREATE TABLE [49bd6fb0-8b6d-4698-b052-261c2e199297].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [49bd6fb0-8b6d-4698-b052-261c2e199297].[powertable_automation_jobs] ([id])
);
