CREATE TABLE [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[ib_source]([recordGuid] ASC);
