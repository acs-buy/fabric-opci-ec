              ...
              CREATE PROCEDURE [efed97ad-5e3c-4c48-9256-9881fa39bca2].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [efed97ad-5e3c-4c48-9256-9881fa39bca2].powertable_approval_request_rows SET status = 500 FROM [efed97ad-5e3c-4c48-9256-9881fa39bca2].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
