CREATE TABLE [0d2c47cd-6740-4e30-9d88-b815bab60653].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [0d2c47cd-6740-4e30-9d88-b815bab60653].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [0d2c47cd-6740-4e30-9d88-b815bab60653].[powertable_approval]([recordGuid] ASC);
