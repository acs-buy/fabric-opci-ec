              ...
              CREATE PROCEDURE [abf29c97-6605-42db-bf40-988a0419387f].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [abf29c97-6605-42db-bf40-988a0419387f].powertable_approval_request_rows SET status = 500 FROM [abf29c97-6605-42db-bf40-988a0419387f].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
