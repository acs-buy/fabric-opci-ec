CREATE TABLE [eb015c3f-91d7-4289-8920-d40b3feafd42].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [eb015c3f-91d7-4289-8920-d40b3feafd42].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [eb015c3f-91d7-4289-8920-d40b3feafd42].[writeback_settings]([recordGuid] ASC);
