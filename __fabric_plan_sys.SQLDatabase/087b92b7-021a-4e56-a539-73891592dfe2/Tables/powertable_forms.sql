CREATE TABLE [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_forms]([recordGuid] ASC);
