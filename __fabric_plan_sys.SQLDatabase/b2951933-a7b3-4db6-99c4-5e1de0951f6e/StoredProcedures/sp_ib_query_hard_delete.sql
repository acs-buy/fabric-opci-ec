      ...
      CREATE   PROCEDURE [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[ib_query_writeback] qw
