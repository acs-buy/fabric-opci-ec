CREATE TABLE [1b81b45c-751e-46d6-9081-18225b0e9011].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [1b81b45c-751e-46d6-9081-18225b0e9011].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [1b81b45c-751e-46d6-9081-18225b0e9011].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [1b81b45c-751e-46d6-9081-18225b0e9011].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [1b81b45c-751e-46d6-9081-18225b0e9011].[ib_source]([recordGuid] ASC);
