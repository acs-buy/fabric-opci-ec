      ...
      CREATE   PROCEDURE [88469c8b-a912-49ff-b453-4d359bdddd12].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [88469c8b-a912-49ff-b453-4d359bdddd12].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [88469c8b-a912-49ff-b453-4d359bdddd12].[ib_query_writeback] qw
