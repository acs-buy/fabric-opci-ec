CREATE TABLE [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_column_config]([recordGuid] ASC);
