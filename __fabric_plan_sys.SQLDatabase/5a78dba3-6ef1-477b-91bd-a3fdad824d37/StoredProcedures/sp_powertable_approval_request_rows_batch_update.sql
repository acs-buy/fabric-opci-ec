                          ...
                          CREATE PROCEDURE [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [5a78dba3-6ef1-477b-91bd-a3fdad824d37].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [5a78dba3-6ef1-477b-91bd-a3fdad824d37].powertable_approval_request_rows
