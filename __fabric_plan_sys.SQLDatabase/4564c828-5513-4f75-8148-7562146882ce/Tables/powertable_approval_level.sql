CREATE TABLE [4564c828-5513-4f75-8148-7562146882ce].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [4564c828-5513-4f75-8148-7562146882ce].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [4564c828-5513-4f75-8148-7562146882ce].[powertable_approval_level]([recordGuid] ASC);
