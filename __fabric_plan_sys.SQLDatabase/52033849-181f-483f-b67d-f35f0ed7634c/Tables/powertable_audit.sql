CREATE TABLE [52033849-181f-483f-b67d-f35f0ed7634c].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [52033849-181f-483f-b67d-f35f0ed7634c].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
