CREATE TABLE [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[cube_partition_sync_logs] (
    ...
    CONSTRAINT [FK_c178596a53d6c303773a9095a21] FOREIGN KEY ([partitionMeasureId]) REFERENCES [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[cube_partition_measure] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
