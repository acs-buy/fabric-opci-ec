CREATE TABLE [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
