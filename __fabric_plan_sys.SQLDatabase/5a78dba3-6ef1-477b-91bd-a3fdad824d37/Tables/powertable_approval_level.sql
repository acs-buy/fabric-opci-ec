CREATE TABLE [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_approval_level]([recordGuid] ASC);
