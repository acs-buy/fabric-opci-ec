CREATE TABLE [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_automation_jobs] ([id])
);
