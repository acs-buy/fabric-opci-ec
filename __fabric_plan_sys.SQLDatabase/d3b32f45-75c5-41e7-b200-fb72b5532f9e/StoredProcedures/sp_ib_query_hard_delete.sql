      ...
      CREATE   PROCEDURE [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[ib_query_writeback] qw
