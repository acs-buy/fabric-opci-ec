CREATE TABLE [f4f404e9-7898-4106-9f54-616374ef7645].[cube_partition_sync_logs] (
    ...
    CONSTRAINT [FK_c178596a53d6c303773a9095a21] FOREIGN KEY ([partitionMeasureId]) REFERENCES [f4f404e9-7898-4106-9f54-616374ef7645].[cube_partition_measure] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [f4f404e9-7898-4106-9f54-616374ef7645].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
