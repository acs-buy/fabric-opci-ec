CREATE TABLE [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_row_access_filters]([recordGuid] ASC);
