CREATE TABLE [abf29c97-6605-42db-bf40-988a0419387f].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [abf29c97-6605-42db-bf40-988a0419387f].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [abf29c97-6605-42db-bf40-988a0419387f].[writeback_settings]([recordGuid] ASC);
