CREATE TABLE [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[powertable_attachment] (
    ...
    CONSTRAINT [FK_2bd05b1cc85a67483bedbced9c3] FOREIGN KEY ([sourceId]) REFERENCES [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[powertable_source] ([id])
);
