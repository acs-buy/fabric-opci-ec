CREATE TABLE [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_approval]([recordGuid] ASC);
