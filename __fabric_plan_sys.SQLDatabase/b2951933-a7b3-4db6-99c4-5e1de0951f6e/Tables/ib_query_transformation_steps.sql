CREATE TABLE [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[ib_query_transformation_steps]([recordGuid] ASC);
