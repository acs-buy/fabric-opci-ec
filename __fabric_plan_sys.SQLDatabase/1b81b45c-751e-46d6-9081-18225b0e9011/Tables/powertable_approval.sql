CREATE TABLE [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_approval]([recordGuid] ASC);
