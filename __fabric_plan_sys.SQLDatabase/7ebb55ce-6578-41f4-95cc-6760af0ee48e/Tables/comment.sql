CREATE TABLE [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[visual] ([id]) ON DELETE CASCADE
);
