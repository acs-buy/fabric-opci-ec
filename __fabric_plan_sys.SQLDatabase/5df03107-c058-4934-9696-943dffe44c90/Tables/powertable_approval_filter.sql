CREATE TABLE [5df03107-c058-4934-9696-943dffe44c90].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [5df03107-c058-4934-9696-943dffe44c90].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [5df03107-c058-4934-9696-943dffe44c90].[powertable_approval_filter]([recordGuid] ASC);
