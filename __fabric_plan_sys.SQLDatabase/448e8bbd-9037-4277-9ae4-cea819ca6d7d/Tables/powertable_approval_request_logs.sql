CREATE TABLE [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[powertable_approval_request] ([id])
);
