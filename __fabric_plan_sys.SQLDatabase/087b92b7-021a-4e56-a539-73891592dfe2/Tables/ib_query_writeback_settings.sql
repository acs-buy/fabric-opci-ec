CREATE TABLE [087b92b7-021a-4e56-a539-73891592dfe2].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [087b92b7-021a-4e56-a539-73891592dfe2].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [087b92b7-021a-4e56-a539-73891592dfe2].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [087b92b7-021a-4e56-a539-73891592dfe2].[ib_query_writeback_settings]([recordGuid] ASC);
