CREATE TABLE [88469c8b-a912-49ff-b453-4d359bdddd12].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [88469c8b-a912-49ff-b453-4d359bdddd12].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [88469c8b-a912-49ff-b453-4d359bdddd12].[writeback_settings]([recordGuid] ASC);
