CREATE TABLE [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_approval_level]([recordGuid] ASC);
