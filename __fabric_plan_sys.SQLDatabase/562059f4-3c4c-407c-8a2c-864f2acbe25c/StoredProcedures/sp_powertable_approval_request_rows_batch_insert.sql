                ...
                CREATE PROCEDURE [562059f4-3c4c-407c-8a2c-864f2acbe25c].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [562059f4-3c4c-407c-8a2c-864f2acbe25c].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
