CREATE TABLE [2942a440-8581-4a23-873f-cfa91145c17e].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [2942a440-8581-4a23-873f-cfa91145c17e].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [2942a440-8581-4a23-873f-cfa91145c17e].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [2942a440-8581-4a23-873f-cfa91145c17e].[ib_query_transformation_steps]([recordGuid] ASC);
