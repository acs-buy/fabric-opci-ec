CREATE TABLE [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[powertable_approval_level]([recordGuid] ASC);
