CREATE TABLE [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[powertable_comment] (
    ...
    CONSTRAINT [FK_e923d030022f35af27a650126af] FOREIGN KEY ([sourceId]) REFERENCES [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[powertable_source] ([id])
);
