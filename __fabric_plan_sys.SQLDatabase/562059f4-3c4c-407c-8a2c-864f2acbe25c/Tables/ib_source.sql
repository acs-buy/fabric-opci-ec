CREATE TABLE [562059f4-3c4c-407c-8a2c-864f2acbe25c].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [562059f4-3c4c-407c-8a2c-864f2acbe25c].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [562059f4-3c4c-407c-8a2c-864f2acbe25c].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [562059f4-3c4c-407c-8a2c-864f2acbe25c].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [562059f4-3c4c-407c-8a2c-864f2acbe25c].[ib_source]([recordGuid] ASC);
