CREATE TABLE [f4f404e9-7898-4106-9f54-616374ef7645].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [f4f404e9-7898-4106-9f54-616374ef7645].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [f4f404e9-7898-4106-9f54-616374ef7645].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [f4f404e9-7898-4106-9f54-616374ef7645].[ib_query_writeback_destination]([recordGuid] ASC);
