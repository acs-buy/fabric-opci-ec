CREATE TABLE [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
