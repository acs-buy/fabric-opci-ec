CREATE TABLE [f421652a-1f51-49cc-965b-e8a69233e76d].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [f421652a-1f51-49cc-965b-e8a69233e76d].[powertable_approval_request] ([id])
);
