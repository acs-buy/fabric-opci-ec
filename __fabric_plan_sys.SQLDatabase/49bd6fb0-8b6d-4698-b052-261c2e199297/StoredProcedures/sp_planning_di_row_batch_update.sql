            ...
            CREATE PROCEDURE [49bd6fb0-8b6d-4698-b052-261c2e199297].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [49bd6fb0-8b6d-4698-b052-261c2e199297].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [49bd6fb0-8b6d-4698-b052-261c2e199297].data_input_row
                INNER JOIN [49bd6fb0-8b6d-4698-b052-261c2e199297].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
