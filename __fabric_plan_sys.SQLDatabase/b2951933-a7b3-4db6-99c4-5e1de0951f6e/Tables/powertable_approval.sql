CREATE TABLE [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[powertable_approval]([recordGuid] ASC);
