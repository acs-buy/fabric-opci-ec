CREATE TABLE [52033849-181f-483f-b67d-f35f0ed7634c].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [52033849-181f-483f-b67d-f35f0ed7634c].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [52033849-181f-483f-b67d-f35f0ed7634c].[writeback_settings]([recordGuid] ASC);
