CREATE TABLE [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
