                ...
                CREATE PROCEDURE [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
