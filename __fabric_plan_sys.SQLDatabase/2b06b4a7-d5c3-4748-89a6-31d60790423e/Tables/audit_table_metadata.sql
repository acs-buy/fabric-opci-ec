CREATE TABLE [2b06b4a7-d5c3-4748-89a6-31d60790423e].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [2b06b4a7-d5c3-4748-89a6-31d60790423e].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [2b06b4a7-d5c3-4748-89a6-31d60790423e].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
