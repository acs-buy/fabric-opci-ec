                ...
                CREATE PROCEDURE [4564c828-5513-4f75-8148-7562146882ce].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [4564c828-5513-4f75-8148-7562146882ce].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
