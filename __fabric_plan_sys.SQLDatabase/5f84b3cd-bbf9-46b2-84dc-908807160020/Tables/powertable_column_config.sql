CREATE TABLE [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_column_config]([recordGuid] ASC);
