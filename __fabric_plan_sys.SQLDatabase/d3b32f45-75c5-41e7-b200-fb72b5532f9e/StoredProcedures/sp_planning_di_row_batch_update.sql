            ...
            CREATE PROCEDURE [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [d3b32f45-75c5-41e7-b200-fb72b5532f9e].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [d3b32f45-75c5-41e7-b200-fb72b5532f9e].data_input_row
                INNER JOIN [d3b32f45-75c5-41e7-b200-fb72b5532f9e].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
