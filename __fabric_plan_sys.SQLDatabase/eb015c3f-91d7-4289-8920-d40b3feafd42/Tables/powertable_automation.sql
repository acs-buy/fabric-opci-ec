CREATE TABLE [eb015c3f-91d7-4289-8920-d40b3feafd42].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [eb015c3f-91d7-4289-8920-d40b3feafd42].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [eb015c3f-91d7-4289-8920-d40b3feafd42].[powertable_automation]([recordGuid] ASC);
