CREATE TABLE [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[writeback_settings]([recordGuid] ASC);
