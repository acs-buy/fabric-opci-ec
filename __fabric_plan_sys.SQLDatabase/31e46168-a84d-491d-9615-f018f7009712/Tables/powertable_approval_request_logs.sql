CREATE TABLE [31e46168-a84d-491d-9615-f018f7009712].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [31e46168-a84d-491d-9615-f018f7009712].[powertable_approval_request] ([id])
);
