CREATE TABLE [5df03107-c058-4934-9696-943dffe44c90].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [5df03107-c058-4934-9696-943dffe44c90].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [5df03107-c058-4934-9696-943dffe44c90].[powertable_row_access_filters]([recordGuid] ASC);
