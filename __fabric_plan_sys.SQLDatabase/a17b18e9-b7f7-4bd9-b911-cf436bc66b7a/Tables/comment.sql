CREATE TABLE [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[visual] ([id]) ON DELETE CASCADE
);
