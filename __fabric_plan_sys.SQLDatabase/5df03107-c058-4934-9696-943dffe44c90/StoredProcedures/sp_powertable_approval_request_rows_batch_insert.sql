                ...
                CREATE PROCEDURE [5df03107-c058-4934-9696-943dffe44c90].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [5df03107-c058-4934-9696-943dffe44c90].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
