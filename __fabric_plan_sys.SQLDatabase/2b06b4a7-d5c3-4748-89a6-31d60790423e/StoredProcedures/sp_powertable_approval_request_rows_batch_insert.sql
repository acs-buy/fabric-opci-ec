                ...
                CREATE PROCEDURE [2b06b4a7-d5c3-4748-89a6-31d60790423e].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [2b06b4a7-d5c3-4748-89a6-31d60790423e].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
