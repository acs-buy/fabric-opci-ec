CREATE TABLE [087b92b7-021a-4e56-a539-73891592dfe2].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [087b92b7-021a-4e56-a539-73891592dfe2].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [087b92b7-021a-4e56-a539-73891592dfe2].[writeback_settings]([recordGuid] ASC);
