CREATE TABLE [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[cube_partition_sync_logs] (
    ...
    CONSTRAINT [FK_c178596a53d6c303773a9095a21] FOREIGN KEY ([partitionMeasureId]) REFERENCES [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[cube_partition_measure] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
