      ...
      CREATE   PROCEDURE [eb015c3f-91d7-4289-8920-d40b3feafd42].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [eb015c3f-91d7-4289-8920-d40b3feafd42].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [eb015c3f-91d7-4289-8920-d40b3feafd42].[ib_query_writeback] qw
