      ...
      CREATE   PROCEDURE [78a38abc-56bf-4310-b918-515ffd855204].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [78a38abc-56bf-4310-b918-515ffd855204].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [78a38abc-56bf-4310-b918-515ffd855204].[ib_query_writeback] qw
