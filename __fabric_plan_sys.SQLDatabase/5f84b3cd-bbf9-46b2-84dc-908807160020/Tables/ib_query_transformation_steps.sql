CREATE TABLE [5f84b3cd-bbf9-46b2-84dc-908807160020].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [5f84b3cd-bbf9-46b2-84dc-908807160020].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [5f84b3cd-bbf9-46b2-84dc-908807160020].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [5f84b3cd-bbf9-46b2-84dc-908807160020].[ib_query_transformation_steps]([recordGuid] ASC);
