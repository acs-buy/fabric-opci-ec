CREATE TABLE [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[writeback_settings]([recordGuid] ASC);
