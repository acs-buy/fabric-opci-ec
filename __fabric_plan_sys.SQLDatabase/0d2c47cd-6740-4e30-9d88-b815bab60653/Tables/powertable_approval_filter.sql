CREATE TABLE [0d2c47cd-6740-4e30-9d88-b815bab60653].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [0d2c47cd-6740-4e30-9d88-b815bab60653].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [0d2c47cd-6740-4e30-9d88-b815bab60653].[powertable_approval_filter]([recordGuid] ASC);
