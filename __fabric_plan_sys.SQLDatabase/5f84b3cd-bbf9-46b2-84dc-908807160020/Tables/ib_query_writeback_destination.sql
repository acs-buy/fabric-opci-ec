CREATE TABLE [5f84b3cd-bbf9-46b2-84dc-908807160020].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [5f84b3cd-bbf9-46b2-84dc-908807160020].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [5f84b3cd-bbf9-46b2-84dc-908807160020].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [5f84b3cd-bbf9-46b2-84dc-908807160020].[ib_query_writeback_destination]([recordGuid] ASC);
