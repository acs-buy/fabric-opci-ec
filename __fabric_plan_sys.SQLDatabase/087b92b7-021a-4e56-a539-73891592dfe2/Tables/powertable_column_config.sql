CREATE TABLE [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_column_config]([recordGuid] ASC);
