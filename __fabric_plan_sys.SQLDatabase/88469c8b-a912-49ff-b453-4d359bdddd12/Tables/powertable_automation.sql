CREATE TABLE [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_automation]([recordGuid] ASC);
