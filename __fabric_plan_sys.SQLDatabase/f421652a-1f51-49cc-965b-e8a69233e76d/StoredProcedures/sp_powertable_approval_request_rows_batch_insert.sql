                ...
                CREATE PROCEDURE [f421652a-1f51-49cc-965b-e8a69233e76d].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [f421652a-1f51-49cc-965b-e8a69233e76d].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
