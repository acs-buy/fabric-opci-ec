              ...
              CREATE PROCEDURE [b0026fd3-dfdb-4602-bcf8-a36976552cee].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [b0026fd3-dfdb-4602-bcf8-a36976552cee].powertable_approval_request_rows SET status = 500 FROM [b0026fd3-dfdb-4602-bcf8-a36976552cee].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
