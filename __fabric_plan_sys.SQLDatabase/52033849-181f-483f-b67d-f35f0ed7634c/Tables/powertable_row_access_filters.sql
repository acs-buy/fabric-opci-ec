CREATE TABLE [52033849-181f-483f-b67d-f35f0ed7634c].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [52033849-181f-483f-b67d-f35f0ed7634c].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [52033849-181f-483f-b67d-f35f0ed7634c].[powertable_row_access_filters]([recordGuid] ASC);
