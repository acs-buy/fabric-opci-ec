CREATE TABLE [5f84b3cd-bbf9-46b2-84dc-908807160020].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [5f84b3cd-bbf9-46b2-84dc-908807160020].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [5f84b3cd-bbf9-46b2-84dc-908807160020].[writeback_settings]([recordGuid] ASC);
