CREATE TABLE [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_approval]([recordGuid] ASC);
