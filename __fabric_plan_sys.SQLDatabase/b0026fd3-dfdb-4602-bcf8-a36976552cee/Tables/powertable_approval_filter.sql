CREATE TABLE [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_approval_filter]([recordGuid] ASC);
