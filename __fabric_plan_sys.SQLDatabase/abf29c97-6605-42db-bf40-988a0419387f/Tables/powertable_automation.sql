CREATE TABLE [abf29c97-6605-42db-bf40-988a0419387f].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [abf29c97-6605-42db-bf40-988a0419387f].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [abf29c97-6605-42db-bf40-988a0419387f].[powertable_automation]([recordGuid] ASC);
