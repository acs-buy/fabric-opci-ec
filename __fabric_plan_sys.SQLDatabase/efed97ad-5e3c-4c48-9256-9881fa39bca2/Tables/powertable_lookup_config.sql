CREATE TABLE [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_lookup_config]([recordGuid] ASC);
