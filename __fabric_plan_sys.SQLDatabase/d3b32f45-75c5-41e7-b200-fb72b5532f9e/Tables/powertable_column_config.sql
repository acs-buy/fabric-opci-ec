CREATE TABLE [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[powertable_column_config]([recordGuid] ASC);
