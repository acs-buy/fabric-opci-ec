CREATE TABLE [2b06b4a7-d5c3-4748-89a6-31d60790423e].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [2b06b4a7-d5c3-4748-89a6-31d60790423e].[powertable_automation_jobs] ([id])
);
