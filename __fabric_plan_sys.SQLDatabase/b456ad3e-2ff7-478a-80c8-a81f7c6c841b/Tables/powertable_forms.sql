CREATE TABLE [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[powertable_forms]([recordGuid] ASC);
