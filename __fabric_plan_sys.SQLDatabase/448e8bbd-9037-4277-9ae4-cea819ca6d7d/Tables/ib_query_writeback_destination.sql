CREATE TABLE [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[ib_query_writeback_destination]([recordGuid] ASC);
