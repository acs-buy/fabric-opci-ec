                          ...
                          CREATE PROCEDURE [49bd6fb0-8b6d-4698-b052-261c2e199297].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [49bd6fb0-8b6d-4698-b052-261c2e199297].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [49bd6fb0-8b6d-4698-b052-261c2e199297].powertable_approval_request_rows
