CREATE TABLE [4564c828-5513-4f75-8148-7562146882ce].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [4564c828-5513-4f75-8148-7562146882ce].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [4564c828-5513-4f75-8148-7562146882ce].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [4564c828-5513-4f75-8148-7562146882ce].[ib_query_writeback_settings]([recordGuid] ASC);
