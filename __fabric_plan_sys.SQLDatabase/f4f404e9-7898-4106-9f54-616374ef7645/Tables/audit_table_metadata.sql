CREATE TABLE [f4f404e9-7898-4106-9f54-616374ef7645].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [f4f404e9-7898-4106-9f54-616374ef7645].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [f4f404e9-7898-4106-9f54-616374ef7645].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
