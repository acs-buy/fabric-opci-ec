CREATE TABLE [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[powertable_lookup_config]([recordGuid] ASC);
