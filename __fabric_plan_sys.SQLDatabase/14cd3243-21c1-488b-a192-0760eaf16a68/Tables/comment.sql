CREATE TABLE [14cd3243-21c1-488b-a192-0760eaf16a68].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [14cd3243-21c1-488b-a192-0760eaf16a68].[visual] ([id]) ON DELETE CASCADE
);
