CREATE TABLE [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[powertable_automation_jobs] ([id])
);
