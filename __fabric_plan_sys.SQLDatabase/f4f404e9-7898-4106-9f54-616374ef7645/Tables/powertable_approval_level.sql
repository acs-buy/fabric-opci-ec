CREATE TABLE [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_approval_level]([recordGuid] ASC);
