                ...
                CREATE PROCEDURE [52033849-181f-483f-b67d-f35f0ed7634c].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [52033849-181f-483f-b67d-f35f0ed7634c].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
