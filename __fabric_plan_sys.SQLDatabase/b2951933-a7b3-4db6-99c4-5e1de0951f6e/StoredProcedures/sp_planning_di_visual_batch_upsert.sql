        ...
        CREATE   PROCEDURE [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [b2951933-a7b3-4db6-99c4-5e1de0951f6e].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [b2951933-a7b3-4db6-99c4-5e1de0951f6e].' + QUOTENAME(@DIVTableName) + ' AS div
