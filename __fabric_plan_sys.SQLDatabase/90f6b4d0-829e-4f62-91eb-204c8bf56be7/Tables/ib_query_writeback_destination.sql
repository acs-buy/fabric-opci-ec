CREATE TABLE [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[ib_query_writeback_destination]([recordGuid] ASC);
