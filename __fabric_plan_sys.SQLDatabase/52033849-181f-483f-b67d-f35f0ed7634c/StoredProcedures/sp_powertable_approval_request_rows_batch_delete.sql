              ...
              CREATE PROCEDURE [52033849-181f-483f-b67d-f35f0ed7634c].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [52033849-181f-483f-b67d-f35f0ed7634c].powertable_approval_request_rows SET status = 500 FROM [52033849-181f-483f-b67d-f35f0ed7634c].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
