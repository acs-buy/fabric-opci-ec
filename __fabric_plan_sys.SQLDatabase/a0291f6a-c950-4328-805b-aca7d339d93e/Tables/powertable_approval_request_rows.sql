CREATE TABLE [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_approval_request] ([id])
);
