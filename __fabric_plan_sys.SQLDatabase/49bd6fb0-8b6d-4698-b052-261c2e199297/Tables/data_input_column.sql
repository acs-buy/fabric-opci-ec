CREATE TABLE [49bd6fb0-8b6d-4698-b052-261c2e199297].[data_input_column] (
    ...
    CONSTRAINT [FK_2f2ba9690ea788805bf78ae17a1] FOREIGN KEY ([visualId]) REFERENCES [49bd6fb0-8b6d-4698-b052-261c2e199297].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [ix_data_input_column_hydration_cold]
    ON [49bd6fb0-8b6d-4698-b052-261c2e199297].[data_input_column]([sidecarHydrationStatus] ASC) WHERE ([sidecarHydrationStatus] IN ((10), (30), (50)));
