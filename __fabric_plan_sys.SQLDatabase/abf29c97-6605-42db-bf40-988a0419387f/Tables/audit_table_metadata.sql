CREATE TABLE [abf29c97-6605-42db-bf40-988a0419387f].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [abf29c97-6605-42db-bf40-988a0419387f].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [abf29c97-6605-42db-bf40-988a0419387f].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
