CREATE TABLE [b0026fd3-dfdb-4602-bcf8-a36976552cee].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [b0026fd3-dfdb-4602-bcf8-a36976552cee].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [b0026fd3-dfdb-4602-bcf8-a36976552cee].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
