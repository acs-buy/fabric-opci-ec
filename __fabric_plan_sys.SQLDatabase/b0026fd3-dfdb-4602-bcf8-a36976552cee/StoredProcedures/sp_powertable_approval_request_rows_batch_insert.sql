                ...
                CREATE PROCEDURE [b0026fd3-dfdb-4602-bcf8-a36976552cee].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [b0026fd3-dfdb-4602-bcf8-a36976552cee].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
