CREATE TABLE [4564c828-5513-4f75-8148-7562146882ce].[cube_partition_sync_logs] (
    ...
    CONSTRAINT [FK_c178596a53d6c303773a9095a21] FOREIGN KEY ([partitionMeasureId]) REFERENCES [4564c828-5513-4f75-8148-7562146882ce].[cube_partition_measure] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [4564c828-5513-4f75-8148-7562146882ce].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
