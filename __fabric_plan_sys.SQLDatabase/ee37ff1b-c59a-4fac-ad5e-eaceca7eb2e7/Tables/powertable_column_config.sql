CREATE TABLE [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[powertable_column_config]([recordGuid] ASC);
