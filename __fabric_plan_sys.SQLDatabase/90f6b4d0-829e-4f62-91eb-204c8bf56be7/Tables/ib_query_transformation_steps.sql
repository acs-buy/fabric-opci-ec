CREATE TABLE [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[ib_query_transformation_steps]([recordGuid] ASC);
