CREATE TABLE [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_automation]([recordGuid] ASC);
