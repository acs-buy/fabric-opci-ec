CREATE TABLE [52033849-181f-483f-b67d-f35f0ed7634c].[cube_partition_sync_logs] (
    ...
    CONSTRAINT [FK_c178596a53d6c303773a9095a21] FOREIGN KEY ([partitionMeasureId]) REFERENCES [52033849-181f-483f-b67d-f35f0ed7634c].[cube_partition_measure] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [52033849-181f-483f-b67d-f35f0ed7634c].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
