CREATE TABLE [562059f4-3c4c-407c-8a2c-864f2acbe25c].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [562059f4-3c4c-407c-8a2c-864f2acbe25c].[visual] ([id]) ON DELETE CASCADE
);
