CREATE TABLE [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[powertable_automation]([recordGuid] ASC);
