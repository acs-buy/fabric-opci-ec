CREATE TABLE [49bd6fb0-8b6d-4698-b052-261c2e199297].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [49bd6fb0-8b6d-4698-b052-261c2e199297].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [49bd6fb0-8b6d-4698-b052-261c2e199297].[writeback_settings]([recordGuid] ASC);
