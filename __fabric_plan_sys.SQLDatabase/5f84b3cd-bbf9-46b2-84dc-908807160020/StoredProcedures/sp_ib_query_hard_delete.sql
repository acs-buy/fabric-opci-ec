      ...
      CREATE   PROCEDURE [5f84b3cd-bbf9-46b2-84dc-908807160020].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [5f84b3cd-bbf9-46b2-84dc-908807160020].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [5f84b3cd-bbf9-46b2-84dc-908807160020].[ib_query_writeback] qw
