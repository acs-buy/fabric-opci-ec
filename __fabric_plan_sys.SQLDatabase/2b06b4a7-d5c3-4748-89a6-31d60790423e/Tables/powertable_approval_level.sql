CREATE TABLE [2b06b4a7-d5c3-4748-89a6-31d60790423e].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [2b06b4a7-d5c3-4748-89a6-31d60790423e].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [2b06b4a7-d5c3-4748-89a6-31d60790423e].[powertable_approval_level]([recordGuid] ASC);
