CREATE TABLE [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_approval_request] ([id])
);
