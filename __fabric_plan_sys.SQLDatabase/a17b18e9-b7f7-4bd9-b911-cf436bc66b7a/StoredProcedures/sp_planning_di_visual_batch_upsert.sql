        ...
        CREATE   PROCEDURE [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].' + QUOTENAME(@DIVTableName) + ' AS div
