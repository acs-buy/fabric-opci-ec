CREATE TABLE [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_approval]([recordGuid] ASC);
