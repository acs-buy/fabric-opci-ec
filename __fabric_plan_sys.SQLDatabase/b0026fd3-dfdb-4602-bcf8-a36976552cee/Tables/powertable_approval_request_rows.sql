CREATE TABLE [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_approval_request] ([id])
);
