CREATE TABLE [14cd3243-21c1-488b-a192-0760eaf16a68].[cube_partition_sync_logs] (
    ...
    CONSTRAINT [FK_c178596a53d6c303773a9095a21] FOREIGN KEY ([partitionMeasureId]) REFERENCES [14cd3243-21c1-488b-a192-0760eaf16a68].[cube_partition_measure] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [14cd3243-21c1-488b-a192-0760eaf16a68].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
