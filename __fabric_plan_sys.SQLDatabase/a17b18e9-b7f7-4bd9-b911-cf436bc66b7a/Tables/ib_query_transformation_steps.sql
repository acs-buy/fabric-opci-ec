CREATE TABLE [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[ib_query_transformation_steps]([recordGuid] ASC);
