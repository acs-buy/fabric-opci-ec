                ...
                CREATE PROCEDURE [49bd6fb0-8b6d-4698-b052-261c2e199297].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [49bd6fb0-8b6d-4698-b052-261c2e199297].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
