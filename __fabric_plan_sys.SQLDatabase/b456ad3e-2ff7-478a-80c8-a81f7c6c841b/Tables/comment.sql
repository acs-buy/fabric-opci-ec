CREATE TABLE [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[visual] ([id]) ON DELETE CASCADE
);
