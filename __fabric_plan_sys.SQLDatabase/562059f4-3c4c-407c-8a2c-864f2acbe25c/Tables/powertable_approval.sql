CREATE TABLE [562059f4-3c4c-407c-8a2c-864f2acbe25c].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [562059f4-3c4c-407c-8a2c-864f2acbe25c].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [562059f4-3c4c-407c-8a2c-864f2acbe25c].[powertable_approval]([recordGuid] ASC);
