CREATE TABLE [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[ib_source]([recordGuid] ASC);
