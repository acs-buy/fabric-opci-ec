CREATE TABLE [31e46168-a84d-491d-9615-f018f7009712].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [31e46168-a84d-491d-9615-f018f7009712].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
