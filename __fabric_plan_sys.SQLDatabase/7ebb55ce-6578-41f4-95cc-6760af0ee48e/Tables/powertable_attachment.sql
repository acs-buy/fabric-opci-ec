CREATE TABLE [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[powertable_attachment] (
    ...
    CONSTRAINT [FK_2bd05b1cc85a67483bedbced9c3] FOREIGN KEY ([sourceId]) REFERENCES [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[powertable_source] ([id])
);
