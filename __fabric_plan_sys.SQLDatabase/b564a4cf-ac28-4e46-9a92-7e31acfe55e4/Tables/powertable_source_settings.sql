CREATE TABLE [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[powertable_source_settings]([recordGuid] ASC);
