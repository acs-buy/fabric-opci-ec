CREATE TABLE [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[writeback_settings]([recordGuid] ASC);
