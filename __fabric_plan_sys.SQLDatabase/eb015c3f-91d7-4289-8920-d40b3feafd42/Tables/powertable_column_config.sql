CREATE TABLE [eb015c3f-91d7-4289-8920-d40b3feafd42].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [eb015c3f-91d7-4289-8920-d40b3feafd42].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [eb015c3f-91d7-4289-8920-d40b3feafd42].[powertable_column_config]([recordGuid] ASC);
