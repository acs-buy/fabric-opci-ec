CREATE TABLE [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[ib_query_writeback_settings]([recordGuid] ASC);
