                          ...
                          CREATE PROCEDURE [4564c828-5513-4f75-8148-7562146882ce].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [4564c828-5513-4f75-8148-7562146882ce].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [4564c828-5513-4f75-8148-7562146882ce].powertable_approval_request_rows
