CREATE TABLE [dbo].[role_nature_visa] (
    ...
    CONSTRAINT [ck_rnv_nature] CHECK ([nature]='CLOTURE' OR [nature]='SYNTHESE' OR [nature]='MAINTIEN' OR [nature]='ACCEPTATION' OR [nature]='OBLIGATION' OR [nature]='PUBLICATION' OR [nature]='EVALUATION' OR [nature]='DEROGATION' OR [nature]='CONCLUSION' OR [nature]='LOT'),
