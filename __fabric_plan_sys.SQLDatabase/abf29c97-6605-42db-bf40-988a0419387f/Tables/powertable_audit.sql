CREATE TABLE [abf29c97-6605-42db-bf40-988a0419387f].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [abf29c97-6605-42db-bf40-988a0419387f].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
