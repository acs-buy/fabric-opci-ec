CREATE TABLE [52033849-181f-483f-b67d-f35f0ed7634c].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [52033849-181f-483f-b67d-f35f0ed7634c].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [52033849-181f-483f-b67d-f35f0ed7634c].[powertable_approval_filter]([recordGuid] ASC);
