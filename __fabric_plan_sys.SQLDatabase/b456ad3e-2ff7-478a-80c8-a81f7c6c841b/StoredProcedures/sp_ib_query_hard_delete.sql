      ...
      CREATE   PROCEDURE [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[ib_query_writeback] qw
