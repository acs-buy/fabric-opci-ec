CREATE TABLE [f421652a-1f51-49cc-965b-e8a69233e76d].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [f421652a-1f51-49cc-965b-e8a69233e76d].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [f421652a-1f51-49cc-965b-e8a69233e76d].[powertable_source_settings]([recordGuid] ASC);
