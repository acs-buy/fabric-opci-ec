CREATE TABLE [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_approval_level]([recordGuid] ASC);
