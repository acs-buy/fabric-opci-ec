CREATE TABLE [f421652a-1f51-49cc-965b-e8a69233e76d].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [f421652a-1f51-49cc-965b-e8a69233e76d].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [f421652a-1f51-49cc-965b-e8a69233e76d].[writeback_settings]([recordGuid] ASC);
