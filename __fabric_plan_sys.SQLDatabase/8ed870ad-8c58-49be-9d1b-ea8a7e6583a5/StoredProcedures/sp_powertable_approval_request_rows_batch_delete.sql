              ...
              CREATE PROCEDURE [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].powertable_approval_request_rows SET status = 500 FROM [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
