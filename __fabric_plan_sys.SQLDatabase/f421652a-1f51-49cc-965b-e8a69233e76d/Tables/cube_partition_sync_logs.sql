CREATE TABLE [f421652a-1f51-49cc-965b-e8a69233e76d].[cube_partition_sync_logs] (
    ...
    CONSTRAINT [FK_c178596a53d6c303773a9095a21] FOREIGN KEY ([partitionMeasureId]) REFERENCES [f421652a-1f51-49cc-965b-e8a69233e76d].[cube_partition_measure] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [f421652a-1f51-49cc-965b-e8a69233e76d].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
