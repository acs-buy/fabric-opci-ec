CREATE TABLE [49bd6fb0-8b6d-4698-b052-261c2e199297].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [49bd6fb0-8b6d-4698-b052-261c2e199297].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
