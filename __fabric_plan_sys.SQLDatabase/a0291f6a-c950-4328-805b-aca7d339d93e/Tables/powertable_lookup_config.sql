CREATE TABLE [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_lookup_config]([recordGuid] ASC);
