CREATE TABLE [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[ib_query_writeback_settings]([recordGuid] ASC);
