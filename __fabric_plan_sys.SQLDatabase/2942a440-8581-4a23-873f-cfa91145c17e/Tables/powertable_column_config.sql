CREATE TABLE [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_column_config]([recordGuid] ASC);
