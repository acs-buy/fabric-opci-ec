                ...
                CREATE PROCEDURE [88469c8b-a912-49ff-b453-4d359bdddd12].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [88469c8b-a912-49ff-b453-4d359bdddd12].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
