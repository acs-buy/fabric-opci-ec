CREATE TABLE [eb015c3f-91d7-4289-8920-d40b3feafd42].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [eb015c3f-91d7-4289-8920-d40b3feafd42].[powertable_approval_request] ([id])
);
