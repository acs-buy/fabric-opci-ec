CREATE TABLE [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_lookup_config]([recordGuid] ASC);
