            ...
            CREATE PROCEDURE [b0026fd3-dfdb-4602-bcf8-a36976552cee].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [b0026fd3-dfdb-4602-bcf8-a36976552cee].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [b0026fd3-dfdb-4602-bcf8-a36976552cee].data_input_row
                INNER JOIN [b0026fd3-dfdb-4602-bcf8-a36976552cee].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
