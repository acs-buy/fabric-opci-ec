CREATE TABLE [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[ib_query_writeback_settings]([recordGuid] ASC);
