CREATE TABLE [31e46168-a84d-491d-9615-f018f7009712].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [31e46168-a84d-491d-9615-f018f7009712].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [31e46168-a84d-491d-9615-f018f7009712].[powertable_approval_level]([recordGuid] ASC);
