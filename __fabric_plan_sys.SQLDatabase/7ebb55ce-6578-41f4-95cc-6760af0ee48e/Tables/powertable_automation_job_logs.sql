CREATE TABLE [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[powertable_automation_jobs] ([id])
);
