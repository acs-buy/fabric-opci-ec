        ...
        CREATE PROCEDURE [31e46168-a84d-491d-9615-f018f7009712].[sp_planning_di_row_values_batch_delete] 
        ...
        SET NOCOUNT ON;
          ...
          SET @sql = @sql + '
            DELETE [31e46168-a84d-491d-9615-f018f7009712].' + QUOTENAME(@DIVTableName) + '
            FROM [31e46168-a84d-491d-9615-f018f7009712].' + QUOTENAME(@DIVTableName) + '
            INNER JOIN [31e46168-a84d-491d-9615-f018f7009712].' + QUOTENAME(@TempTableName) + ' AS temp ON temp.rowId = [31e46168-a84d-491d-9615-f018f7009712].' + QUOTENAME(@DIVTableName) + '.rowId;';
          ...
          SET @sql = @sql + N'
            ...
            -- Insert the incoming values into the temporary table
            INSERT INTO [31e46168-a84d-491d-9615-f018f7009712].' + QUOTENAME(@DataInputRowTempTableName) + N'
            SELECT value as rowId FROM OPENJSON(@DataInputRowIds);

            UPDATE [31e46168-a84d-491d-9615-f018f7009712].data_input_row SET status = 500 FROM [31e46168-a84d-491d-9615-f018f7009712].data_input_row inner join [31e46168-a84d-491d-9615-f018f7009712].' + @DataInputRowTempTableName + ' as temp on temp.rowId = data_input_row.id;
