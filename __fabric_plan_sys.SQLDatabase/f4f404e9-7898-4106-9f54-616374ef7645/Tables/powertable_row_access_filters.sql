CREATE TABLE [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_row_access_filters]([recordGuid] ASC);
