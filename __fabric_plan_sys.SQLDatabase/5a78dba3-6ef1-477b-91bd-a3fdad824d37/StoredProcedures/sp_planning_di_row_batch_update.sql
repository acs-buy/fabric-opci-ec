            ...
            CREATE PROCEDURE [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [5a78dba3-6ef1-477b-91bd-a3fdad824d37].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [5a78dba3-6ef1-477b-91bd-a3fdad824d37].data_input_row
                INNER JOIN [5a78dba3-6ef1-477b-91bd-a3fdad824d37].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
