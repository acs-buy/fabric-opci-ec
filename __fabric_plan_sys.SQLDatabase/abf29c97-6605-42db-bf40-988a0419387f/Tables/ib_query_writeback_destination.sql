CREATE TABLE [abf29c97-6605-42db-bf40-988a0419387f].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [abf29c97-6605-42db-bf40-988a0419387f].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [abf29c97-6605-42db-bf40-988a0419387f].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [abf29c97-6605-42db-bf40-988a0419387f].[ib_query_writeback_destination]([recordGuid] ASC);
