CREATE TABLE [88469c8b-a912-49ff-b453-4d359bdddd12].[cube_partition_sync_logs] (
    ...
    CONSTRAINT [FK_c178596a53d6c303773a9095a21] FOREIGN KEY ([partitionMeasureId]) REFERENCES [88469c8b-a912-49ff-b453-4d359bdddd12].[cube_partition_measure] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [88469c8b-a912-49ff-b453-4d359bdddd12].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
