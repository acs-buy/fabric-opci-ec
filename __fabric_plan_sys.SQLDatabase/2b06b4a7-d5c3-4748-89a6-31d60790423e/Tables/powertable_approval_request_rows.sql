CREATE TABLE [2b06b4a7-d5c3-4748-89a6-31d60790423e].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [2b06b4a7-d5c3-4748-89a6-31d60790423e].[powertable_approval_request] ([id])
);
