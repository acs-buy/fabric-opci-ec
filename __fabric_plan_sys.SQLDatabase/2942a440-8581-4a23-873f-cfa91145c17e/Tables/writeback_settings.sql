CREATE TABLE [2942a440-8581-4a23-873f-cfa91145c17e].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [2942a440-8581-4a23-873f-cfa91145c17e].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [2942a440-8581-4a23-873f-cfa91145c17e].[writeback_settings]([recordGuid] ASC);
