CREATE TABLE [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_approval_request] ([id])
);
