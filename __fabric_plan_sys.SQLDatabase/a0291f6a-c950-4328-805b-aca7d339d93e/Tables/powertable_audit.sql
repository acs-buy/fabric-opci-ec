CREATE TABLE [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
