CREATE TABLE [52033849-181f-483f-b67d-f35f0ed7634c].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [52033849-181f-483f-b67d-f35f0ed7634c].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [52033849-181f-483f-b67d-f35f0ed7634c].[powertable_approval]([recordGuid] ASC);
