CREATE TABLE [49bd6fb0-8b6d-4698-b052-261c2e199297].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [49bd6fb0-8b6d-4698-b052-261c2e199297].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [49bd6fb0-8b6d-4698-b052-261c2e199297].[powertable_row_access_filters]([recordGuid] ASC);
