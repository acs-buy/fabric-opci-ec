CREATE TABLE [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_lookup_config]([recordGuid] ASC);
