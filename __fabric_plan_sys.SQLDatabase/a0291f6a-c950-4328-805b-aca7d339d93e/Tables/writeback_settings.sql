CREATE TABLE [a0291f6a-c950-4328-805b-aca7d339d93e].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [a0291f6a-c950-4328-805b-aca7d339d93e].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [a0291f6a-c950-4328-805b-aca7d339d93e].[writeback_settings]([recordGuid] ASC);
