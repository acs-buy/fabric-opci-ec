CREATE TABLE [efed97ad-5e3c-4c48-9256-9881fa39bca2].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [efed97ad-5e3c-4c48-9256-9881fa39bca2].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [efed97ad-5e3c-4c48-9256-9881fa39bca2].[writeback_settings]([recordGuid] ASC);
