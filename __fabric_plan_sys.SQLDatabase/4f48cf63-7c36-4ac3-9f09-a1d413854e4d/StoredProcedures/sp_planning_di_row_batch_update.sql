            ...
            CREATE PROCEDURE [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].data_input_row
                INNER JOIN [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
