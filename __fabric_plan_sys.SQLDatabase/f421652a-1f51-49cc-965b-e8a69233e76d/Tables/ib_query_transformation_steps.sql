CREATE TABLE [f421652a-1f51-49cc-965b-e8a69233e76d].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [f421652a-1f51-49cc-965b-e8a69233e76d].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [f421652a-1f51-49cc-965b-e8a69233e76d].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [f421652a-1f51-49cc-965b-e8a69233e76d].[ib_query_transformation_steps]([recordGuid] ASC);
