CREATE TABLE [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[ib_query_transformation_steps]([recordGuid] ASC);
