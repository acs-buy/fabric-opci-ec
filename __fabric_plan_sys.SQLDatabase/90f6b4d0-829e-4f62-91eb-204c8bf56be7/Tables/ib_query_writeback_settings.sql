CREATE TABLE [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[ib_query_writeback_settings]([recordGuid] ASC);
