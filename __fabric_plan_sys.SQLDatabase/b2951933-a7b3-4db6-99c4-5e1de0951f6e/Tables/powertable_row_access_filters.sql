CREATE TABLE [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[powertable_row_access_filters]([recordGuid] ASC);
