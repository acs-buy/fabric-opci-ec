CREATE TABLE [0d2c47cd-6740-4e30-9d88-b815bab60653].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [0d2c47cd-6740-4e30-9d88-b815bab60653].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [0d2c47cd-6740-4e30-9d88-b815bab60653].[powertable_column_config]([recordGuid] ASC);
