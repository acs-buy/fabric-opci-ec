CREATE TABLE [5df03107-c058-4934-9696-943dffe44c90].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [5df03107-c058-4934-9696-943dffe44c90].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [5df03107-c058-4934-9696-943dffe44c90].[powertable_forms]([recordGuid] ASC);
