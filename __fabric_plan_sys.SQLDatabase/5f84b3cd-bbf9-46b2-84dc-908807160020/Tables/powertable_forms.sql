CREATE TABLE [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_forms]([recordGuid] ASC);
