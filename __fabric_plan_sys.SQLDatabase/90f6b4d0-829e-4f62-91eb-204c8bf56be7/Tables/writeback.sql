CREATE TABLE [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[writeback] (
    ...
    CONSTRAINT [FK_bbc1ed3d35bb48f8c0823c361c0] FOREIGN KEY ([visualId]) REFERENCES [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[visual] ([id])
);
