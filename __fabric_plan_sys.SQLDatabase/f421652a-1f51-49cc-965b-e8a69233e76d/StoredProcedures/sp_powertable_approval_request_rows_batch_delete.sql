              ...
              CREATE PROCEDURE [f421652a-1f51-49cc-965b-e8a69233e76d].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [f421652a-1f51-49cc-965b-e8a69233e76d].powertable_approval_request_rows SET status = 500 FROM [f421652a-1f51-49cc-965b-e8a69233e76d].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
