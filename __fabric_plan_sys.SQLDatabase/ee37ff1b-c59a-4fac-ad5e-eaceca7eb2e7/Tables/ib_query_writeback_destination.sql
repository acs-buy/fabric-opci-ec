CREATE TABLE [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[ib_query_writeback_destination]([recordGuid] ASC);
