CREATE TABLE [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
