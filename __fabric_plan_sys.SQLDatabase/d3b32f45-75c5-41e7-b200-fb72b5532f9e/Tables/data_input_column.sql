CREATE TABLE [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[data_input_column] (
    ...
    CONSTRAINT [FK_2f2ba9690ea788805bf78ae17a1] FOREIGN KEY ([visualId]) REFERENCES [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [ix_data_input_column_hydration_cold]
    ON [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[data_input_column]([sidecarHydrationStatus] ASC) WHERE ([sidecarHydrationStatus] IN ((10), (30), (50)));
