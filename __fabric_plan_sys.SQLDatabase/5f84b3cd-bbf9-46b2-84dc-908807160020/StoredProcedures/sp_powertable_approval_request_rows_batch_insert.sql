                ...
                CREATE PROCEDURE [5f84b3cd-bbf9-46b2-84dc-908807160020].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [5f84b3cd-bbf9-46b2-84dc-908807160020].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
