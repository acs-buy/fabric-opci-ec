CREATE TABLE [31e46168-a84d-491d-9615-f018f7009712].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [31e46168-a84d-491d-9615-f018f7009712].[powertable_approval_request] ([id])
);
