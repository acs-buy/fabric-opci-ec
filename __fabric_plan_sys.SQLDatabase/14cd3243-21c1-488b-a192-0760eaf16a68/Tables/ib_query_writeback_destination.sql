CREATE TABLE [14cd3243-21c1-488b-a192-0760eaf16a68].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [14cd3243-21c1-488b-a192-0760eaf16a68].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [14cd3243-21c1-488b-a192-0760eaf16a68].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [14cd3243-21c1-488b-a192-0760eaf16a68].[ib_query_writeback_destination]([recordGuid] ASC);
