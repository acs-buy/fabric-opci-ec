CREATE TABLE [f421652a-1f51-49cc-965b-e8a69233e76d].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [f421652a-1f51-49cc-965b-e8a69233e76d].[powertable_approval_request] ([id])
);
