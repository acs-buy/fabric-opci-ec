CREATE TABLE [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[cube_partition_sync_logs] (
    ...
    CONSTRAINT [FK_c178596a53d6c303773a9095a21] FOREIGN KEY ([partitionMeasureId]) REFERENCES [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[cube_partition_measure] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
