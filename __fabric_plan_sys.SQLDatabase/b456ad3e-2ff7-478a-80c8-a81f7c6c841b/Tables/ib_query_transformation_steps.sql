CREATE TABLE [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[ib_query_transformation_steps]([recordGuid] ASC);
