CREATE TABLE [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[cube_partition_sync_logs] (
    ...
    CONSTRAINT [FK_c178596a53d6c303773a9095a21] FOREIGN KEY ([partitionMeasureId]) REFERENCES [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[cube_partition_measure] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
