CREATE TABLE [f421652a-1f51-49cc-965b-e8a69233e76d].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [f421652a-1f51-49cc-965b-e8a69233e76d].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
