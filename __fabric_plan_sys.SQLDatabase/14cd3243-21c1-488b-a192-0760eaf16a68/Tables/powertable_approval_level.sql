CREATE TABLE [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_approval_level]([recordGuid] ASC);
