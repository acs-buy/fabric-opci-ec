CREATE TABLE [5df03107-c058-4934-9696-943dffe44c90].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [5df03107-c058-4934-9696-943dffe44c90].[powertable_automation_jobs] ([id])
);
