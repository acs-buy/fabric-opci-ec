CREATE TABLE [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[powertable_approval_level]([recordGuid] ASC);
