CREATE TABLE [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[ib_query_transformation_steps]([recordGuid] ASC);
