CREATE TABLE [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_column_config]([recordGuid] ASC);
