              ...
              CREATE PROCEDURE [5df03107-c058-4934-9696-943dffe44c90].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [5df03107-c058-4934-9696-943dffe44c90].powertable_approval_request_rows SET status = 500 FROM [5df03107-c058-4934-9696-943dffe44c90].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
