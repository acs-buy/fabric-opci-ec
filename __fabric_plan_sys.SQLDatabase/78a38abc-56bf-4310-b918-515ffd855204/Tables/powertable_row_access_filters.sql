CREATE TABLE [78a38abc-56bf-4310-b918-515ffd855204].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [78a38abc-56bf-4310-b918-515ffd855204].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [78a38abc-56bf-4310-b918-515ffd855204].[powertable_row_access_filters]([recordGuid] ASC);
