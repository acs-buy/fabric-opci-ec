CREATE TABLE [eb015c3f-91d7-4289-8920-d40b3feafd42].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [eb015c3f-91d7-4289-8920-d40b3feafd42].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [eb015c3f-91d7-4289-8920-d40b3feafd42].[powertable_approval_level]([recordGuid] ASC);
