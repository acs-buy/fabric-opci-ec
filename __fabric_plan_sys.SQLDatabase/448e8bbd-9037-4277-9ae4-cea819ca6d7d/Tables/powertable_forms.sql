CREATE TABLE [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[powertable_forms]([recordGuid] ASC);
