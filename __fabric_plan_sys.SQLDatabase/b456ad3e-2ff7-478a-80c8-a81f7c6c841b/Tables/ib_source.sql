CREATE TABLE [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[ib_source]([recordGuid] ASC);
