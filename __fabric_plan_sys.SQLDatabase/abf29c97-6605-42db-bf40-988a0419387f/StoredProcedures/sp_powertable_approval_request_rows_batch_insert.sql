                ...
                CREATE PROCEDURE [abf29c97-6605-42db-bf40-988a0419387f].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [abf29c97-6605-42db-bf40-988a0419387f].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
