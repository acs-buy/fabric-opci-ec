CREATE TABLE [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_attachment] (
    ...
    CONSTRAINT [FK_2bd05b1cc85a67483bedbced9c3] FOREIGN KEY ([sourceId]) REFERENCES [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_source] ([id])
);
