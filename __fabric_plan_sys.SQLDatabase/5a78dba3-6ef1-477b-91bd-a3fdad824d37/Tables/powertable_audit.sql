CREATE TABLE [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
