CREATE TABLE [f4f404e9-7898-4106-9f54-616374ef7645].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [f4f404e9-7898-4106-9f54-616374ef7645].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [f4f404e9-7898-4106-9f54-616374ef7645].[writeback_settings]([recordGuid] ASC);
