        ...
        CREATE   PROCEDURE [b0026fd3-dfdb-4602-bcf8-a36976552cee].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [b0026fd3-dfdb-4602-bcf8-a36976552cee].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [b0026fd3-dfdb-4602-bcf8-a36976552cee].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [b0026fd3-dfdb-4602-bcf8-a36976552cee].' + QUOTENAME(@DIVTableName) + ' AS div
