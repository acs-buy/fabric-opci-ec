CREATE TABLE [5df03107-c058-4934-9696-943dffe44c90].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [5df03107-c058-4934-9696-943dffe44c90].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
