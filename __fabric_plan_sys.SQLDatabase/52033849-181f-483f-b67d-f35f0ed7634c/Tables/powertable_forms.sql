CREATE TABLE [52033849-181f-483f-b67d-f35f0ed7634c].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [52033849-181f-483f-b67d-f35f0ed7634c].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [52033849-181f-483f-b67d-f35f0ed7634c].[powertable_forms]([recordGuid] ASC);
