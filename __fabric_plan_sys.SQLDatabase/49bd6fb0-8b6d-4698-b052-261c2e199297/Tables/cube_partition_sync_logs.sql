CREATE TABLE [49bd6fb0-8b6d-4698-b052-261c2e199297].[cube_partition_sync_logs] (
    ...
    CONSTRAINT [FK_c178596a53d6c303773a9095a21] FOREIGN KEY ([partitionMeasureId]) REFERENCES [49bd6fb0-8b6d-4698-b052-261c2e199297].[cube_partition_measure] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [49bd6fb0-8b6d-4698-b052-261c2e199297].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
