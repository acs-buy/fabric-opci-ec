CREATE TABLE [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[ib_source]([recordGuid] ASC);
