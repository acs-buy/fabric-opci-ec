CREATE TABLE [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_source_settings]([recordGuid] ASC);
