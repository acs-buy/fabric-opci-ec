        ...
        CREATE   PROCEDURE [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [d3b32f45-75c5-41e7-b200-fb72b5532f9e].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [d3b32f45-75c5-41e7-b200-fb72b5532f9e].' + QUOTENAME(@DIVTableName) + ' AS div
