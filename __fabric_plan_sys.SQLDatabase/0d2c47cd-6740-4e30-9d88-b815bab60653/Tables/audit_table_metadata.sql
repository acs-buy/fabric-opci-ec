CREATE TABLE [0d2c47cd-6740-4e30-9d88-b815bab60653].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [0d2c47cd-6740-4e30-9d88-b815bab60653].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [0d2c47cd-6740-4e30-9d88-b815bab60653].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
