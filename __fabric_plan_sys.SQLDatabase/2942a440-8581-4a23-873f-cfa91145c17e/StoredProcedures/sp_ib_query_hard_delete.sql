      ...
      CREATE   PROCEDURE [2942a440-8581-4a23-873f-cfa91145c17e].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [2942a440-8581-4a23-873f-cfa91145c17e].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [2942a440-8581-4a23-873f-cfa91145c17e].[ib_query_writeback] qw
