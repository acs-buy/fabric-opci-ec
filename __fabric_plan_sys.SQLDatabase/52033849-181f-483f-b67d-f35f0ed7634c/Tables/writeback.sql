CREATE TABLE [52033849-181f-483f-b67d-f35f0ed7634c].[writeback] (
    ...
    CONSTRAINT [FK_bbc1ed3d35bb48f8c0823c361c0] FOREIGN KEY ([visualId]) REFERENCES [52033849-181f-483f-b67d-f35f0ed7634c].[visual] ([id])
);
