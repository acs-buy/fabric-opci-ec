CREATE TABLE [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[ib_query_writeback_settings]([recordGuid] ASC);
