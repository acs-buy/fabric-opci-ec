      ...
      CREATE   PROCEDURE [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[ib_query_writeback] qw
