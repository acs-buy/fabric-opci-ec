CREATE TABLE [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [88469c8b-a912-49ff-b453-4d359bdddd12].[powertable_source_settings]([recordGuid] ASC);
