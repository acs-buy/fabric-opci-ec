CREATE TABLE [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_approval]([recordGuid] ASC);
