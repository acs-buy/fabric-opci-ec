CREATE TABLE [efed97ad-5e3c-4c48-9256-9881fa39bca2].[cube_partition_sync_logs] (
    ...
    CONSTRAINT [FK_c178596a53d6c303773a9095a21] FOREIGN KEY ([partitionMeasureId]) REFERENCES [efed97ad-5e3c-4c48-9256-9881fa39bca2].[cube_partition_measure] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [efed97ad-5e3c-4c48-9256-9881fa39bca2].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
