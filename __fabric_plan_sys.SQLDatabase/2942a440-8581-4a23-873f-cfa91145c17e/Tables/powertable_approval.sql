CREATE TABLE [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_approval]([recordGuid] ASC);
