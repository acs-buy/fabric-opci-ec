              ...
              CREATE PROCEDURE [562059f4-3c4c-407c-8a2c-864f2acbe25c].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [562059f4-3c4c-407c-8a2c-864f2acbe25c].powertable_approval_request_rows SET status = 500 FROM [562059f4-3c4c-407c-8a2c-864f2acbe25c].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
