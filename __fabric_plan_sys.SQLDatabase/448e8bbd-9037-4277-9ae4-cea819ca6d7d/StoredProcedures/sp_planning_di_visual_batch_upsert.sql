        ...
        CREATE   PROCEDURE [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [448e8bbd-9037-4277-9ae4-cea819ca6d7d].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [448e8bbd-9037-4277-9ae4-cea819ca6d7d].' + QUOTENAME(@DIVTableName) + ' AS div
