CREATE TABLE [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [14cd3243-21c1-488b-a192-0760eaf16a68].[powertable_approval]([recordGuid] ASC);
