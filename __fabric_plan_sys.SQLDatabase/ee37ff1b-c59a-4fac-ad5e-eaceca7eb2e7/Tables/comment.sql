CREATE TABLE [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[visual] ([id]) ON DELETE CASCADE
);
