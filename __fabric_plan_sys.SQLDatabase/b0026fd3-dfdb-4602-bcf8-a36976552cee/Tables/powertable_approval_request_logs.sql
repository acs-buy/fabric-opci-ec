CREATE TABLE [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_approval_request] ([id])
);
