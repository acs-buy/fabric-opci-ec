CREATE TABLE [2942a440-8581-4a23-873f-cfa91145c17e].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [2942a440-8581-4a23-873f-cfa91145c17e].[visual] ([id]) ON DELETE CASCADE
);
