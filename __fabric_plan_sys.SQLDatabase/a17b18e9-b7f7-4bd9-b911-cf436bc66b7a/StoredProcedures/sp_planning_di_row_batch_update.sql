            ...
            CREATE PROCEDURE [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].data_input_row
                INNER JOIN [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
