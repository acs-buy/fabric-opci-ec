CREATE TABLE [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[powertable_approval_request] ([id])
);
