CREATE TABLE [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [f4f404e9-7898-4106-9f54-616374ef7645].[powertable_approval_request] ([id])
);
