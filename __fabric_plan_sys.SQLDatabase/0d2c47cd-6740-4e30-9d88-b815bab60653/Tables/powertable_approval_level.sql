CREATE TABLE [0d2c47cd-6740-4e30-9d88-b815bab60653].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [0d2c47cd-6740-4e30-9d88-b815bab60653].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [0d2c47cd-6740-4e30-9d88-b815bab60653].[powertable_approval_level]([recordGuid] ASC);
