                ...
                CREATE PROCEDURE [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [448e8bbd-9037-4277-9ae4-cea819ca6d7d].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
