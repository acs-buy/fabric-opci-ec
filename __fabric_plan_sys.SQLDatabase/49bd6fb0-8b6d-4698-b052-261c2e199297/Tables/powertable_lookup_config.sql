CREATE TABLE [49bd6fb0-8b6d-4698-b052-261c2e199297].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [49bd6fb0-8b6d-4698-b052-261c2e199297].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [49bd6fb0-8b6d-4698-b052-261c2e199297].[powertable_lookup_config]([recordGuid] ASC);
