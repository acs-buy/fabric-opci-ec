CREATE TABLE [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[ib_query_transformation_steps]([recordGuid] ASC);
