              ...
              CREATE PROCEDURE [14cd3243-21c1-488b-a192-0760eaf16a68].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [14cd3243-21c1-488b-a192-0760eaf16a68].powertable_approval_request_rows SET status = 500 FROM [14cd3243-21c1-488b-a192-0760eaf16a68].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
