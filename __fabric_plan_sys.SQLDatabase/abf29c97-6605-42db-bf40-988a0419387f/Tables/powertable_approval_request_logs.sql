CREATE TABLE [abf29c97-6605-42db-bf40-988a0419387f].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [abf29c97-6605-42db-bf40-988a0419387f].[powertable_approval_request] ([id])
);
