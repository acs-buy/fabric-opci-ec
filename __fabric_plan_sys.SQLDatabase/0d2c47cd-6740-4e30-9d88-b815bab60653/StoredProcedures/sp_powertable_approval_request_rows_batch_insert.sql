                ...
                CREATE PROCEDURE [0d2c47cd-6740-4e30-9d88-b815bab60653].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [0d2c47cd-6740-4e30-9d88-b815bab60653].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
