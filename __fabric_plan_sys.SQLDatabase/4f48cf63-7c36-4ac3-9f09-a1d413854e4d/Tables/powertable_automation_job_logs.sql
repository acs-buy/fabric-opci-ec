CREATE TABLE [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[powertable_automation_jobs] ([id])
);
