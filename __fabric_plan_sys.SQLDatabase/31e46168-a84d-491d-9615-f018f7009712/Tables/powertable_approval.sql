CREATE TABLE [31e46168-a84d-491d-9615-f018f7009712].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [31e46168-a84d-491d-9615-f018f7009712].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [31e46168-a84d-491d-9615-f018f7009712].[powertable_approval]([recordGuid] ASC);
