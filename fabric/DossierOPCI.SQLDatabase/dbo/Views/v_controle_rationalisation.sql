...
SELECT o.entite, o.arrete, o.actif_net_precedent, o.actif_net_rationalise,
       ...
       CAST(CASE WHEN ISNULL(p.ecritures, 0) = 0 THEN 1
                 -- 06/09/2026 : le premier arrete n'a pas de comparatif, il ne peut
                 -- pas boucler et n'est pas une anomalie ; la lecture le dit.
                 WHEN o.arrete_precedent IS NULL THEN 1
