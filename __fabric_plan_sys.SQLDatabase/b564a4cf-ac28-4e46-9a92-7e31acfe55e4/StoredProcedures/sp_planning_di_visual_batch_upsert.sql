        ...
        CREATE   PROCEDURE [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].' + QUOTENAME(@DIVTableName) + ' AS div
