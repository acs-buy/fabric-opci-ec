CREATE TABLE [31e46168-a84d-491d-9615-f018f7009712].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [31e46168-a84d-491d-9615-f018f7009712].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [31e46168-a84d-491d-9615-f018f7009712].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
