CREATE TABLE [5df03107-c058-4934-9696-943dffe44c90].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [5df03107-c058-4934-9696-943dffe44c90].[powertable_approval_request] ([id])
);
