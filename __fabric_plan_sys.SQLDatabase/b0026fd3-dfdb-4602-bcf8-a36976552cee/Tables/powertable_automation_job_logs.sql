CREATE TABLE [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_automation_jobs] ([id])
);
