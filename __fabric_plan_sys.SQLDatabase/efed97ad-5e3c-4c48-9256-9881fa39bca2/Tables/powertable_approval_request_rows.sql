CREATE TABLE [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_approval_request] ([id])
);
