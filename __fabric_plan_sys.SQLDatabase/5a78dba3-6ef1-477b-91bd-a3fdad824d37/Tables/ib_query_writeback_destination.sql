CREATE TABLE [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[ib_query_writeback_destination]([recordGuid] ASC);
