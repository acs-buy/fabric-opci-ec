CREATE TABLE [eb015c3f-91d7-4289-8920-d40b3feafd42].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [eb015c3f-91d7-4289-8920-d40b3feafd42].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [eb015c3f-91d7-4289-8920-d40b3feafd42].[powertable_approval]([recordGuid] ASC);
