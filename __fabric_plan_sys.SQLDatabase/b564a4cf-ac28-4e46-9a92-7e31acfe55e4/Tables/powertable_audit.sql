CREATE TABLE [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
