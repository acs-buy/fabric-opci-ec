CREATE TABLE [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
