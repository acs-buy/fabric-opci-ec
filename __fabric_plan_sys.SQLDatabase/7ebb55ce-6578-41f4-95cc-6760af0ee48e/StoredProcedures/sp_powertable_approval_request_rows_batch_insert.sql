                ...
                CREATE PROCEDURE [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [7ebb55ce-6578-41f4-95cc-6760af0ee48e].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
