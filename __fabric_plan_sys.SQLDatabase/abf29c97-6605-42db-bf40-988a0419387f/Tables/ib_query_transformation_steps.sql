CREATE TABLE [abf29c97-6605-42db-bf40-988a0419387f].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [abf29c97-6605-42db-bf40-988a0419387f].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [abf29c97-6605-42db-bf40-988a0419387f].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [abf29c97-6605-42db-bf40-988a0419387f].[ib_query_transformation_steps]([recordGuid] ASC);
