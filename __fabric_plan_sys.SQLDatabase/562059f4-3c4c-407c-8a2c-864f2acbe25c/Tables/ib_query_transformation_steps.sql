CREATE TABLE [562059f4-3c4c-407c-8a2c-864f2acbe25c].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [562059f4-3c4c-407c-8a2c-864f2acbe25c].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [562059f4-3c4c-407c-8a2c-864f2acbe25c].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [562059f4-3c4c-407c-8a2c-864f2acbe25c].[ib_query_transformation_steps]([recordGuid] ASC);
