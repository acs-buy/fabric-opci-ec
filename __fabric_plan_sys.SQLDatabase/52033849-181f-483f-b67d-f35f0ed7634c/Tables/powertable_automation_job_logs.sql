CREATE TABLE [52033849-181f-483f-b67d-f35f0ed7634c].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [52033849-181f-483f-b67d-f35f0ed7634c].[powertable_automation_jobs] ([id])
);
