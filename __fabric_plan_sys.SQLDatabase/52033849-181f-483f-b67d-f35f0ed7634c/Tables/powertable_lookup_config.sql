CREATE TABLE [52033849-181f-483f-b67d-f35f0ed7634c].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [52033849-181f-483f-b67d-f35f0ed7634c].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [52033849-181f-483f-b67d-f35f0ed7634c].[powertable_lookup_config]([recordGuid] ASC);
