CREATE TABLE [eb015c3f-91d7-4289-8920-d40b3feafd42].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [eb015c3f-91d7-4289-8920-d40b3feafd42].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [eb015c3f-91d7-4289-8920-d40b3feafd42].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [eb015c3f-91d7-4289-8920-d40b3feafd42].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [eb015c3f-91d7-4289-8920-d40b3feafd42].[ib_source]([recordGuid] ASC);
