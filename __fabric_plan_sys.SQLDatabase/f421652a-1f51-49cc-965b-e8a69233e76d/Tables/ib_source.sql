CREATE TABLE [f421652a-1f51-49cc-965b-e8a69233e76d].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [f421652a-1f51-49cc-965b-e8a69233e76d].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [f421652a-1f51-49cc-965b-e8a69233e76d].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [f421652a-1f51-49cc-965b-e8a69233e76d].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [f421652a-1f51-49cc-965b-e8a69233e76d].[ib_source]([recordGuid] ASC);
