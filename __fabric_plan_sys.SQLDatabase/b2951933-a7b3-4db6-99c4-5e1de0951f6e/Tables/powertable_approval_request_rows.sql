CREATE TABLE [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[powertable_approval_request] ([id])
);
