CREATE TABLE [562059f4-3c4c-407c-8a2c-864f2acbe25c].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [562059f4-3c4c-407c-8a2c-864f2acbe25c].[powertable_automation_jobs] ([id])
);
