        ...
        CREATE   PROCEDURE [2b06b4a7-d5c3-4748-89a6-31d60790423e].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [2b06b4a7-d5c3-4748-89a6-31d60790423e].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [2b06b4a7-d5c3-4748-89a6-31d60790423e].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [2b06b4a7-d5c3-4748-89a6-31d60790423e].' + QUOTENAME(@DIVTableName) + ' AS div
