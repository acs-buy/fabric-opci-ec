CREATE TABLE [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
