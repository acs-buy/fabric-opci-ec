                          ...
                          CREATE PROCEDURE [eb015c3f-91d7-4289-8920-d40b3feafd42].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [eb015c3f-91d7-4289-8920-d40b3feafd42].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [eb015c3f-91d7-4289-8920-d40b3feafd42].powertable_approval_request_rows
