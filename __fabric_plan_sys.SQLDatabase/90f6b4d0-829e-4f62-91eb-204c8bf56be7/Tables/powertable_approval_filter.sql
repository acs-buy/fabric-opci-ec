CREATE TABLE [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[powertable_approval_filter]([recordGuid] ASC);
