CREATE TABLE [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_approval_filter]([recordGuid] ASC);
