CREATE TABLE [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [4f48cf63-7c36-4ac3-9f09-a1d413854e4d].[powertable_approval]([recordGuid] ASC);
