CREATE TABLE [88469c8b-a912-49ff-b453-4d359bdddd12].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [88469c8b-a912-49ff-b453-4d359bdddd12].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [88469c8b-a912-49ff-b453-4d359bdddd12].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [88469c8b-a912-49ff-b453-4d359bdddd12].[ib_query_writeback_destination]([recordGuid] ASC);
