CREATE TABLE [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[powertable_approval_request] ([id])
);
