CREATE TABLE [4564c828-5513-4f75-8148-7562146882ce].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [4564c828-5513-4f75-8148-7562146882ce].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [4564c828-5513-4f75-8148-7562146882ce].[powertable_automation]([recordGuid] ASC);
