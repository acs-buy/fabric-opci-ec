      ...
      CREATE   PROCEDURE [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[ib_query_writeback] qw
