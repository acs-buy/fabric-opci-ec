CREATE TABLE [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[writeback_settings]([recordGuid] ASC);
