CREATE TABLE [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [b0026fd3-dfdb-4602-bcf8-a36976552cee].[powertable_forms]([recordGuid] ASC);
