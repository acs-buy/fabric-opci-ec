CREATE TABLE [0d2c47cd-6740-4e30-9d88-b815bab60653].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [0d2c47cd-6740-4e30-9d88-b815bab60653].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
