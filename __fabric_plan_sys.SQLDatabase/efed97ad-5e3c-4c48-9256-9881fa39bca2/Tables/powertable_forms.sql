CREATE TABLE [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_forms]([recordGuid] ASC);
