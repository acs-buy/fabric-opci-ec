                          ...
                          CREATE PROCEDURE [78a38abc-56bf-4310-b918-515ffd855204].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [78a38abc-56bf-4310-b918-515ffd855204].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [78a38abc-56bf-4310-b918-515ffd855204].powertable_approval_request_rows
