CREATE TABLE [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_comment] (
    ...
    CONSTRAINT [FK_e923d030022f35af27a650126af] FOREIGN KEY ([sourceId]) REFERENCES [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_source] ([id])
);
