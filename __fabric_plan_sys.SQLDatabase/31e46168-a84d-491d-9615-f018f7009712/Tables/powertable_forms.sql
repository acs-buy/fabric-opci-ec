CREATE TABLE [31e46168-a84d-491d-9615-f018f7009712].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [31e46168-a84d-491d-9615-f018f7009712].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [31e46168-a84d-491d-9615-f018f7009712].[powertable_forms]([recordGuid] ASC);
