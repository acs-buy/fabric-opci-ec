      ...
      CREATE   PROCEDURE [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[ib_query_writeback] qw
