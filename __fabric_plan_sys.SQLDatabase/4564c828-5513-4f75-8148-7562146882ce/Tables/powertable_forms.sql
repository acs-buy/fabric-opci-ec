CREATE TABLE [4564c828-5513-4f75-8148-7562146882ce].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [4564c828-5513-4f75-8148-7562146882ce].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [4564c828-5513-4f75-8148-7562146882ce].[powertable_forms]([recordGuid] ASC);
