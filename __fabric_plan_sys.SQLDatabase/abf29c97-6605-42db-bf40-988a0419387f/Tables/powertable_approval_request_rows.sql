CREATE TABLE [abf29c97-6605-42db-bf40-988a0419387f].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [abf29c97-6605-42db-bf40-988a0419387f].[powertable_approval_request] ([id])
);
