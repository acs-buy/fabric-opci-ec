CREATE TABLE [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_attachment] (
    ...
    CONSTRAINT [FK_2bd05b1cc85a67483bedbced9c3] FOREIGN KEY ([sourceId]) REFERENCES [5f84b3cd-bbf9-46b2-84dc-908807160020].[powertable_source] ([id])
);
