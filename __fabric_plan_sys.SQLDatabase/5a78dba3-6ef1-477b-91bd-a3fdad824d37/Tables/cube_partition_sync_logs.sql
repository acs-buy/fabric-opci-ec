CREATE TABLE [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[cube_partition_sync_logs] (
    ...
    CONSTRAINT [FK_c178596a53d6c303773a9095a21] FOREIGN KEY ([partitionMeasureId]) REFERENCES [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[cube_partition_measure] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
