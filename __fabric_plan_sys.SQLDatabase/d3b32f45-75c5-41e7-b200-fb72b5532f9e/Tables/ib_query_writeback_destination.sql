CREATE TABLE [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[ib_query_writeback_destination]([recordGuid] ASC);
