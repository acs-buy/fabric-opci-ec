CREATE TABLE [5df03107-c058-4934-9696-943dffe44c90].[cube_partition_sync_logs] (
    ...
    CONSTRAINT [FK_c178596a53d6c303773a9095a21] FOREIGN KEY ([partitionMeasureId]) REFERENCES [5df03107-c058-4934-9696-943dffe44c90].[cube_partition_measure] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [5df03107-c058-4934-9696-943dffe44c90].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
