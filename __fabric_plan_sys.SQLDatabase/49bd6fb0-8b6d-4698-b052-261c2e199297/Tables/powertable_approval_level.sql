CREATE TABLE [49bd6fb0-8b6d-4698-b052-261c2e199297].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [49bd6fb0-8b6d-4698-b052-261c2e199297].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [49bd6fb0-8b6d-4698-b052-261c2e199297].[powertable_approval_level]([recordGuid] ASC);
