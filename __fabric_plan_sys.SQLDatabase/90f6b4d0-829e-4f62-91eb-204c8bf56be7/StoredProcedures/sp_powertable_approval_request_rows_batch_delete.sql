              ...
              CREATE PROCEDURE [90f6b4d0-829e-4f62-91eb-204c8bf56be7].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [90f6b4d0-829e-4f62-91eb-204c8bf56be7].powertable_approval_request_rows SET status = 500 FROM [90f6b4d0-829e-4f62-91eb-204c8bf56be7].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
