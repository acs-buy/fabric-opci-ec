CREATE TABLE [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [d3b32f45-75c5-41e7-b200-fb72b5532f9e].[powertable_approval_request] ([id])
);
