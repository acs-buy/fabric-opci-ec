CREATE TABLE [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_lookup_config]([recordGuid] ASC);
