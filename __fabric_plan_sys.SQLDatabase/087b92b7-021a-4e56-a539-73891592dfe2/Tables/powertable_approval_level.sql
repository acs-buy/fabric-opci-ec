CREATE TABLE [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [087b92b7-021a-4e56-a539-73891592dfe2].[powertable_approval_level]([recordGuid] ASC);
