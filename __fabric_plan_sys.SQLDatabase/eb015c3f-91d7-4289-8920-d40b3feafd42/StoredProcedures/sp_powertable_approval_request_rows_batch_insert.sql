                ...
                CREATE PROCEDURE [eb015c3f-91d7-4289-8920-d40b3feafd42].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [eb015c3f-91d7-4289-8920-d40b3feafd42].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
