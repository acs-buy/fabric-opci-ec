                ...
                CREATE PROCEDURE [a0291f6a-c950-4328-805b-aca7d339d93e].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [a0291f6a-c950-4328-805b-aca7d339d93e].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
