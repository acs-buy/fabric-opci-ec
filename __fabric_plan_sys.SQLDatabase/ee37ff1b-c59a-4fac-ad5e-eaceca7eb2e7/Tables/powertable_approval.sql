CREATE TABLE [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [ee37ff1b-c59a-4fac-ad5e-eaceca7eb2e7].[powertable_approval]([recordGuid] ASC);
