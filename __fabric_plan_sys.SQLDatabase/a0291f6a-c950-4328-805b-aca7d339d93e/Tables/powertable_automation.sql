CREATE TABLE [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_automation]([recordGuid] ASC);
