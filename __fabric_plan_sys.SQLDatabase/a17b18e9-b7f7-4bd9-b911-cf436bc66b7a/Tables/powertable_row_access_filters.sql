CREATE TABLE [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [a17b18e9-b7f7-4bd9-b911-cf436bc66b7a].[powertable_row_access_filters]([recordGuid] ASC);
