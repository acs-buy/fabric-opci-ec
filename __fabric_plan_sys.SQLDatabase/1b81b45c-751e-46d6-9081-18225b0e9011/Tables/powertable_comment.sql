CREATE TABLE [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_comment] (
    ...
    CONSTRAINT [FK_e923d030022f35af27a650126af] FOREIGN KEY ([sourceId]) REFERENCES [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_source] ([id])
);
