CREATE TABLE [2942a440-8581-4a23-873f-cfa91145c17e].[data_input_column] (
    ...
    CONSTRAINT [FK_2f2ba9690ea788805bf78ae17a1] FOREIGN KEY ([visualId]) REFERENCES [2942a440-8581-4a23-873f-cfa91145c17e].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [ix_data_input_column_hydration_cold]
    ON [2942a440-8581-4a23-873f-cfa91145c17e].[data_input_column]([sidecarHydrationStatus] ASC) WHERE ([sidecarHydrationStatus] IN ((10), (30), (50)));
