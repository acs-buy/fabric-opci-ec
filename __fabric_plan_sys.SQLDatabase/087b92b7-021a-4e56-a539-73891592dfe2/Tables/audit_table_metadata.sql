CREATE TABLE [087b92b7-021a-4e56-a539-73891592dfe2].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [087b92b7-021a-4e56-a539-73891592dfe2].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [087b92b7-021a-4e56-a539-73891592dfe2].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
