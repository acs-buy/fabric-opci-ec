      ...
      CREATE   PROCEDURE [14cd3243-21c1-488b-a192-0760eaf16a68].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [14cd3243-21c1-488b-a192-0760eaf16a68].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [14cd3243-21c1-488b-a192-0760eaf16a68].[ib_query_writeback] qw
