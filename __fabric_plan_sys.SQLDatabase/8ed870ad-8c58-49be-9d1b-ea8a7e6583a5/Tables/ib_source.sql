CREATE TABLE [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[ib_source]([recordGuid] ASC);
