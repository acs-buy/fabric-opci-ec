CREATE TABLE [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
