CREATE TABLE [f421652a-1f51-49cc-965b-e8a69233e76d].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [f421652a-1f51-49cc-965b-e8a69233e76d].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [f421652a-1f51-49cc-965b-e8a69233e76d].[powertable_automation]([recordGuid] ASC);
