CREATE TABLE [0d2c47cd-6740-4e30-9d88-b815bab60653].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [0d2c47cd-6740-4e30-9d88-b815bab60653].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [0d2c47cd-6740-4e30-9d88-b815bab60653].[writeback_settings]([recordGuid] ASC);
