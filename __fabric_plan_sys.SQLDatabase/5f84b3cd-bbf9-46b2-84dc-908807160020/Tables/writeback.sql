CREATE TABLE [5f84b3cd-bbf9-46b2-84dc-908807160020].[writeback] (
    ...
    CONSTRAINT [FK_bbc1ed3d35bb48f8c0823c361c0] FOREIGN KEY ([visualId]) REFERENCES [5f84b3cd-bbf9-46b2-84dc-908807160020].[visual] ([id])
);
