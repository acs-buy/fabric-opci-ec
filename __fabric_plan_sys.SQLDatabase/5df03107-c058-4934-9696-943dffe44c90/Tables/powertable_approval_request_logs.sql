CREATE TABLE [5df03107-c058-4934-9696-943dffe44c90].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [5df03107-c058-4934-9696-943dffe44c90].[powertable_approval_request] ([id])
);
