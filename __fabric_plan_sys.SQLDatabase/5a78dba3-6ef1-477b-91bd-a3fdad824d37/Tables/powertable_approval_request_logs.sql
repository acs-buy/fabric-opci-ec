CREATE TABLE [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[powertable_approval_request] ([id])
);
