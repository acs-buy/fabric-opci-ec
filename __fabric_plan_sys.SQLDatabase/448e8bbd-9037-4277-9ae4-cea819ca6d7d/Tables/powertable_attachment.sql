CREATE TABLE [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[powertable_attachment] (
    ...
    CONSTRAINT [FK_2bd05b1cc85a67483bedbced9c3] FOREIGN KEY ([sourceId]) REFERENCES [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[powertable_source] ([id])
);
