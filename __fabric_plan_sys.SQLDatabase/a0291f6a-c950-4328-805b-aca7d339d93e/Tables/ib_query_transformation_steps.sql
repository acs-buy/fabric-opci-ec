CREATE TABLE [a0291f6a-c950-4328-805b-aca7d339d93e].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [a0291f6a-c950-4328-805b-aca7d339d93e].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [a0291f6a-c950-4328-805b-aca7d339d93e].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [a0291f6a-c950-4328-805b-aca7d339d93e].[ib_query_transformation_steps]([recordGuid] ASC);
