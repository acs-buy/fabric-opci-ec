CREATE TABLE [52033849-181f-483f-b67d-f35f0ed7634c].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [52033849-181f-483f-b67d-f35f0ed7634c].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [52033849-181f-483f-b67d-f35f0ed7634c].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
