      ...
      CREATE   PROCEDURE [b0026fd3-dfdb-4602-bcf8-a36976552cee].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [b0026fd3-dfdb-4602-bcf8-a36976552cee].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [b0026fd3-dfdb-4602-bcf8-a36976552cee].[ib_query_writeback] qw
