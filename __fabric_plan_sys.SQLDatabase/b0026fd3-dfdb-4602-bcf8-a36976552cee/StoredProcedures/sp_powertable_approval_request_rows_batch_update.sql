                          ...
                          CREATE PROCEDURE [b0026fd3-dfdb-4602-bcf8-a36976552cee].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [b0026fd3-dfdb-4602-bcf8-a36976552cee].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [b0026fd3-dfdb-4602-bcf8-a36976552cee].powertable_approval_request_rows
