CREATE TABLE [4564c828-5513-4f75-8148-7562146882ce].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [4564c828-5513-4f75-8148-7562146882ce].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [4564c828-5513-4f75-8148-7562146882ce].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [4564c828-5513-4f75-8148-7562146882ce].[ib_query_transformation_steps]([recordGuid] ASC);
