CREATE TABLE [49bd6fb0-8b6d-4698-b052-261c2e199297].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [49bd6fb0-8b6d-4698-b052-261c2e199297].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [49bd6fb0-8b6d-4698-b052-261c2e199297].[powertable_forms]([recordGuid] ASC);
