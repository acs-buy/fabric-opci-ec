CREATE TABLE [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [7ebb55ce-6578-41f4-95cc-6760af0ee48e].[powertable_lookup_config]([recordGuid] ASC);
