CREATE TABLE [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [448e8bbd-9037-4277-9ae4-cea819ca6d7d].[powertable_approval_level]([recordGuid] ASC);
