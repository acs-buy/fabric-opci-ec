CREATE TABLE [52033849-181f-483f-b67d-f35f0ed7634c].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [52033849-181f-483f-b67d-f35f0ed7634c].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [52033849-181f-483f-b67d-f35f0ed7634c].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [52033849-181f-483f-b67d-f35f0ed7634c].[ib_query_transformation_steps]([recordGuid] ASC);
