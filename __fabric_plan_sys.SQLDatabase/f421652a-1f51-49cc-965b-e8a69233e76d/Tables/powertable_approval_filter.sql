CREATE TABLE [f421652a-1f51-49cc-965b-e8a69233e76d].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [f421652a-1f51-49cc-965b-e8a69233e76d].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [f421652a-1f51-49cc-965b-e8a69233e76d].[powertable_approval_filter]([recordGuid] ASC);
