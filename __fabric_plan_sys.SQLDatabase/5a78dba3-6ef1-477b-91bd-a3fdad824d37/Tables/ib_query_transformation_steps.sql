CREATE TABLE [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[ib_query_transformation_steps]([recordGuid] ASC);
