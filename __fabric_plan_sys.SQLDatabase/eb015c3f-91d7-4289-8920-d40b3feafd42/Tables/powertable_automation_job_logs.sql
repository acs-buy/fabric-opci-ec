CREATE TABLE [eb015c3f-91d7-4289-8920-d40b3feafd42].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [eb015c3f-91d7-4289-8920-d40b3feafd42].[powertable_automation_jobs] ([id])
);
