            ...
            CREATE PROCEDURE [5f84b3cd-bbf9-46b2-84dc-908807160020].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [5f84b3cd-bbf9-46b2-84dc-908807160020].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [5f84b3cd-bbf9-46b2-84dc-908807160020].data_input_row
                INNER JOIN [5f84b3cd-bbf9-46b2-84dc-908807160020].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
