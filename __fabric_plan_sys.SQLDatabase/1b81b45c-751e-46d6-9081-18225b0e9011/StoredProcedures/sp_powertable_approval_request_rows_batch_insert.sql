                ...
                CREATE PROCEDURE [1b81b45c-751e-46d6-9081-18225b0e9011].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [1b81b45c-751e-46d6-9081-18225b0e9011].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
