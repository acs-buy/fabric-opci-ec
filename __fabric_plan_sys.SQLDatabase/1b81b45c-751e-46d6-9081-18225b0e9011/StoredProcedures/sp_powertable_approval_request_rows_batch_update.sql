                          ...
                          CREATE PROCEDURE [1b81b45c-751e-46d6-9081-18225b0e9011].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [1b81b45c-751e-46d6-9081-18225b0e9011].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [1b81b45c-751e-46d6-9081-18225b0e9011].powertable_approval_request_rows
