CREATE TABLE [f4f404e9-7898-4106-9f54-616374ef7645].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [f4f404e9-7898-4106-9f54-616374ef7645].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [f4f404e9-7898-4106-9f54-616374ef7645].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [f4f404e9-7898-4106-9f54-616374ef7645].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [f4f404e9-7898-4106-9f54-616374ef7645].[ib_source]([recordGuid] ASC);
