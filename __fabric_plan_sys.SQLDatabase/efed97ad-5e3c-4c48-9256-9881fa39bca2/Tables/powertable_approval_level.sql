CREATE TABLE [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_approval_level]([recordGuid] ASC);
