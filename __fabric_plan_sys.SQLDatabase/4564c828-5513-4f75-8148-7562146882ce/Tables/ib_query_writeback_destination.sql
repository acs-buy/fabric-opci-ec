CREATE TABLE [4564c828-5513-4f75-8148-7562146882ce].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [4564c828-5513-4f75-8148-7562146882ce].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [4564c828-5513-4f75-8148-7562146882ce].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [4564c828-5513-4f75-8148-7562146882ce].[ib_query_writeback_destination]([recordGuid] ASC);
