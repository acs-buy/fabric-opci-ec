CREATE TABLE [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
