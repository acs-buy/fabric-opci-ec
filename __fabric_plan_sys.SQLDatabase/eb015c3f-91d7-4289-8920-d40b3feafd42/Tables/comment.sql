CREATE TABLE [eb015c3f-91d7-4289-8920-d40b3feafd42].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [eb015c3f-91d7-4289-8920-d40b3feafd42].[visual] ([id]) ON DELETE CASCADE
);
