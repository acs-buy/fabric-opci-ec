CREATE TABLE [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_approval_request] ([id])
);
