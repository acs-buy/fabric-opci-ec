CREATE TABLE [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [2942a440-8581-4a23-873f-cfa91145c17e].[powertable_lookup_config]([recordGuid] ASC);
