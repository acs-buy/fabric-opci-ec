              ...
              CREATE PROCEDURE [1b81b45c-751e-46d6-9081-18225b0e9011].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [1b81b45c-751e-46d6-9081-18225b0e9011].powertable_approval_request_rows SET status = 500 FROM [1b81b45c-751e-46d6-9081-18225b0e9011].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
