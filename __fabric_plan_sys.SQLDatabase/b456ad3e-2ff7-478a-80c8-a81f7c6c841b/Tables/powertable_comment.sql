CREATE TABLE [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[powertable_comment] (
    ...
    CONSTRAINT [FK_e923d030022f35af27a650126af] FOREIGN KEY ([sourceId]) REFERENCES [b456ad3e-2ff7-478a-80c8-a81f7c6c841b].[powertable_source] ([id])
);
