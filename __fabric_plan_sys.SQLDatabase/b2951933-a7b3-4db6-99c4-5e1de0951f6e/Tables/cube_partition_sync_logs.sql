CREATE TABLE [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[cube_partition_sync_logs] (
    ...
    CONSTRAINT [FK_c178596a53d6c303773a9095a21] FOREIGN KEY ([partitionMeasureId]) REFERENCES [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[cube_partition_measure] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
