CREATE TABLE [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [b2951933-a7b3-4db6-99c4-5e1de0951f6e].[visual] ([id])
);
