CREATE TABLE [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [b564a4cf-ac28-4e46-9a92-7e31acfe55e4].[powertable_automation_jobs] ([id])
);
