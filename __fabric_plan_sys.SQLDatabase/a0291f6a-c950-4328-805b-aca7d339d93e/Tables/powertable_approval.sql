CREATE TABLE [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [a0291f6a-c950-4328-805b-aca7d339d93e].[powertable_approval]([recordGuid] ASC);
