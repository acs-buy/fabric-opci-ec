CREATE TABLE [abf29c97-6605-42db-bf40-988a0419387f].[powertable_comment] (
    ...
    CONSTRAINT [FK_e923d030022f35af27a650126af] FOREIGN KEY ([sourceId]) REFERENCES [abf29c97-6605-42db-bf40-988a0419387f].[powertable_source] ([id])
);
