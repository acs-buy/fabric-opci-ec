CREATE TABLE [78a38abc-56bf-4310-b918-515ffd855204].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [78a38abc-56bf-4310-b918-515ffd855204].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [78a38abc-56bf-4310-b918-515ffd855204].[powertable_forms]([recordGuid] ASC);
