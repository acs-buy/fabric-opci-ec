CREATE TABLE [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [8ed870ad-8c58-49be-9d1b-ea8a7e6583a5].[ib_query_writeback_settings]([recordGuid] ASC);
