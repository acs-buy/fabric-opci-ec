CREATE TABLE [78a38abc-56bf-4310-b918-515ffd855204].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [78a38abc-56bf-4310-b918-515ffd855204].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [78a38abc-56bf-4310-b918-515ffd855204].[powertable_column_config]([recordGuid] ASC);
