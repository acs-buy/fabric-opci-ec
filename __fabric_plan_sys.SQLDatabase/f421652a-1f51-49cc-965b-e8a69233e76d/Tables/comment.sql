CREATE TABLE [f421652a-1f51-49cc-965b-e8a69233e76d].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [f421652a-1f51-49cc-965b-e8a69233e76d].[visual] ([id]) ON DELETE CASCADE
);
