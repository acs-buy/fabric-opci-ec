CREATE TABLE [49bd6fb0-8b6d-4698-b052-261c2e199297].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [49bd6fb0-8b6d-4698-b052-261c2e199297].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [49bd6fb0-8b6d-4698-b052-261c2e199297].[powertable_automation]([recordGuid] ASC);
