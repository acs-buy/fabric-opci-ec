              ...
              CREATE PROCEDURE [a0291f6a-c950-4328-805b-aca7d339d93e].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [a0291f6a-c950-4328-805b-aca7d339d93e].powertable_approval_request_rows SET status = 500 FROM [a0291f6a-c950-4328-805b-aca7d339d93e].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
