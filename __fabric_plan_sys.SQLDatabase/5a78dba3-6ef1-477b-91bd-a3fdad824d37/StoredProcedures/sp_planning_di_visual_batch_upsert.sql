        ...
        CREATE   PROCEDURE [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [5a78dba3-6ef1-477b-91bd-a3fdad824d37].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [5a78dba3-6ef1-477b-91bd-a3fdad824d37].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [5a78dba3-6ef1-477b-91bd-a3fdad824d37].' + QUOTENAME(@DIVTableName) + ' AS div
