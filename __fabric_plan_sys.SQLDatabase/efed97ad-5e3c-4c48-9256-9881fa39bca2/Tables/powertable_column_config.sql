CREATE TABLE [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [efed97ad-5e3c-4c48-9256-9881fa39bca2].[powertable_column_config]([recordGuid] ASC);
