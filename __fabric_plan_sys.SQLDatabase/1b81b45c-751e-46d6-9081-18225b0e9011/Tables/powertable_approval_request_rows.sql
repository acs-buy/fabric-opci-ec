CREATE TABLE [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [1b81b45c-751e-46d6-9081-18225b0e9011].[powertable_approval_request] ([id])
);
