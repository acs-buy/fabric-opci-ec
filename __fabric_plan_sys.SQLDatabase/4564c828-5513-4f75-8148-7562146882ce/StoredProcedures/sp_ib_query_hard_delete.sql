      ...
      CREATE   PROCEDURE [4564c828-5513-4f75-8148-7562146882ce].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [4564c828-5513-4f75-8148-7562146882ce].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [4564c828-5513-4f75-8148-7562146882ce].[ib_query_writeback] qw
